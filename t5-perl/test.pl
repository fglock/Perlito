...
sub ok {
    ...
    my $todo    = shift;
    my $depends = shift;
    proclaim( $cond, 'ok! ' . $desc, $todo, $depends );
}
...
sub is {
    ...
    proclaim( $test, 'is! ' . $desc, $todo, $got, $expected, $depends );
}
...
sub is_deeply {
    ...
    proclaim( $test, "is deeply! $desc", $todo, $got_perl, $expected_perl, $depends );
}
...
sub isnt {
    ...
    my $test = !( $got eq $expected );
    proclaim( $test, "isnt! $desc", $todo, $got, $expected, $depends, { negate => 1 } );
}
...
sub cmp_ok {
    ...
    say "### cmp_ok not implemented";
}

sub like {
    say "### like not implemented";
}

sub unlike {
    say "### unlike not implemented";
}

sub eval_dies_ok {
    say "### eval_dies_ok not implemented";
}

sub isa_ok {
    say "### isa_ok not implemented";
}

sub use_ok {
    say "### use_ok not implemented";
}

sub throws_ok {
    say "### throws_ok not implemented";
}

sub dies_ok {
    say "### dies_ok not implemented";
}

sub lives_ok {
    say "### lives_ok not implemented";
}
...
sub flunk {
    ...
    proclaim( 0, 'flunk! ' . $desc, $todo, $depends );
}
...
sub proclaim {
    ...
    if ($cond) {
        ...
        report_failure( $todo, $got, $expected, $negate );
    }
...
sub report_failure {
    ...
    say "### report_failure not implemented";
}
