...
class Call {
    ...
    sub emit_javascript_indented {
        ...
        if ($.method eq 'new') {
            ...
            if ( $.invocant->isa( 'Proto' ) ) {
                ...
                return
                    ...
                    .   'var tmp = {' . join(',', @$str) . '}; '
                    .   'tmp._class_ = ' . Perlito5::Runtime::to_javascript_namespace($invocant) . '; '
                    .   'return tmp; '
                    . '})()'
            ...
            return
                ...
                .   '} '
                    # XXX Perl6 autogenerated constructor
                .   'var tmp = {' . join(',', @$str) . '}; '
                .   'tmp._class_ = ' . Perlito5::Runtime::to_javascript_namespace($invocant) . '._class_; '
                .   'return tmp; '
                . '})()'
        }
        ...
        # try to call a method on the class; if that fails, then call a method on $self.
