...
package Perlito5::Expression;
    ...
    token operator {
        ...
        | '->'
            [
            | '(' <paren_parse>   ')'                   { make [ 'postfix_or_term',  '.( )',  $<paren_parse>->flat()   ] }
            | '[' <square_parse>  ']'                   { make [ 'postfix_or_term',  '.[ ]',  $<square_parse>->flat()  ] }
            | '{' <curly_parse>   '}'                   { make [ 'postfix_or_term',  '.{ }',  $<curly_parse>->flat()   ] }
            ]
        | '('  <paren_parse>   ')'                      { make [ 'postfix_or_term',  '( )',   $<paren_parse>->flat()   ] }
        | '['  <square_parse>  ']'                      { make [ 'postfix_or_term',  '[ ]',   $<square_parse>->flat()  ] }
