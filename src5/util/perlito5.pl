...
perlito5 [switches] [programfile]
  switches:
    ...
    -v --verbose
    -V --version
    -Ctarget        target backend: js, perl5, perl6, ast-perl5
...
";
    ...
    if ($backend && @ARGV) {
        ...
        if ($backend eq 'perl5') {
            say "# Perlito5::AST::Do not edit this file - Generated by ", $_V6_COMPILER_NAME, " ", $_V6_COMPILER_VERSION;
        ...
        if ($backend eq 'js') {
            ...
            my $filename = $perl5lib . '/Perlito5/Javascript/Runtime.js';
            if ( $verbose ) {
                warn "// now loading: ", $filename;
            }
            my $source = IO::slurp( $filename );
