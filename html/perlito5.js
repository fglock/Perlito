				...
				try {
					...
					if ( (p5bool(p5call((v_self || (v_self = new p5HashRef({})))._hash_['obj'], "isa", ['Perlito5::AST::Var'], 0)) && (p5str(p5call((v_self || (v_self = new p5HashRef({})))._hash_['obj'], "sigil", [], 0)) == '$')) ) {
						(function () {
							var v_v = null;
							(v_v = (p5call(p5pkg["Perlito5::AST::Var"], "new", p5list_to_a('sigil', '%', 'namespace', p5call((v_self || (v_self = new p5HashRef({})))._hash_['obj'], "namespace", [], 1), 'name', p5call((v_self || (v_self = new p5HashRef({})))._hash_['obj'], "name", [], 1)), 0)));
							throw(p5context([(p5str(p5call(v_v, "emit_javascript", [v_level], 0)) + '[' + p5str(p5call(v_self, "emit_javascript_index", p5list_to_a((v_self || (v_self = new p5HashRef({})))._hash_['index_exp'], v_level), 0)) + ']')], p5want));
							})();
					};
					return (p5context([(p5str(p5pkg["Perlito5::Javascript"].emit_javascript_autovivify(p5list_to_a((v_self || (v_self = new p5HashRef({})))._hash_['obj'], v_level, 'hash'), 0)) + '._hash_[' + p5str(p5call(v_self, "emit_javascript_index", p5list_to_a((v_self || (v_self = new p5HashRef({})))._hash_['index_exp'], v_level), 0)) + ']')], p5want));
				}
				catch(err) {
					if ( err instanceof Error ) {
						throw(err);
		...
		for (var i_ = 0; i_ < 1 ; i_++) {
			p5make_sub("Perlito5::AST::Call", "emit_javascript", function (List__, p5want) {
				try {
					...
					if ( (p5str(v_meth) == 'postcircumfix:<{ }>') ) {
						throw(p5context([(p5str(p5pkg["Perlito5::Javascript"].emit_javascript_autovivify(p5list_to_a((v_self || (v_self = new p5HashRef({})))._hash_['invocant'], v_level, 'hash'), 0)) + '._hash_[' + p5str(p5call(p5pkg["Perlito5::AST::Lookup"], "emit_javascript_index", p5list_to_a((v_self || (v_self = new p5HashRef({})))._hash_['arguments'], v_level, 'list'), 0)) + ']')], p5want));
					};
					var v_invocant = null;
						...
						if ( p5bool(p5call(v_arg, "isa", ['Perlito5::AST::Lookup'], 0)) ) {
							(function () {
								...
								if ( (p5bool(p5call(v_v, "isa", ['Perlito5::AST::Var'], 0)) && (p5str(p5call(v_v, "sigil", [], 0)) == '$')) ) {
									...
									throw(p5context([('(' + p5str(p5call(v_v, "emit_javascript", [], 0)) + ').hasOwnProperty(' + p5str(p5call(v_arg, "emit_javascript_index", p5list_to_a((v_arg || (v_arg = new p5HashRef({})))._hash_['index_exp'], v_level), 0)) + ')')], p5want));
								};
								throw(p5context([('(' + p5str(p5call(v_v, "emit_javascript", [], 0)) + ')._hash_.hasOwnProperty(' + p5str(p5call(v_arg, "emit_javascript_index", p5list_to_a((v_arg || (v_arg = new p5HashRef({})))._hash_['index_exp'], v_level), 0)) + ')')], p5want));
								})();
						};
						if ( p5bool(p5call(v_arg, "isa", ['Perlito5::AST::Call'], 0)) ) {
							if ( (p5str(p5call(v_arg, "method", [], 0)) == 'postcircumfix:<{ }>') ) {
								throw(p5context([('(' + p5str(p5call(p5call(v_arg, "invocant", [], p5want), "emit_javascript", [], 0)) + ')._hash_.hasOwnProperty(' + p5str(p5call(p5pkg["Perlito5::AST::Lookup"], "emit_javascript_index", p5list_to_a((v_arg || (v_arg = new p5HashRef({})))._hash_['arguments'], v_level), 0)) + ')')], p5want))
							}
	...
	(function () {
		...
		p5make_sub("Perlito5::Grammar::Bareword", "term_bareword", function (List__, p5want) {
			try {
				...
				if ( (p5str((v_list || (v_list = new p5HashRef({})))._hash_['exp']) != '*undef*') ) {
			...
			try {
				...
				if ( (p5str(p5129.ref([v_v], 0)) == 'ARRAY') ) {
					...
					if ( (p5str((v_v || (v_v = new p5ArrayRef([])))._array_[1]) == 'funcall_no_params') ) {
						(v_v = (p5call(p5pkg["Perlito5::AST::Apply"], "new", p5list_to_a('code', (v_v || (v_v = new p5ArrayRef([])))._array_[3], 'namespace', (v_v || (v_v = new p5ArrayRef([])))._array_[2], 'arguments', null), 0)));
						throw(p5context([v_v], p5want));
					};
	...
	return (p5call(p5pkg["Perlito5::AST::Val::Buf"], "new", ['buf', p5pkg["Perlito5::Grammar::String"]["v__"]], p5want));
				...
				for ( ; ((p5num(v_p) < p5131.length([v_str], 0)) && (p5131.substr([v_str, v_p, p5131.length([v_delimiter], 0)], 0) != p5str(v_delimiter)));  ) {
					(function () {
						...
						if ( p5bool(v_m) ) {
							...
							(v_p)++;
							if ( ((p5str(v_c) == p5131.chr([10], 0)) || (p5str(v_c) == p5131.chr([13], 0))) ) {
								(function () {
									var v_m = null;
			...
			try {
				...
				if ( (p5str(v_type) == 'single_quote') ) {
					for ( ; (p5num(v_p) < p5131.length([v_str], 0));  ) {
						...
						for ( ; ((p5num(v_p) < p5131.length([v_str], 0)) && ((p5131.substr([v_str, v_p, 1], 0) != p5131.chr([10], 0)) && (p5131.substr([v_str, v_p, 1], 0) != p5131.chr([13], 0))));  ) {
							(v_p)++;
						};
						for ( ; ((p5num(v_p) < p5131.length([v_str], 0)) && ((p5131.substr([v_str, v_p, 1], 0) == p5131.chr([10], 0)) || (p5131.substr([v_str, v_p, 1], 0) == p5131.chr([13], 0))));  ) {
							(v_p)++;
		...
		p5make_sub("Perlito5::Grammar::String", "double_quoted_buf", function (List__, p5want) {
			try {
				...
				(v_delimiter = (List__[3]));
				var v_c = null;
				(v_c = (p5131.substr([v_str, v_pos, 1], 0)));
				if ( (((p5str(v_c) == '$') || (p5str(v_c) == '@')) && (p5131.substr([v_str, (p5num(v_pos) + 1), p5131.length([v_delimiter], 0)], 0) != p5str(v_delimiter))) ) {
					(function () {
						var v_m = null;
					...
					if ( (p5str(v_c) == String.fromCharCode(92)) ) {
						(function () {
							var v_c2 = null;
							(v_c2 = (p5131.substr([v_str, (p5num(v_pos) + 1), 1], 0)));
							if ( (Hash_escape_sequence).hasOwnProperty(v_c2) ) {
								throw((new p5HashRef(p5a_to_h(p5list_to_a('str', v_str, 'from', v_pos, 'to', (p5num(v_pos) + 2), 'capture', p5call(p5pkg["Perlito5::AST::Val::Buf"], "new", ['buf', p5131.chr([Hash_escape_sequence[v_c2]], 1)], 1))))));
							};
							if ( (p5str(v_c2) == 'c') ) {
								(function () {
									var v_c3 = null;
									(v_c3 = ((p5num((p5131.ord([p5131.substr([v_str, (p5num(v_pos) + 2), 1], 0)], 0) - p5131.ord(['A'], 0))) + 1)));
									if ( (p5num(v_c3) < 0) ) {
										(v_c3 = ((128 + p5num(v_c3))));
									};
									throw((new p5HashRef(p5a_to_h(p5list_to_a('str', v_str, 'from', v_pos, 'to', (p5num(v_pos) + 3), 'capture', p5call(p5pkg["Perlito5::AST::Val::Buf"], "new", ['buf', p5131.chr([v_c3], 1)], 1))))));
									})();
							};
...
;
		...
		(Hash_space = p5a_to_h(['#', function (List__, p5want) {
					...
					var v_pos = null;
					(v_pos = (List__[1]));
					if ( (p5134.substr([v_str, v_pos, 1], 0) == p5134.chr([13], 0)) ) {
						(v_pos)++;
					};
					var v_m = null;
					...
					var v_pos = null;
					(v_pos = (List__[1]));
					if ( (p5134.substr([v_str, v_pos, 1], 0) == p5134.chr([10], 0)) ) {
						(v_pos)++;
					};
					var v_m = null;
					(v_m = (p5call(p5pkg["Perlito5::Grammar::Space"], "start_of_line", p5list_to_a(List__[0], v_pos), 0)));
		...
		p5pkg["Perlito5::Precedence"].add_term([p5134.chr([9], 1), p5134.term_space], null);
		p5pkg["Perlito5::Precedence"].add_term([p5134.chr([10], 1), p5134.term_space], null);
		p5pkg["Perlito5::Precedence"].add_term([p5134.chr([12], 1), p5134.term_space], null);
		p5pkg["Perlito5::Precedence"].add_term([p5134.chr([13], 1), p5134.term_space], null);
		p5pkg["Perlito5::Precedence"].add_term([p5134.chr([32], 1), p5134.term_space], null);
				...
				(v_tmp = (p5context([p5context([(function () {
						...
						return (p5or(p5context([(function () {
							return (p5and(p5context([(function () {
								...
								((v_MATCH || (v_MATCH = new p5HashRef({})))._hash_['capture'] = p5call(p5pkg["Perlito5::AST::Val::Int"], "new", ['int', p5130.oct([p5pkg["Perlito5::Match"].flat([v_MATCH], 0)], 1)], p5want));
								return (p5context([1], p5want));
							})()], p5want) }));
						})()], p5want), function () { return p5context([(function () {
							((v_MATCH || (v_MATCH = new p5HashRef({})))._hash_['to'] = v_pos1);
