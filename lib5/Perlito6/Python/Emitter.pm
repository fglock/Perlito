...
;
    {
    package Perlito6::Python::AnonSub;
        sub new { shift; bless { @_ }, "Perlito6::Python::AnonSub" }
        sub name { $_[0]->{name} };
        sub sig { $_[0]->{sig} };
        sub block { $_[0]->{block} };
    ...
    $List_a
            ...
            ((my  $block) = Perlito6::Python::LexicalBlock->new(('block' => (defined $self->{block} ? $self->{block} : ($self->{block} ||= bless([], 'ARRAY')))), ('needs_return' => 1)));
...
;
    {
    package Perlito6::Python::LexicalBlock;
        sub new { shift; bless { @_ }, "Perlito6::Python::LexicalBlock" }
        sub block { $_[0]->{block} };
    ...
    $List_a
                ...
                if (Main::isa($last_statement, 'If')) {
                    ...
                    ((my  $body_block) = Perlito6::Python::LexicalBlock->new(('block' => ($last_statement->body()->stmts())), ('needs_return' => 1)));
                    ...
                    if (($has_otherwise)) {
                        ...
                        ((my  $otherwise_block) = Perlito6::Python::LexicalBlock->new(('block' => ($last_statement->otherwise()->stmts())), ('needs_return' => 1)));
...
;
    ...
    package CompUnit;
        ...
        sub emit_python_indented {
            ...
            my $level = $_[1];
            (my  $List_s = bless [], 'ARRAY');
            ((my  $block) = Perlito6::Python::LexicalBlock->new(('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY'))))));
            ((my  $label) = ('_anon_' . Perlito6::Python::LexicalBlock::get_ident_python()));
...
;
    ...
    $Hash_a
            ...
            Perlito6::Python::LexicalBlock::push_stmt_python(Perlito6::Python::AnonSub->new(('name' => $label), ('block' => (defined $self->{stmts} ? $self->{stmts} : ($self->{stmts} ||= bless([], 'ARRAY')))), ('sig' => $anon_sig), ('handles_return_exception' => 0)));
...
;
    ...
    package If;
        ...
        sub emit_python_indented {
            ...
            ((my  $body_block) = Perlito6::Python::LexicalBlock->new(('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY')))->stmts())));
            if ($body_block->has_my_decl()) {
            ...
            if (($has_otherwise)) {
                ((my  $otherwise_block) = Perlito6::Python::LexicalBlock->new(('block' => (defined $self->{otherwise} ? $self->{otherwise} : ($self->{otherwise} ||= bless([], 'ARRAY')))->stmts())));
                if ($otherwise_block->has_my_decl()) {
...
;
    ...
    $Hash_a
                ...
                Perlito6::Python::LexicalBlock::push_stmt_python(Perlito6::Python::AnonSub->new(('name' => $label), ('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY')))->stmts()), ('sig' => $anon_sig), ('handles_return_exception' => 0)));
...
;
    ...
    package Sub;
        ...
        sub emit_python_indented {
            ...
            ((my  $label) = ('_anon_' . Perlito6::Python::LexicalBlock::get_ident_python()));
            if ((($self->{name} eq ''))) {
                Perlito6::Python::LexicalBlock::push_stmt_python(Perlito6::Python::AnonSub->new(('name' => $label), ('block' => (defined $self->{block} ? $self->{block} : ($self->{block} ||= bless([], 'ARRAY')))), ('sig' => $self->{sig}), ('handles_return_exception' => 1)));
                return scalar ((Python::tab($level) . 'f_' . $label))
            };
            ((my  $sig) = $self->{sig});
            ((my  $pos) = $sig->positional());
...
;
    ...
    package Do;
        ...
        sub emit_python_indented {
            ...
            Perlito6::Python::LexicalBlock::push_stmt_python(Perlito6::Python::AnonSub->new(('name' => $label), ('block' => $block), ('sig' => Sig->new(('invocant' => undef()), ('positional' => do {
    (my  $List_a = bless [], 'ARRAY');
    (my  $List_v = bless [], 'ARRAY');
    $List_a
}), ('named' => do {
