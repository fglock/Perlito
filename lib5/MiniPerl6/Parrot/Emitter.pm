...
sub emit { my $self = shift; my $List__ = \@_; do { [] }; ('  $P0 = new .Integer' . (Main::newline() . ('  $P0 = ' . ($self->{int} . Main::newline())))) }
...
sub emit { my $self = shift; my $List__ = \@_; do { [] }; ('  $P0 = new "Integer"' . (Main::newline() . ('  $P0 = ' . ($self->{bit} . Main::newline())))) }
...
sub emit { my $self = shift; my $List__ = \@_; do { [] }; ('  $P0 = new "Float"' . (Main::newline() . ('  $P0 = ' . ($self->{num} . Main::newline())))) }
...
sub emit { my $self = shift; my $List__ = \@_; do { [] }; ('  $P0 = new "String"' . (Main::newline() . ('  $P0 = ' . (Main::quote() . ($self->{buf} . (Main::quote() . Main::newline())))))) }
...
sub emit { my $self = shift; my $List__ = \@_; do { [] }; ('  $P0 = new .Undef' . Main::newline()) }
