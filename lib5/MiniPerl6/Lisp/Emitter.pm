...
sub arguments { @_ == 1 ? ( $_[0]->{arguments} ) : ( $_[0]->{arguments} = $_[1] ) };
sub namespace { @_ == 1 ? ( $_[0]->{namespace} ) : ( $_[0]->{namespace} = $_[1] ) };
sub emit_lisp { my $self = shift; my $List__ = \@_; do { [] }; (my  $ns = ''); do { if ($self->{namespace}) { ($ns = (Main::to_lisp_namespace($self->{namespace}) . '::')) } else {  } }; (my  $code = ($ns . $self->{code})); (my  $args = ''); do { if (@{$self->{arguments}}) { ($args = Main::join([ map { $_->emit_lisp() } @{ $self->{arguments} } ], ' ')) } else {  } }; do { if (($code eq 'self')) { return('sv-self') } else {  } }; do { if (($code eq 'false')) { return('nil') } else {  } }; do { if (($code eq 'make')) { return(('(setf (sv-capture sv-MATCH) ' . ($args . ')'))) } else {  } }; do { if (($code eq 'substr')) { return(('(sv-substr ' . ($args . ')'))) } else {  } }; do { if (($code eq 'say')) { return(('(mp-Main::sv-say (list ' . ($args . '))'))) } else {  } }; do { if (($code eq 'print')) { return(('(mp-Main::sv-print (list ' . ($args . '))'))) } else {  } }; do { if (($code eq 'infix:<~>')) { return(('(concatenate \'string (sv-string ' . ($self->{arguments}->[0]->emit_lisp() . (') (sv-string ' . ($self->{arguments}->[1]->emit_lisp() . '))'))))) } else {  } }; do { if (($code eq 'warn')) { return(('(write-line (format nil "~{~a~}" (list ' . ($args . ')) *error-output*)'))) } else {  } }; do { if (($code eq 'die')) { return(('(progn (write-line (format nil "~{~a~}" (list ' . ($args . ')) *error-output*) (sb-ext:quit))'))) } else {  } }; do { if (($code eq 'array')) { return($args) } else {  } }; do { if (($code eq 'prefix:<~>')) { return(('(sv-string ' . ($args . ')'))) } else {  } }; do { if (($code eq 'prefix:<!>')) { return(('(not (sv-bool ' . ($args . '))'))) } else {  } }; do { if (($code eq 'prefix:<?>')) { return(('(sv-bool ' . ($args . ')'))) } else {  } }; do { if (($code eq 'prefix:<$>')) { return(('(sv-scalar ' . ($args . ')'))) } else {  } }; do { if (($code eq 'prefix:<@>')) { return($args) } else {  } }; do { if (($code eq 'prefix:<%>')) { return($args) } else {  } }; do { if (($code eq 'infix:<+>')) { return(('(+ ' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<->')) { return(('(-' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<>>')) { return(('(> ' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<&&>')) { return(('(sv-and ' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<||>')) { return(('(sv-or ' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<eq>')) { return(('(sv-eq ' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<ne>')) { return(('(not (sv-eq ' . ($args . '))'))) } else {  } }; do { if (($code eq 'infix:<==>')) { return(('(eql ' . ($args . ')'))) } else {  } }; do { if (($code eq 'infix:<!=>')) { return(('(not (eql ' . ($args . '))'))) } else {  } }; do { if (($code eq 'ternary:<?? !!>')) { return(('(if (sv-bool ' . ($self->{arguments}->[0]->emit_lisp() . (') ' . ($self->{arguments}->[1]->emit_lisp() . (' ' . ($self->{arguments}->[2]->emit_lisp() . ')'))))))) } else {  } }; return(('(' . ($ns . (Main::to_lisp_identifier($self->{code}) . (' ' . ($args . ')')))))) }
