...
sub arguments { @_ == 1 ? ( $_[0]->{arguments} ) : ( $_[0]->{arguments} = $_[1] ) };
sub namespace { @_ == 1 ? ( $_[0]->{namespace} ) : ( $_[0]->{namespace} = $_[1] ) };
sub emit { my $self = shift; my $List__ = \@_; do { [] }; (my  $ns = ''); do { if ($self->{namespace}) { ($ns = $self->{namespace} . '::') } else {  } }; (my  $code = $ns . $self->{code}); do { if (Main::isa($code, 'Str')) {  } else { return('(' . $self->{code}->emit() . ')->(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ', ') . ')') } }; do { if (($code eq 'self')) { return('$self') } else {  } }; do { if (($code eq 'false')) { return('0') } else {  } }; do { if (($code eq 'make')) { return('($MATCH->capture = (' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ', ') . '))') } else {  } }; do { if (($code eq 'say')) { return('Main::say(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ', ') . ')') } else {  } }; do { if (($code eq 'print')) { return('Main::print(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ', ') . ')') } else {  } }; do { if (($code eq 'warn')) { return('warn(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ', ') . ')') } else {  } }; do { if (($code eq 'array')) { return('@{' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . '}') } else {  } }; do { if (($code eq 'pop')) { return('pop( @{' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . '} )') } else {  } }; do { if (($code eq 'push')) { return('push( @{' . $self->{arguments}->[0]->emit() . '}, ' . $self->{arguments}->[1]->emit() . ' )') } else {  } }; do { if (($code eq 'shift')) { return('shift( @{' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . '} )') } else {  } }; do { if (($code eq 'prefix:<~>')) { return('("" . ' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . ')') } else {  } }; do { if (($code eq 'prefix:<!>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . ' ? 0 : 1)') } else {  } }; do { if (($code eq 'prefix:<?>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . ' ? 1 : 0)') } else {  } }; do { if (($code eq 'prefix:<$>')) { return('${' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . '}') } else {  } }; do { if (($code eq 'prefix:<@>')) { return('@{' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . '}') } else {  } }; do { if (($code eq 'prefix:<%>')) { return('%{' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ') . '}') } else {  } }; do { if (($code eq 'infix:<~>')) { return('' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' . ') . '') } else {  } }; do { if (($code eq 'infix:<+>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' + ') . ')') } else {  } }; do { if (($code eq 'infix:<->')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' - ') . ')') } else {  } }; do { if (($code eq 'infix:<>>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' > ') . ')') } else {  } }; do { if (($code eq 'infix:<x>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' x ') . ')') } else {  } }; do { if (($code eq 'infix:<&&>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' && ') . ')') } else {  } }; do { if (($code eq 'infix:<||>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' || ') . ')') } else {  } }; do { if (($code eq 'infix:<eq>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' eq ') . ')') } else {  } }; do { if (($code eq 'infix:<ne>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' ne ') . ')') } else {  } }; do { if (($code eq 'infix:<==>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' == ') . ')') } else {  } }; do { if (($code eq 'infix:<!=>')) { return('(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ' != ') . ')') } else {  } }; do { if (($code eq 'ternary:<?? !!>')) { return('(' . $self->{arguments}->[0]->emit() . ' ? ' . $self->{arguments}->[1]->emit() . ' : ' . $self->{arguments}->[2]->emit() . ')') } else {  } }; $code . '(' . Main::join([ map { $_->emit() } @{ $self->{arguments} } ], ', ') . ')' }
