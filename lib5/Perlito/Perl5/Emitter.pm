...
sub arguments { $_[0]->{arguments} };
sub namespace { $_[0]->{namespace} };
sub emit_perl5 { my $self = $_[0]; ((my  $ns = undef) = ''); if (Main::bool($self->{namespace})) { ($ns = $self->{namespace} . '::') } ; ((my  $code = undef) = $ns . $self->{code}); if (Main::bool(Main::isa($code, 'Str'))) {  } else { return scalar ('(' . $self->{code}->emit_perl5() . ')->(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') }; if (Main::bool(($code eq 'self'))) { return scalar ('$self') } ; if (Main::bool(($code eq 'Mu'))) { return scalar ('undef') } ; if (Main::bool(($code eq 'make'))) { return scalar ('($MATCH->{capture} = (' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . '))') } ; if (Main::bool(($code eq 'say'))) { return scalar ('Main::say(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; if (Main::bool(($code eq 'print'))) { return scalar ('Main::print(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; if (Main::bool(($code eq 'warn'))) { return scalar ('warn(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; if (Main::bool(($code eq 'array'))) { return scalar ('@{' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . '}') } ; if (Main::bool(($code eq 'pop'))) { return scalar ('pop( @{' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . '} )') } ; if (Main::bool(($code eq 'push'))) { return scalar ('push( @{' . ($self->{arguments}->[0])->emit_perl5() . '}, ' . ($self->{arguments}->[1])->emit_perl5() . ' )') } ; if (Main::bool(($code eq 'shift'))) { return scalar ('shift( @{' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . '} )') } ; if (Main::bool(($code eq 'unshift'))) { return scalar ('unshift( @{' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . '} )') } ; if (Main::bool(($code eq 'Int'))) { return scalar ('(0+' . ($self->{arguments}->[0])->emit_perl5() . ')') } ; if (Main::bool(($code eq 'Num'))) { return scalar ('(0+' . ($self->{arguments}->[0])->emit_perl5() . ')') } ; if (Main::bool(($code eq 'bool'))) { return scalar ('Main::bool(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; if (Main::bool(($code eq 'prefix:<~>'))) { return scalar ('("" . ' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'prefix:<!>'))) { return scalar ('!Main::bool(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'prefix:<?>'))) { return scalar ('Main::bool(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'prefix:<$>'))) { return scalar ('${' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . '}') } ; if (Main::bool(($code eq 'prefix:<@>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ' || [])') } ; if (Main::bool(($code eq 'prefix:<%>'))) { return scalar ('%{' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . '}') } ; if (Main::bool(($code eq 'postfix:<++>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')++') } ; if (Main::bool(($code eq 'postfix:<-->'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')--') } ; if (Main::bool(($code eq 'prefix:<++>'))) { return scalar ('++(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'prefix:<-->'))) { return scalar ('--(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'list:<~>'))) { return scalar ('' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' . ') . '') } ; if (Main::bool(($code eq 'infix:<+>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' + ') . ')') } ; if (Main::bool(($code eq 'infix:<->'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' - ') . ')') } ; if (Main::bool(($code eq 'infix:<*>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' * ') . ')') } ; if (Main::bool(($code eq 'infix:</>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' / ') . ')') } ; if (Main::bool(($code eq 'infix:<>>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' > ') . ')') } ; if (Main::bool(($code eq 'infix:<<>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' < ') . ')') } ; if (Main::bool(($code eq 'infix:<>=>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' >= ') . ')') } ; if (Main::bool(($code eq 'infix:<<=>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' <= ') . ')') } ; if (Main::bool(($code eq 'infix:<x>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' x ') . ')') } ; if (Main::bool(($code eq 'infix:<&&>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' && ') . ')') } ; if (Main::bool(($code eq 'infix:<||>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' || ') . ')') } ; if (Main::bool(($code eq 'infix:<//>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' // ') . ')') } ; if (Main::bool(($code eq 'infix:<eq>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' eq ') . ')') } ; if (Main::bool(($code eq 'infix:<ne>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ne ') . ')') } ; if (Main::bool(($code eq 'infix:<le>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' le ') . ')') } ; if (Main::bool(($code eq 'infix:<ge>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' ge ') . ')') } ; if (Main::bool(($code eq 'infix:<==>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' == ') . ')') } ; if (Main::bool(($code eq 'infix:<!=>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' != ') . ')') } ; if (Main::bool(($code eq 'infix:<=>>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' => ') . ')') } ; if (Main::bool(($code eq 'infix:<..>'))) { return scalar ('[' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ' .. ') . ']') } ; if (Main::bool(($code eq 'ternary:<?? !!>'))) { ((my  $cond = undef) = $self->{arguments}->[0]); if (Main::bool((Main::isa($cond, 'Var') && ($cond->sigil() eq '@')))) { ($cond = Apply->new(('code' => 'prefix:<@>'), ('arguments' => do { (my  $List_a = []); (my  $List_v = []); push( @{$List_a}, $cond ); $List_a }))) } ; return scalar ('(' . Perl5::to_bool($cond)->emit_perl5() . ' ? ' . ($self->{arguments}->[1])->emit_perl5() . ' : ' . ($self->{arguments}->[2])->emit_perl5() . ')') } ; if (Main::bool(($code eq 'circumfix:<( )>'))) { return scalar ('(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; if (Main::bool(($code eq 'infix:<=>'))) { return scalar (emit_perl5_bind($self->{arguments}->[0], $self->{arguments}->[1])) } ; if (Main::bool(($code eq 'return'))) { if (Main::bool(($self->{arguments} && (scalar( @{$self->{arguments}} ) == 1)))) { return scalar ('return scalar (' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; return scalar ('return (' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')') } ; $code . '(' . Main::join(([ map { $_->emit_perl5() } @{ $self->{arguments} } ]), ', ') . ')' };
