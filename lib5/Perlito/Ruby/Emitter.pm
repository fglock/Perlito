...
sub emit_ruby { my $self = $_[0]; $self->emit_ruby_indented(0) };
sub emit_ruby_indented { my $self = $_[0]; my $level = $_[1]; ((my  $ast = undef) = $self->expand_interpolation()); return($ast->emit_ruby_indented($level)) }
}
...
sub emit_ruby { my $self = $_[0]; ((my  $code = undef) = $self->{code}); if (Main::bool(Main::isa($code, 'Str'))) {  } else { return('(' . $self->{code}->emit_ruby(("" . ').(') . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ', ') . ')')) }; if (Main::bool(($code eq 'self'))) { return('self') } ; if (Main::bool(($code eq 'make'))) { return('v_MATCH.v_capture = ' . ($self->{arguments}->[0])->emit_ruby(("" . ''))) } ; if (Main::bool(($code eq 'False'))) { return('false') } ; if (Main::bool(($code eq 'True'))) { return('true') } ; if (Main::bool(($code eq 'say'))) { return('puts' . Ruby::to_str(' + ', $self->{arguments})) } ; if (Main::bool(($code eq 'print'))) { return('print' . Ruby::to_str(' + ', $self->{arguments})) } ; if (Main::bool(($code eq 'warn'))) { return('$stdout.puts(' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ', ') . ')') } ; if (Main::bool(($code eq 'array'))) { return('[' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ' ') . ']') } ; if (Main::bool(($code eq 'Int'))) { return('(' . ($self->{arguments}->[0])->emit_ruby(("" . ').to_i'))) } ; if (Main::bool(($code eq 'Num'))) { return('(' . ($self->{arguments}->[0])->emit_ruby(("" . ').to_f'))) } ; if (Main::bool(($code eq 'prefix:<~>'))) { return(Ruby::to_str(' + ', $self->{arguments})) } ; if (Main::bool(($code eq 'prefix:<!>'))) { return('!' . Ruby::to_bool(' && ', $self->{arguments})) } ; if (Main::bool(($code eq 'prefix:<?>'))) { return('!(!' . Ruby::to_bool(' && ', $self->{arguments}) . ')') } ; if (Main::bool(($code eq 'prefix:<$>'))) { return('mp6_to_scalar(' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'prefix:<@>'))) { return('(' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ' ') . ')') } ; if (Main::bool(($code eq 'prefix:<%>'))) { return('%{' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ' ') . '}') } ; if (Main::bool(($code eq 'infix:<~>'))) { return(Ruby::to_str(' + ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<+>'))) { return(Ruby::to_num(' + ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<->'))) { return(Ruby::to_num(' - ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<*>'))) { return(Ruby::to_num(' * ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:</>'))) { return(Ruby::to_num(' / ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<&&>'))) { return(Ruby::to_bool(' && ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<||>'))) { return(Ruby::to_bool(' || ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<eq>'))) { return(Ruby::to_str(' == ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<ne>'))) { return(Ruby::to_str(' != ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<==>'))) { return(Ruby::to_num(' == ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<!=>'))) { return(Ruby::to_num(' != ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<<>'))) { return(Ruby::to_num(' < ', $self->{arguments})) } ; if (Main::bool(($code eq 'infix:<>>'))) { return(Ruby::to_num(' > ', $self->{arguments})) } ; if (Main::bool(($code eq 'exists'))) { ((my  $arg = undef) = $self->{arguments}->[0]); if (Main::bool(Main::isa($arg, 'Lookup'))) { return('(' . ($arg->obj())->emit_ruby(("" . ').has_key?(') . ($arg->index_exp())->emit_ruby(("" . ')')))) }  } ; if (Main::bool(($code eq 'ternary:<?? !!>'))) { return('(' . Ruby::to_bool(' && ', do { (my  $List_a = []); (my  $List_v = []); push( @{$List_a}, $self->{arguments}->[0] ); $List_a }) . ' ? ' . ($self->{arguments}->[1])->emit_ruby(("" . ' : ') . ($self->{arguments}->[2])->emit_ruby(("" . ')')))) } ; if (Main::bool(($code eq 'substr'))) { return(Ruby::to_str(' + ', do { (my  $List_a = []); (my  $List_v = []); push( @{$List_a}, $self->{arguments}->[0] ); $List_a }) . '[' . ($self->{arguments}->[1])->emit_ruby(("" . ', ') . ($self->{arguments}->[2])->emit_ruby(("" . ']')))) } ; if (Main::bool(($code eq 'index'))) { return('(' . ($self->{arguments}->[0])->emit_ruby(("" . ').index(') . ($self->{arguments}->[1])->emit_ruby(("" . ')')))) } ; if (Main::bool(($code eq 'shift'))) { return(($self->{arguments}->[0])->emit_ruby(("" . '.shift()'))) } ; if (Main::bool(($code eq 'pop'))) { return(($self->{arguments}->[0])->emit_ruby(("" . '.pop()'))) } ; if (Main::bool(($code eq 'push'))) { return(($self->{arguments}->[0])->emit_ruby(("" . '.push(') . ($self->{arguments}->[1])->emit_ruby(("" . ')')))) } ; if (Main::bool(($code eq 'unshift'))) { return(($self->{arguments}->[0])->emit_ruby(("" . '.unshift(') . ($self->{arguments}->[1])->emit_ruby(("" . ')')))) } ; if (Main::bool($self->{namespace})) { return('$' . Main::to_go_namespace($self->{namespace}) . '.f_' . $self->{code} . '(' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ', ') . ')') } ; 'namespace.f_' . $self->{code} . '(' . Main::join(([ map { $_->emit_ruby() } @{ $self->{arguments} } ]), ', ') . ')' };
sub emit_ruby_indented { my $self = $_[0]; my $level = $_[1]; Ruby::tab($level) . $self->emit_ruby() }
}
