...
for ($_) {
    ...
    sub Perlito5::AST::CompUnit::emit_javascript_program {
        ...
        ($Perlito5::VAR = [{('@ARGV' => {('decl' => 'our'), ('namespace' => 'main')}), ('$@' => {('decl' => 'our'), ('namespace' => 'main')}), ('$^O' => {('decl' => 'our'), ('namespace' => 'main')}), ('@_' => {('decl' => 'my')}), ('$_' => {('decl' => 'our'), ('namespace' => $Perlito5::PKG_NAME)}), ('$a' => {('decl' => 'our'), ('namespace' => $Perlito5::PKG_NAME)}), ('$b' => {('decl' => 'our'), ('namespace' => $Perlito5::PKG_NAME)})}]);
