...
;
    {
    package Perlito5::Ruby::AnonSub;
        sub new { shift; bless { @_ }, "Perlito5::Ruby::AnonSub" }
        sub name { $_[0]->{name} };
        sub sig { $_[0]->{sig} };
        sub block { $_[0]->{block} };
    ...
    $List_a
            ...
            ((my  $block) = Perlito5::Ruby::LexicalBlock->new(('block' => (defined $self->{block} ? $self->{block} : ($self->{block} ||= bless([], 'ARRAY')))), ('needs_return' => 1)));
            (my  $List_s = bless [], 'ARRAY');
...
;
    {
    package Perlito5::Ruby::LexicalBlock;
        sub new { shift; bless { @_ }, "Perlito5::Ruby::LexicalBlock" }
        sub block { $_[0]->{block} };
    ...
    $List_a
                ...
                if (Main::isa($last_statement, 'If')) {
                    ...
                    ((my  $body_block) = Perlito5::Ruby::LexicalBlock->new(('block' => ($last_statement->body()->stmts())), ('needs_return' => 1)));
                    ((my  $otherwise_block) = Perlito5::Ruby::LexicalBlock->new(('block' => ($last_statement->otherwise()->stmts())), ('needs_return' => 1)));
...
;
    ...
    package CompUnit;
        ...
        sub emit_ruby_indented {
            ...
            my $level = $_[1];
            (my  $List_s = bless [], 'ARRAY');
            ((my  $block) = Perlito5::Ruby::LexicalBlock->new(('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY'))))));
...
;
    ...
    package If;
        ...
        sub emit_ruby_indented {
            ...
            ((my  $body_block) = Perlito5::Ruby::LexicalBlock->new(('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY')))->stmts())));
            if ($body_block->has_my_decl()) {
    ...
    $List_a
            ...
            if (($has_otherwise)) {
                ((my  $otherwise_block) = Perlito5::Ruby::LexicalBlock->new(('block' => (defined $self->{otherwise} ? $self->{otherwise} : ($self->{otherwise} ||= bless([], 'ARRAY')))->stmts())));
...
;
    ...
    package While;
        ...
        sub emit_ruby_indented {
            my $self = $_[0];
            my $level = $_[1];
            ((my  $body_block) = Perlito5::Ruby::LexicalBlock->new(('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY'))))));
            if ($body_block->has_my_decl()) {
                ($body_block = Do->new(('block' => (defined $self->{body} ? $self->{body} : ($self->{body} ||= bless([], 'ARRAY'))))))
            };
...
;
    ...
    package Sub;
        ...
        sub emit_ruby_indented {
            ...
            if ((($self->{name} eq ''))) {
                Perlito5::Ruby::LexicalBlock::push_stmt_ruby(Perlito5::Ruby::AnonSub->new(('name' => $label), ('block' => (defined $self->{block} ? $self->{block} : ($self->{block} ||= bless([], 'ARRAY')))), ('sig' => $self->{sig}), ('handles_return_exception' => 1)));
...
;
    ...
    package Do;
        ...
        sub emit_ruby_indented {
            ...
            push( @{$List_s}, (Perlito5::Ruby::LexicalBlock->new(('block' => $block), ('needs_return' => 0)))->emit_ruby_indented(($level + 1)) );
