...
;
    ...
    package Rul::SpecialChar;
        ...
        sub emit_perl5 {
            ...
            if ((($char eq 'N'))) {
                return scalar (Rul::Subrule->new(('metasyntax' => 'not_newline'), ('captures' => 0))->emit_perl5())
            };
            if ((($char eq 'd'))) {
                return scalar (Rul::Subrule->new(('metasyntax' => 'digit'), ('captures' => 0))->emit_perl5())
            };
            if ((($char eq 's'))) {
                return scalar (Rul::Subrule->new(('metasyntax' => 'space'), ('captures' => 0))->emit_perl5())
            };
            if ((($char eq 't'))) {
