...
(v_sig = v_decl.f_sig());(v_pos = v_sig.f_positional());(v_block = (function () { var tmp = {v_block: v_decl.f_block(),v_needs_return: 1,v_top_level: 1}; tmp.__proto__ = Perlito$Javascript$LexicalBlock; return tmp })());(v_str = (f_string(v_str) + f_string("  // sub ") + f_string(v_decl.f_name()) + f_string((f_string("\n"))) + f_string("  ") + f_string(v_class_name) + f_string(".f_") + f_string(v_decl.f_name()) + f_string(" = function (") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) }; return out; })(v_pos)).join(", ")) + f_string(") {") + f_string((f_string("\n"))) + f_string("    ") + f_string(v_block.f_emit_javascript()) + f_string((f_string("\n"))) + f_string("  }") + f_string((f_string("\n"))))); })() }; })(a_[i_]) } })(v_self.v_body);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_decl) { if ( f_bool(f_and(f_and((( f_bool((f_and(f_isa(v_decl, "Decl"), function () { return (f_or(((v_decl.f_decl() == "has")), function () { return ((v_decl.f_decl() == "my"))}))}))) ? false : true)), function () { return (( f_bool((f_isa(v_decl, "Method"))) ? false : true))}), function () { return (( f_bool((f_isa(v_decl, "Sub"))) ? false : true))})) ) { (function () { (v_str = (f_string(v_str) + f_string((v_decl).f_emit_javascript()) + f_string(";"))); })() }; })(a_[i_]) } })(v_self.v_body);return((v_str = (f_string(v_str) + f_string("}") + f_string(")();") + f_string((f_string("\n")))))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  ...
  CompUnit.f_emit_javascript_program = function (v_comp_units) {
    try { var v_str = null;
(v_str = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_comp_unit) { (v_str = (f_string(v_str) + f_string(v_comp_unit.f_emit_javascript()))); })(a_[i_]) } })(((v_comp_units)));throw(v_str) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
})();
;// class Val::Int
...
(function () {
  ...
  Lit$Array.f_emit_javascript = function () {
    var v_self = this;
    try { var v_ast = null;
(v_ast = v_self.f_expand_interpolation());throw(v_ast.f_emit_javascript()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_ns = null;
(v_table = (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["$"]  = "v_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["@"]  = "List_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["%"]  = "Hash_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["&"]  = "Code_"); })();return(Hash_a) })());(v_ns = "");if ( f_bool(v_self.v_namespace) ) { (function () { (v_ns = (f_string(Main.f_to_javascript_namespace(v_self.v_namespace)) + f_string("."))); })() };return(( f_bool(((v_self.v_twigil == "."))) ? ((f_string("v_self.v_") + f_string(v_self.v_name) + f_string(""))) : (( f_bool(((v_self.v_name == "/"))) ? ((f_string((function () { if (v_table == null) { v_table = {} }; return (v_table[v_self.v_sigil] ); })()) + f_string("MATCH"))) : ((f_string((function () { if (v_table == null) { v_table = {} }; return (v_table[v_self.v_sigil] ); })()) + f_string(v_ns) + f_string(v_self.v_name))))))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_str = null;
var v_i = null;
(v_a = v_parameters.f_array1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_str = (f_string(v_str) + f_string(" ") + f_string(v__NAMESPACE.f_emit_javascript_bind(v_var, (function () { var tmp = {v_obj: v_arguments,v_index_exp: (function () { var tmp = {v_int: v_i}; tmp.__proto__ = Val$Int; return tmp })()}; tmp.__proto__ = Index; return tmp })())) + f_string("; ")));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_a));throw((f_string(v_str) + f_string(v_parameters.f_emit_javascript()) + f_string(" }"))); })() };if ( f_bool(f_isa(v_parameters, "Lit::Hash")) ) { (function () { var v_a = null;
var v_b = null;
var v_str = null;
var v_i = null;
var v_arg = null;
(v_a = v_parameters.f_hash1());(v_b = v_arguments.f_hash1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = (function () { var tmp = {v_code: "Mu"}; tmp.__proto__ = Apply; return tmp })());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool(((v_var2[0]).f_buf() == (v_var[0]).f_buf())) ) { (function () { (v_arg = v_var2[1]); })() }; })(a_[i_]) } })((v_b));(v_str = (f_string(v_str) + f_string(" ") + f_string(v__NAMESPACE.f_emit_javascript_bind(v_var[1], v_arg)) + f_string("; ")));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_a));throw((f_string(v_str) + f_string(v_parameters.f_emit_javascript()) + f_string(" }"))); })() };if ( f_bool(f_isa(v_parameters, "Call")) ) { (function () { throw((f_string("(") + f_string((v_parameters.f_invocant()).f_emit_javascript()) + f_string(".v_") + f_string(v_parameters.f_method()) + f_string(" = ") + f_string(v_arguments.f_emit_javascript()) + f_string(")"))); })() };if ( f_bool(f_isa(v_parameters, "Lookup")) ) { (function () { var v_str = null;
var v_var = null;
var v_var_js = null;
var v_index_js = null;
(v_str = "");(v_var = v_parameters.f_obj());if ( f_bool(f_isa(v_var, "Lookup")) ) { (function () { var v_var1 = null;
var v_var1_js = null;
(v_var1 = v_var.f_obj());(v_var1_js = v_var1.f_emit_javascript());(v_str = (f_string(v_str) + f_string("if (") + f_string(v_var1_js) + f_string(" == null) { ") + f_string(v_var1_js) + f_string(" = {} }; ")));(v_var_js = (f_string(v_var1_js) + f_string("[") + f_string(v_var.f_index_exp().f_emit_javascript()) + f_string("]"))); })() } else { (function () { (v_var_js = v_var.f_emit_javascript()); })() };(v_str = (f_string(v_str) + f_string("if (") + f_string(v_var_js) + f_string(" == null) { ") + f_string(v_var_js) + f_string(" = {} }; ")));(v_index_js = v_parameters.f_index_exp().f_emit_javascript());(v_str = (f_string(v_str) + f_string("return (") + f_string(v_var_js) + f_string("[") + f_string(v_index_js) + f_string("] ") + f_string(" = ") + f_string(v_arguments.f_emit_javascript()) + f_string("); ")));throw((f_string("(function () { ") + f_string(v_str) + f_string("})()"))); })() };if ( f_bool(f_isa(v_parameters, "Index")) ) { (function () { var v_str = null;
var v_var = null;
var v_var_js = null;
var v_index_js = null;
(v_str = "");(v_var = v_parameters.f_obj());if ( f_bool(f_isa(v_var, "Index")) ) { (function () { var v_var1 = null;
var v_var1_js = null;
(v_var1 = v_var.f_obj());(v_var1_js = v_var1.f_emit_javascript());(v_str = (f_string(v_str) + f_string("if (") + f_string(v_var1_js) + f_string(" == null) { ") + f_string(v_var1_js) + f_string(" = [] }; ")));(v_var_js = (f_string(v_var1_js) + f_string("[") + f_string(v_var.f_index_exp().f_emit_javascript()) + f_string("]"))); })() } else { (function () { (v_var_js = v_var.f_emit_javascript()); })() };(v_str = (f_string(v_str) + f_string("if (") + f_string(v_var_js) + f_string(" == null) { ") + f_string(v_var_js) + f_string(" = [] }; ")));(v_index_js = v_parameters.f_index_exp().f_emit_javascript());(v_str = (f_string(v_str) + f_string("return (") + f_string(v_var_js) + f_string("[") + f_string(v_index_js) + f_string("] ") + f_string(" = ") + f_string(v_arguments.f_emit_javascript()) + f_string("); ")));throw((f_string("(function () { ") + f_string(v_str) + f_string("})()"))); })() };if ( f_bool(f_or(f_and(f_isa(v_parameters, "Var"), function () { return (v_parameters.f_sigil() == "@")}), function () { return f_and(f_isa(v_parameters, "Decl"), function () { return (v_parameters.f_var().f_sigil() == "@")})})) ) { (function () { (v_arguments = (function () { var tmp = {v_array1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_arguments);return(List_a) })()}; tmp.__proto__ = Lit$Array; return tmp })()); })() } else { (function () { if ( f_bool(f_or(f_and(f_isa(v_parameters, "Var"), function () { return (v_parameters.f_sigil() == "%")}), function () { return f_and(f_isa(v_parameters, "Decl"), function () { return (v_parameters.f_var().f_sigil() == "%")})})) ) { (function () { (v_arguments = (function () { var tmp = {v_hash1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_arguments);return(List_a) })()}; tmp.__proto__ = Lit$Hash; return tmp })()); })() }; })() };return((f_string("(") + f_string(v_parameters.f_emit_javascript()) + f_string(" = ") + f_string(v_arguments.f_emit_javascript()) + f_string(")"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
})();
;// class If
if (typeof If != 'object') {
...
var v_body = null;
var v_s = null;
(v_cond = v_self.v_cond);if ( f_bool(f_and(f_isa(v_cond, "Var"), function () { return (v_cond.f_sigil() == "@")})) ) { (function () { (v_cond = (function () { var tmp = {v_code: "prefix:<@>",v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v_cond);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })()); })() };(v_body = (function () { var tmp = {v_block: v_self.v_body.f_stmts(),v_needs_return: 0}; tmp.__proto__ = Perlito$Javascript$LexicalBlock; return tmp })());(v_s = (f_string("if ( f_bool(") + f_string(v_cond.f_emit_javascript()) + f_string(") ) { ") + f_string("(function () { ") + f_string(v_body.f_emit_javascript()) + f_string(" })() }")));if ( f_bool(v_self.v_otherwise) ) { (function () { var v_otherwise = null;
...
var v_body = null;
var v_sig = null;
(v_cond = v_self.v_cond);if ( f_bool(( f_bool((f_and(f_isa(v_cond, "Var"), function () { return (v_cond.f_sigil() == "@")}))) ? false : true)) ) { (function () { (v_cond = (function () { var tmp = {v_array1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_cond);return(List_a) })()}; tmp.__proto__ = Lit$Array; return tmp })()); })() };(v_body = (function () { var tmp = {v_block: v_self.v_body.f_stmts(),v_needs_return: 0}; tmp.__proto__ = Perlito$Javascript$LexicalBlock; return tmp })());(v_sig = "v__");if ( f_bool(v_self.v_body.f_sig()) ) { (function () { (v_sig = v_self.v_body.f_sig().f_emit_javascript()); })() };return((f_string("(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { ") + f_string((f_string("(function (") + f_string(v_sig) + f_string(") ") + f_string("{") + f_string(" "))) + f_string(v_body.f_emit_javascript()) + f_string(" })(a_[i_]) } })") + f_string("(") + f_string(v_cond.f_emit_javascript()) + f_string(")"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Do.f_emit_javascript = function () {
    var v_self = this;
    try { var v_block = null;
(v_block = v_self.f_simplify().f_block());throw((f_string("(function () { ") + f_string(((function () { var tmp = {v_block: v_block,v_needs_return: 1}; tmp.__proto__ = Perlito$Javascript$LexicalBlock; return tmp })()).f_emit_javascript()) + f_string(" })()"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_c2 = null;
(v_c1 = (v_str || "").substr((f_add(v_pos, v_l) - 1), 1));(v_c2 = (v_str || "").substr(f_add(v_pos, v_l), 1));if ( f_bool(f_and(v__NAMESPACE.f_is_ident_middle(v_c1), function () { return (f_or(v__NAMESPACE.f_is_ident_middle(v_c2), function () { return (v_c2 == "(")}))})) ) { (function () { null })() } else { (function () { throw((function () { var tmp = {v_str: v_str,v_from: v_from,v_to: f_add(v_pos, 2),v_bool: 1,v_capture: (function () { var List_a = [];
var List_v = [];
List_a.push("end");List_a.push(v_s);return(List_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() }; })() }; })(a_[i_]) } })(((v_End_token)));(v_c01 = (v_str || "").substr(v_pos, 1));(v_c02 = (v_str || "").substr(v_pos, 2));(v_hyper_left = 0);(v_hyper_right = 0);if ( f_bool(f_or(((v_c01 == "Â«")), function () { return ((v_c01 == "Â»"))})) ) { (function () { (v_hyper_left = v_c01);(v_pos = f_add(v_pos, 1));(v_c02 = (v_str || "").substr(v_pos, 2)); })() } else { (function () { if ( f_bool(f_or(((v_c02 == "<<")), function () { return ((v_c02 == ">>"))})) ) { (function () { (v_hyper_left = v_c02);(v_pos = f_add(v_pos, 2));(v_c02 = (v_str || "").substr(v_pos, 2)); })() }; })() };(v_op3 = (v_str || "").substr(v_pos, 3));if ( f_bool((v_Op3).hasOwnProperty(v_op3)) ) { (function () { var v_c1 = null;
var v_c2 = null;
(v_c1 = (v_str || "").substr(f_add(v_pos, 2), 1));(v_c2 = (v_str || "").substr(f_add(v_pos, 3), 1));if ( f_bool(f_and(v__NAMESPACE.f_is_ident_middle(v_c1), function () { return (f_or(v__NAMESPACE.f_is_ident_middle(v_c2), function () { return (v_c2 == "(")}))})) ) { (function () { null })() } else { (function () { var v_c01 = null;
var v_c02 = null;
(v_pos = f_add(v_pos, 3));(v_c01 = (v_str || "").substr(v_pos, 2));(v_c02 = (v_str || "").substr(v_pos, 3));if ( f_bool(f_or(((v_c01 == "Â«")), function () { return ((v_c01 == "Â»"))})) ) { (function () { (v_hyper_right = v_c01);(v_pos = f_add(v_pos, 1)); })() } else { (function () { if ( f_bool(f_or(((v_c02 == "<<")), function () { return ((v_c02 == ">>"))})) ) { (function () { (v_hyper_right = v_c02);(v_pos = f_add(v_pos, 2)); })() }; })() };throw((function () { var tmp = {v_str: v_str,v_from: v_from,v_to: v_pos,v_bool: 1,v_capture: (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push(v_op3);List_a.push((function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["hyper_left"]  = v_hyper_left); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["hyper_right"]  = v_hyper_right); })();return(Hash_a) })());return(List_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() }; })() };(v_op2 = v_c02);if ( f_bool((v_Op2).hasOwnProperty(v_op2)) ) { (function () { var v_c1 = null;
var v_c2 = null;
...
var v_c02 = null;
(v_pos = f_add(v_pos, 2));(v_c01 = (v_str || "").substr(v_pos, 1));(v_c02 = (v_str || "").substr(v_pos, 2));if ( f_bool(f_or(((v_c01 == "Â«")), function () { return ((v_c01 == "Â»"))})) ) { (function () { (v_hyper_right = v_c01);(v_pos = f_add(v_pos, 1)); })() } else { (function () { if ( f_bool(f_or(((v_c02 == "<<")), function () { return ((v_c02 == ">>"))})) ) { (function () { (v_hyper_right = v_c02);(v_pos = f_add(v_pos, 2)); })() }; })() };throw((function () { var tmp = {v_str: v_str,v_from: v_from,v_to: v_pos,v_bool: 1,v_capture: (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push(v_op2);List_a.push((function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["hyper_left"]  = v_hyper_left); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["hyper_right"]  = v_hyper_right); })();return(Hash_a) })());return(List_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() }; })() };(v_op1 = (v_str || "").substr(v_pos, 1));if ( f_bool((v_Op1).hasOwnProperty(v_op1)) ) { (function () { var v_c2 = null;
...
var v_c02 = null;
(v_pos = f_add(v_pos, 1));(v_c01 = (v_str || "").substr(v_pos, 1));(v_c02 = (v_str || "").substr(v_pos, 2));if ( f_bool(f_or(((v_c01 == "Â«")), function () { return ((v_c01 == "Â»"))})) ) { (function () { (v_hyper_right = v_c01);(v_pos = f_add(v_pos, 1)); })() } else { (function () { if ( f_bool(f_or(((v_c02 == "<<")), function () { return ((v_c02 == ">>"))})) ) { (function () { (v_hyper_right = v_c02);(v_pos = f_add(v_pos, 2)); })() }; })() };throw((function () { var tmp = {v_str: v_str,v_from: v_from,v_to: v_pos,v_bool: 1,v_capture: (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push(v_op1);List_a.push((function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["hyper_left"]  = v_hyper_left); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["hyper_right"]  = v_hyper_right); })();return(Hash_a) })());return(List_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() }; })() };throw((function () { var tmp = {v_bool: 0}; tmp.__proto__ = Perlito$Match; return tmp })()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
if ( f_bool(( f_bool(((v_param != null))) ? false : true)) ) { (function () { (v_param = (function () { var Hash_a = {};
return(Hash_a) })()); })() };(v_assoc = f_or((function () { if (v_param == null) { v_param = {} }; return (v_param["assoc"] ); })(), function () { return "left"}));(function () { if (v_Operator == null) { v_Operator = {} }; if (v_Operator[v_fixity] == null) { v_Operator[v_fixity] = {} }; return (v_Operator[v_fixity][v_name]  = 1); })();(function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[v_name]  = v_precedence); })();(function () { if (v_Assoc == null) { v_Assoc = {} }; if (v_Assoc[v_assoc] == null) { v_Assoc[v_assoc] = {} }; return (v_Assoc[v_assoc][v_name]  = 1); })();(function () { if (v_Allow_space_before == null) { v_Allow_space_before = {} }; if (v_Allow_space_before[v_fixity] == null) { v_Allow_space_before[v_fixity] = {} }; return (v_Allow_space_before[v_fixity][v_name]  = ( f_bool((function () { if (v_param == null) { v_param = {} }; return (v_param["no_space_before"] ); })()) ? false : true)); })();if ( f_bool(((f_chars(v_name)) == 1)) ) { return (function () { return((function () { if (v_Op1 == null) { v_Op1 = {} }; return (v_Op1[v_name]  = 1); })()) })() } else { return (function () { if ( f_bool(((f_chars(v_name)) == 2)) ) { return (function () { return((function () { if (v_Op2 == null) { v_Op2 = {} }; return (v_Op2[v_name]  = 1); })()) })() } else { return (function () { if ( f_bool(((f_chars(v_name)) == 3)) ) { return (function () { return((function () { if (v_Op3 == null) { v_Op3 = {} }; return (v_Op3[v_name]  = 1); })()) })() } })() } })() } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_token = null;
(v_get_token = v_self.f_get_token());(v_reduce = v_self.f_reduce());(v_last_end_token = v_End_token);(v_End_token = v_self.f_end_token());(v_op_stack = (function () { var List_a = [];
var List_v = [];
return(List_a) })());(v_num_stack = (function () { var List_a = [];
var List_v = [];
return(List_a) })());(v_last = (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push("*start*");return(List_a) })());(v_last_has_space = false);(v_token = (v_get_token)());if ( f_bool(((v_token[0]) == "space")) ) { (function () { (v_token = (v_get_token)()); })() };for ( ; f_bool(f_and(((v_token != null)), function () { return ((v_token[0] != "end"))}));  ) { (function () { if ( f_bool(f_and(((v_token[1] == ",")), function () { return (f_or(((v_last[1] == "*start*")), function () { return ((v_last[1] == ","))}))})) ) { (function () { v_num_stack.push((function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(null);return(List_a) })()); })() };if ( f_bool(f_and((function () { if (v_Operator == null) { v_Operator = {} }; if (v_Operator["prefix"] == null) { v_Operator["prefix"] = {} }; return (v_Operator["prefix"][v_token[1]] ); })(), function () { return (f_or(((v_last[1] == "*start*")), function () { return ( f_bool((v__NAMESPACE.f_is_term(v_last))) ? false : true)}))})) ) { (function () { (function () { if (v_token == null) { v_token = [] }; return (v_token[0]  = "prefix"); })();v_op_stack.unshift(v_token); })() } else { (function () { if ( f_bool(f_and(f_and((function () { if (v_Operator == null) { v_Operator = {} }; if (v_Operator["postfix"] == null) { v_Operator["postfix"] = {} }; return (v_Operator["postfix"][v_token[1]] ); })(), function () { return v__NAMESPACE.f_is_term(v_last)}), function () { return (f_or((function () { if (v_Allow_space_before == null) { v_Allow_space_before = {} }; if (v_Allow_space_before["postfix"] == null) { v_Allow_space_before["postfix"] = {} }; return (v_Allow_space_before["postfix"][v_token[1]] ); })(), function () { return ( f_bool((v_last_has_space)) ? false : true)}))})) ) { (function () { var v_pr = null;
(v_pr = (function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[v_token[1]] ); })());for ( ; f_bool(f_and(f_elems(v_op_stack), function () { return ((v_pr <= (function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[(v_op_stack[0])[1]] ); })()))}));  ) { (function () { (v_reduce)(v_op_stack, v_num_stack); })() };if ( f_bool(((v_token[0]) != "postfix_or_term")) ) { (function () { (function () { if (v_token == null) { v_token = [] }; return (v_token[0]  = "postfix"); })(); })() };v_op_stack.unshift(v_token); })() } else { (function () { if ( f_bool(f_and(f_and(((v_token[1] == "block")), function () { return v__NAMESPACE.f_is_term(v_last)}), function () { return v_last_has_space})) ) { (function () { for ( ; f_bool(f_elems(v_op_stack));  ) { (function () { (v_reduce)(v_op_stack, v_num_stack); })() };v_num_stack.push(v_token);(v_End_token = v_last_end_token);throw(v_num_stack); })() } else { (function () { if ( f_bool(v__NAMESPACE.f_is_term(v_token)) ) { (function () { if ( f_bool(v__NAMESPACE.f_is_term(v_last)) ) { (function () { f_say((f_string("#      last:  ")), f_perl(v_last));f_say((f_string("#      token: ")), f_perl(v_token));f_say((f_string("#      space: ")), v_last_has_space);f_die((f_string("Value tokens must be separated by an operator"))); })() };(function () { if (v_token == null) { v_token = [] }; return (v_token[0]  = "term"); })();v_num_stack.push(v_token); })() } else { (function () { if ( f_bool((function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[v_token[1]] ); })()) ) { (function () { var v_pr = null;
(v_pr = (function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[v_token[1]] ); })());if ( f_bool((function () { if (v_Assoc == null) { v_Assoc = {} }; if (v_Assoc["right"] == null) { v_Assoc["right"] = {} }; return (v_Assoc["right"][v_token[1]] ); })()) ) { (function () { for ( ; f_bool(f_and(f_elems(v_op_stack), function () { return ((v_pr < (function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[(v_op_stack[0])[1]] ); })()))}));  ) { (function () { (v_reduce)(v_op_stack, v_num_stack); })() }; })() } else { (function () { for ( ; f_bool(f_and(f_elems(v_op_stack), function () { return ((v_pr <= (function () { if (v_Precedence == null) { v_Precedence = {} }; return (v_Precedence[(v_op_stack[0])[1]] ); })()))}));  ) { (function () { (v_reduce)(v_op_stack, v_num_stack); })() }; })() };if ( f_bool((function () { if (v_Operator == null) { v_Operator = {} }; if (v_Operator["ternary"] == null) { v_Operator["ternary"] = {} }; return (v_Operator["ternary"][v_token[1]] ); })()) ) { (function () { (function () { if (v_token == null) { v_token = [] }; return (v_token[0]  = "ternary"); })(); })() } else { (function () { (function () { if (v_token == null) { v_token = [] }; return (v_token[0]  = "infix"); })(); })() };v_op_stack.unshift(v_token); })() } else { (function () { f_die((f_string("Unknown token: '")), v_token[1], (f_string("'"))); })() }; })() }; })() }; })() }; })() };(v_last = v_token);(v_token = (v_get_token)());if ( f_bool((v_token[0] == "space")) ) { (function () { (v_token = (v_get_token)());(v_last_has_space = true); })() } else { (function () { (v_last_has_space = false); })() }; })() };if ( f_bool(f_and((v_token != null), function () { return ((v_token[0] != "end"))})) ) { (function () { f_die((f_string("Unexpected end token: ")), f_perl(v_token)); })() };for ( ; f_bool(f_elems(v_op_stack));  ) { (function () { (v_reduce)(v_op_stack, v_num_stack); })() };(v_End_token = v_last_end_token);throw(v_num_stack) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  Perlito$Precedence.f_precedence_parse;  // v8 bug workaround
(v_Operator = (function () { var Hash_a = {};
return(Hash_a) })());(v_Precedence = (function () { var Hash_a = {};
return(Hash_a) })());(v_Assoc = (function () { var Hash_a = {};
return(Hash_a) })());(v_Allow_space_before = (function () { var Hash_a = {};
return(Hash_a) })());(v_prec = 100);v__NAMESPACE.f_add_op("postfix", ".( )", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", ".[ ]", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", ".{ }", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "( )", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "[ ]", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "funcall", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "funcall_no_params", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "methcall", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "methcall_no_params", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "block", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "hash", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("prefix", "++", v_prec);v__NAMESPACE.f_add_op("prefix", "--", v_prec);v__NAMESPACE.f_add_op("postfix", "++", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());v__NAMESPACE.f_add_op("postfix", "--", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["no_space_before"]  = true); })();return(Hash_a) })());(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "**", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "right"); })();return(Hash_a) })());(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("prefix", "+", v_prec);v__NAMESPACE.f_add_op("prefix", "-", v_prec);v__NAMESPACE.f_add_op("prefix", "$", v_prec);v__NAMESPACE.f_add_op("prefix", "@", v_prec);v__NAMESPACE.f_add_op("prefix", "%", v_prec);v__NAMESPACE.f_add_op("prefix", "!", v_prec);v__NAMESPACE.f_add_op("prefix", "?", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "*", v_prec);v__NAMESPACE.f_add_op("infix", "/", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "+", v_prec);v__NAMESPACE.f_add_op("infix", "-", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "~", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "list"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("prefix", "~", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "&", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "list"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("prefix", "&", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "|", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "list"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("prefix", "|", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "<=>", v_prec);v__NAMESPACE.f_add_op("infix", "leg", v_prec);v__NAMESPACE.f_add_op("infix", "cmp", v_prec);v__NAMESPACE.f_add_op("infix", "does", v_prec);v__NAMESPACE.f_add_op("infix", "but", v_prec);v__NAMESPACE.f_add_op("infix", "..", v_prec);v__NAMESPACE.f_add_op("infix", "^..", v_prec);v__NAMESPACE.f_add_op("infix", "..^", v_prec);v__NAMESPACE.f_add_op("infix", "^..^", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "===", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "ne", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "eq", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "lt", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "le", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "gt", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "ge", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "<=", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", ">=", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "==", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "!=", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "<", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", ">", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", "~~", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "chain"); })();return(Hash_a) })());(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "&&", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "||", v_prec);v__NAMESPACE.f_add_op("infix", "//", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("ternary", "?? !!", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "=", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "right"); })();return(Hash_a) })());v__NAMESPACE.f_add_op("infix", ":=", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "right"); })();return(Hash_a) })());(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("prefix", "not", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "=>", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("list", ",", v_prec, (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["assoc"]  = "list"); })();return(Hash_a) })());(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "and", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "or", v_prec);(v_prec = (v_prec - 1));v__NAMESPACE.f_add_op("infix", "*start*", v_prec);})();
;// use v6
;// class Perl5
...
(function () {
  ...
  Perl5.f_to_bool = function (v_cond) {
    try { if ( f_bool(f_or(f_or(f_or(f_isa(v_cond, "Val::Num"), function () { return f_isa(v_cond, "Val::Buf")}), function () { return f_isa(v_cond, "Val::Int")}), function () { return (f_and(f_isa(v_cond, "Apply"), function () { return (f_or(f_or(((v_cond.f_code() == "bool")), function () { return ((v_cond.f_code() == "True"))}), function () { return ((v_cond.f_code() == "False"))}))}))})) ) { (function () { throw(v_cond); })() };throw((function () { var tmp = {v_code: "bool",v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v_cond);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
})();
;// class CompUnit
if (typeof CompUnit != 'object') {
...
(function () {
  ...
  CompUnit.f_emit_perl5 = function () {
    var v_self = this;
    try { var List_body = [];
(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v__) { if ( f_bool((v__ != null)) ) { (function () { f_push(List_body, v__); })() }; })(a_[i_]) } })(v_self.v_body);return((f_string("{") + f_string("\n") + f_string("package ") + f_string(v_self.v_name) + f_string((f_string(";"))) + f_string((f_string("\n"))) + f_string("sub new { shift; bless { @_ }, \"") + f_string(v_self.v_name) + f_string("\" }") + f_string((f_string("\n"))) + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(List_body)).join((f_string(";") + f_string((f_string("\n")))))) + f_string((f_string("\n"))) + f_string((f_string("}") + f_string("\n"))) + f_string((f_string("\n"))))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  CompUnit.f_emit_perl5;  // v8 bug workaround
  // sub emit_perl5_program
  CompUnit.f_emit_perl5_program = function (v_comp_units) {
    try { var v_str = null;
(v_str = (f_string("") + f_string((f_string("use v5;") + f_string("\n"))) + f_string((f_string("use utf8;") + f_string("\n"))) + f_string((f_string("use strict;") + f_string("\n"))) + f_string((f_string("use warnings;") + f_string("\n"))) + f_string((f_string("no warnings ('redefine', 'once', 'void', 'uninitialized', 'misc', 'recursion');") + f_string("\n"))) + f_string((f_string("use Perlito::Perl5::Runtime;") + f_string("\n"))) + f_string((f_string("use Perlito::Perl5::Prelude;") + f_string("\n"))) + f_string((f_string("our ") + f_string("$") + f_string("MATCH = Perlito::Match->new();") + f_string("\n")))));(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_comp_unit) { (v_str = (f_string(v_str) + f_string(v_comp_unit.f_emit_perl5()))); })(a_[i_]) } })(((v_comp_units)));(v_str = (f_string(v_str) + f_string((f_string("1;") + f_string("\n")))));throw(v_str) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
})();
;// class Val::Int
if (typeof Val$Int != 'object') {
...
(function () {
  ...
  Val$Buf.f_emit_perl5 = function () {
    var v_self = this;
    try { return((f_string("'") + f_string(Main.f_perl_escape_string(v_self.v_buf)) + f_string("'"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Lit$Block.f_emit_perl5 = function () {
    var v_self = this;
    try { var List_body = [];
(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v__) { if ( f_bool((v__ != null)) ) { (function () { f_push(List_body, v__); })() }; })(a_[i_]) } })(v_self.v_stmts);return(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(List_body)).join("; ")) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Lit$Array.f_emit_perl5 = function () {
    var v_self = this;
    try { var v_ast = null;
(v_ast = v_self.f_expand_interpolation());throw(v_ast.f_emit_perl5()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Index.f_emit_perl5 = function () {
    var v_self = this;
    try { return((f_string(v_self.v_obj.f_emit_perl5()) + f_string("->[") + f_string(v_self.v_index_exp.f_emit_perl5()) + f_string("]"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_ns = null;
(v_table = (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["$"]  = "$"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["@"]  = "$List_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["%"]  = "$Hash_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["&"]  = "$Code_"); })();return(Hash_a) })());(v_ns = "");if ( f_bool(v_self.v_namespace) ) { (function () { (v_ns = (f_string(v_self.v_namespace) + f_string("::"))); })() } else { (function () { if ( f_bool(f_and(f_and(((v_self.v_sigil == "@")), function () { return ((v_self.v_twigil == "*"))}), function () { return ((v_self.v_name == "ARGS"))})) ) { (function () { throw("(\\@ARGV)"); })() };if ( f_bool((v_self.v_twigil == ".")) ) { (function () { throw((f_string("$self->{") + f_string(v_self.v_name) + f_string("}"))); })() };if ( f_bool((v_self.v_name == "/")) ) { (function () { throw((f_string((function () { if (v_table == null) { v_table = {} }; return (v_table[v_self.v_sigil] ); })()) + f_string("MATCH"))); })() }; })() };throw((f_string((function () { if (v_table == null) { v_table = {} }; return (v_table[v_self.v_sigil] ); })()) + f_string(v_ns) + f_string(v_self.v_name))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_meth = null;
var v_call = null;
(v_invocant = v_self.v_invocant.f_emit_perl5());if ( f_bool((v_invocant == "self")) ) { (function () { (v_invocant = "$self"); })() };if ( f_bool(f_or(((v_self.v_method == "values")), function () { return ((v_self.v_method == "keys"))})) ) { (function () { if ( f_bool((v_self.v_hyper)) ) { (function () { f_die((f_string("not implemented"))); })() } else { (function () { throw((f_string("[") + f_string(v_self.v_method) + f_string("( %{") + f_string(v_invocant) + f_string("} )") + f_string("]"))); })() }; })() };if ( f_bool(f_or(f_or(f_or(f_or(f_or(f_or(f_or(((v_self.v_method == "perl")), function () { return ((v_self.v_method == "id"))}), function () { return ((v_self.v_method == "yaml"))}), function () { return ((v_self.v_method == "say"))}), function () { return ((v_self.v_method == "join"))}), function () { return ((v_self.v_method == "chars"))}), function () { return ((v_self.v_method == "isa"))}), function () { return ((v_self.v_method == "pairs"))})) ) { (function () { if ( f_bool((v_self.v_hyper)) ) { (function () { throw((f_string("[ map { Main::") + f_string(v_self.v_method) + f_string("( $_, ") + f_string(", ") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")") + f_string(" } @{( ") + f_string(v_invocant) + f_string(" )} ]"))); })() } else { (function () { throw((f_string("Main::") + f_string(v_self.v_method) + f_string("(") + f_string(v_invocant) + f_string(", ") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() }; })() };if ( f_bool((v_self.v_method == "push")) ) { (function () { throw((f_string("push( @{") + f_string(v_invocant) + f_string("}, ") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(" )"))); })() };if ( f_bool((v_self.v_method == "unshift")) ) { (function () { throw((f_string("unshift( @{") + f_string(v_invocant) + f_string("}, ") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(" )"))); })() };if ( f_bool((v_self.v_method == "pop")) ) { (function () { throw((f_string("pop( @{") + f_string(v_invocant) + f_string("} )"))); })() };if ( f_bool((v_self.v_method == "shift")) ) { (function () { throw((f_string("shift( @{") + f_string(v_invocant) + f_string("} )"))); })() };if ( f_bool((v_self.v_method == "elems")) ) { (function () { throw((f_string("scalar( @{") + f_string(v_invocant) + f_string("} )"))); })() };(v_meth = v_self.v_method);if ( f_bool((v_meth == "postcircumfix:<( )>")) ) { (function () { (v_meth = ""); })() };(v_call = (f_string("->") + f_string(v_meth) + f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")")));if ( f_bool((v_self.v_hyper)) ) { return (function () { if ( f_bool(( f_bool((f_and(f_isa(v_self.v_invocant, "Apply"), function () { return (v_self.v_invocant.f_code() == "prefix:<@>")}))) ? false : true)) ) { (function () { (v_invocant = (f_string("@{( ") + f_string(v_invocant) + f_string(" )}"))); })() };throw((f_string("[ map { $_") + f_string(v_call) + f_string(" } ") + f_string(v_invocant) + f_string(" ]"))) })() } else { return (function () { return((f_string(v_invocant) + f_string(v_call))) })() } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Apply.f_emit_perl5 = function () {
    ...
    try { var v_ns = null;
var v_code = null;
(v_ns = "");if ( f_bool(v_self.v_namespace) ) { (function () { (v_ns = (f_string(v_self.v_namespace) + f_string("::"))); })() };(v_code = (f_string(v_ns) + f_string(v_self.v_code)));if ( f_bool(f_isa(v_code, "Str")) ) { (function () { null })() } else { (function () { throw((f_string("(") + f_string(v_self.v_code.f_emit_perl5()) + f_string(")->(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };if ( f_bool((v_code == "self")) ) { (function () { throw("$self"); })() };if ( f_bool((v_code == "Mu")) ) { (function () { throw("undef"); })() };if ( f_bool((v_code == "make")) ) { (function () { throw((f_string("($MATCH->{capture} = (") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string("))"))); })() };if ( f_bool((v_code == "say")) ) { (function () { throw((f_string("Main::say(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };if ( f_bool((v_code == "print")) ) { (function () { throw((f_string("Main::print(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };if ( f_bool((v_code == "warn")) ) { (function () { throw((f_string("warn(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };if ( f_bool((v_code == "array")) ) { (function () { throw((f_string("@{") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string("}"))); })() };if ( f_bool((v_code == "pop")) ) { (function () { throw((f_string("pop( @{") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string("} )"))); })() };if ( f_bool((v_code == "push")) ) { (function () { throw((f_string("push( @{") + f_string((v_self.v_arguments[0]).f_emit_perl5()) + f_string("}, ") + f_string((v_self.v_arguments[1]).f_emit_perl5()) + f_string(" )"))); })() };if ( f_bool((v_code == "shift")) ) { (function () { throw((f_string("shift( @{") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string("} )"))); })() };if ( f_bool((v_code == "unshift")) ) { (function () { throw((f_string("unshift( @{") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string("} )"))); })() };if ( f_bool((v_code == "Int")) ) { (function () { throw((f_string("(0+") + f_string((v_self.v_arguments[0]).f_emit_perl5()) + f_string(")"))); })() };if ( f_bool((v_code == "Num")) ) { (function () { throw((f_string("(0+") + f_string((v_self.v_arguments[0]).f_emit_perl5()) + f_string(")"))); })() };if ( f_bool((v_code == "bool")) ) { (function () { throw((f_string("Main::bool(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };if ( f_bool((v_code == "prefix:<~>")) ) { (function () { throw((f_string("(\"\" . ") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")"))); })() };if ( f_bool((v_code == "prefix:<!>")) ) { (function () { throw((f_string("!Main::bool(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")"))); })() };if ( f_bool((v_code == "prefix:<?>")) ) { (function () { throw((f_string("Main::bool(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")"))); })() };if ( f_bool((v_code == "prefix:<$>")) ) { (function () { throw((f_string("${") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string("}"))); })() };if ( f_bool((v_code == "prefix:<@>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(" || [])"))); })() };if ( f_bool((v_code == "prefix:<%>")) ) { (function () { throw((f_string("%{") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string("}"))); })() };if ( f_bool((v_code == "postfix:<++>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")++"))); })() };if ( f_bool((v_code == "postfix:<-->")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")--"))); })() };if ( f_bool((v_code == "prefix:<++>")) ) { (function () { throw((f_string("++(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")"))); })() };if ( f_bool((v_code == "prefix:<-->")) ) { (function () { throw((f_string("--(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ")) + f_string(")"))); })() };if ( f_bool((v_code == "list:<~>")) ) { (function () { throw((f_string("") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" . ")) + f_string(""))); })() };if ( f_bool((v_code == "infix:<+>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" + ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<->")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" - ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<*>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" * ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:</>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" / ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<>>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" > ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<<>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" < ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<>=>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" >= ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<<=>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" <= ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<x>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" x ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<&&>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" && ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<||>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" || ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<and>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" and ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<or>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" or ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<//>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" // ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<eq>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" eq ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<ne>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ne ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<le>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" le ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<ge>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" ge ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<==>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" == ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<!=>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" != ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<=>>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" => ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<..>")) ) { (function () { throw((f_string("[") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(" .. ")) + f_string("]"))); })() };if ( f_bool((v_code == "infix:<===>")) ) { (function () { throw((f_string("(Main::id(") + f_string((v_self.v_arguments[0]).f_emit_perl5()) + f_string(") eq Main::id(") + f_string((v_self.v_arguments[1]).f_emit_perl5()) + f_string("))"))); })() };if ( f_bool((v_code == "ternary:<?? !!>")) ) { (function () { var v_cond = null;
(v_cond = v_self.v_arguments[0]);if ( f_bool(f_and(f_isa(v_cond, "Var"), function () { return (v_cond.f_sigil() == "@")})) ) { (function () { (v_cond = (function () { var tmp = {v_code: "prefix:<@>",v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v_cond);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })()); })() };throw((f_string("(") + f_string(Perl5.f_to_bool(v_cond).f_emit_perl5()) + f_string(" ? ") + f_string((v_self.v_arguments[1]).f_emit_perl5()) + f_string(" : ") + f_string((v_self.v_arguments[2]).f_emit_perl5()) + f_string(")"))); })() };if ( f_bool((v_code == "circumfix:<( )>")) ) { (function () { throw((f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };if ( f_bool((v_code == "infix:<=>")) ) { (function () { throw(v__NAMESPACE.f_emit_perl5_bind(v_self.v_arguments[0], v_self.v_arguments[1])); })() };if ( f_bool((v_code == "return")) ) { (function () { if ( f_bool(f_and(v_self.v_arguments, function () { return (f_elems(v_self.v_arguments) == 1)})) ) { (function () { throw((f_string("return scalar (") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };throw((f_string("return (") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))); })() };return((f_string(v_code) + f_string("(") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_arguments)).join(", ")) + f_string(")"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  Apply.f_emit_perl5;  // v8 bug workaround
  // sub emit_perl5_bind
  Apply.f_emit_perl5_bind = function (v_parameters, v_arguments) {
    try { if ( f_bool(f_isa(v_parameters, "Call")) ) { (function () { var v_a = null;
(v_a = v_parameters);throw((f_string("((") + f_string((v_a.f_invocant()).f_emit_perl5()) + f_string(")->{") + f_string(v_a.f_method()) + f_string("} = ") + f_string(v_arguments.f_emit_perl5()) + f_string(")"))); })() };if ( f_bool(f_isa(v_parameters, "Lit::Array")) ) { (function () { var v_a = null;
var v_str = null;
var v_i = null;
(v_a = v_parameters.f_array1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_str = (f_string(v_str) + f_string(" ") + f_string(v__NAMESPACE.f_emit_perl5_bind(v_var, (function () { var tmp = {v_obj: v_arguments,v_index_exp: (function () { var tmp = {v_int: v_i}; tmp.__proto__ = Val$Int; return tmp })()}; tmp.__proto__ = Index; return tmp })())) + f_string("; ")));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_a));throw((f_string(v_str) + f_string(v_parameters.f_emit_perl5()) + f_string(" }"))); })() };if ( f_bool(f_isa(v_parameters, "Lit::Hash")) ) { (function () { var v_a = null;
var v_b = null;
var v_str = null;
var v_i = null;
var v_arg = null;
(v_a = v_parameters.f_hash1());(v_b = v_arguments.f_hash1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = (function () { var tmp = {v_code: "Mu",v_arguments: (function () { var List_a = [];
var List_v = [];
return(List_a) })()}; tmp.__proto__ = Apply; return tmp })());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool(((v_var2[0]).f_buf() == (v_var[0]).f_buf())) ) { (function () { (v_arg = v_var2[1]); })() }; })(a_[i_]) } })((v_b));(v_str = (f_string(v_str) + f_string(" ") + f_string(v__NAMESPACE.f_emit_perl5_bind(v_var[1], v_arg)) + f_string("; ")));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_a));throw((f_string(v_str) + f_string(v_parameters.f_emit_perl5()) + f_string(" }"))); })() };if ( f_bool(f_or(f_and(f_isa(v_parameters, "Var"), function () { return (v_parameters.f_sigil() == "@")}), function () { return f_and(f_isa(v_parameters, "Decl"), function () { return (v_parameters.f_var().f_sigil() == "@")})})) ) { (function () { (v_arguments = (function () { var tmp = {v_array1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_arguments);return(List_a) })()}; tmp.__proto__ = Lit$Array; return tmp })()); })() } else { (function () { if ( f_bool(f_or(f_and(f_isa(v_parameters, "Var"), function () { return (v_parameters.f_sigil() == "%")}), function () { return f_and(f_isa(v_parameters, "Decl"), function () { return (v_parameters.f_var().f_sigil() == "%")})})) ) { (function () { (v_arguments = (function () { var tmp = {v_hash1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_arguments);return(List_a) })()}; tmp.__proto__ = Lit$Hash; return tmp })()); })() }; })() };return((f_string("(") + f_string(v_parameters.f_emit_perl5()) + f_string(" = ") + f_string(v_arguments.f_emit_perl5()) + f_string(")"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
})();
;// class If
if (typeof If != 'object') {
...
(function () {
  ...
  If.f_emit_perl5 = function () {
    var v_self = this;
    try { throw((f_string("if (") + f_string(Perl5.f_to_bool(v_self.v_cond).f_emit_perl5()) + f_string(") { ") + f_string(((v_self.v_body).f_emit_perl5())) + f_string(" } ") + f_string((( f_bool(v_self.v_otherwise) ? ((f_string("else { ") + f_string(((v_self.v_otherwise).f_emit_perl5())) + f_string(" }"))) : ""))))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_cond = v_self.v_cond);if ( f_bool(f_and(f_isa(v_cond, "Var"), function () { return (v_cond.f_sigil() == "@")})) ) { (function () { (v_cond = (function () { var tmp = {v_code: "prefix:<@>",v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v_cond);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })()); })() };return((f_string("for ( ") + f_string((( f_bool(v_self.v_init) ? (f_string(v_self.v_init.f_emit_perl5()) + f_string("; ")) : "; "))) + f_string((( f_bool(v_cond) ? (f_string(Perl5.f_to_bool(v_cond).f_emit_perl5()) + f_string("; ")) : "; "))) + f_string((( f_bool(v_self.v_continue) ? (f_string(v_self.v_continue.f_emit_perl5()) + f_string(" ")) : " "))) + f_string(") { ") + f_string(v_self.v_body.f_emit_perl5()) + f_string(" }"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_cond = v_self.v_cond);if ( f_bool(( f_bool((f_and(f_isa(v_cond, "Var"), function () { return (v_cond.f_sigil() == "@")}))) ? false : true)) ) { (function () { (v_cond = (function () { var tmp = {v_array1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_cond);return(List_a) })()}; tmp.__proto__ = Lit$Array; return tmp })()); })() };if ( f_bool(v_self.v_body.f_sig()) ) { (function () { (v_sig = (f_string("my ") + f_string(v_self.v_body.f_sig().f_emit_perl5()) + f_string(" "))); })() };throw((f_string("for ") + f_string(v_sig) + f_string("( @{") + f_string(v_cond.f_emit_perl5()) + f_string(" || []} ) { ") + f_string(v_self.v_body.f_emit_perl5()) + f_string(" }"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_name = null;
var v_str = null;
(v_decl = v_self.v_decl);(v_name = v_self.v_var.f_plain_name());if ( f_bool((v_decl == "has")) ) { (function () { throw((f_string("sub ") + f_string(v_name) + f_string(" { $_[0]->{") + f_string(v_name) + f_string("} }"))); })() };(v_str = (f_string("(") + f_string(v_self.v_decl) + f_string(" ") + f_string(v_self.v_type) + f_string(" ") + f_string(v_self.v_var.f_emit_perl5()) + f_string(" = ")));if ( f_bool(((v_self.v_var).f_sigil() == "%")) ) { (function () { (v_str = (f_string(v_str) + f_string("{})"))); })() } else { (function () { if ( f_bool(((v_self.v_var).f_sigil() == "@")) ) { (function () { (v_str = (f_string(v_str) + f_string("[])"))); })() } else { (function () { (v_str = (f_string(v_str) + f_string("undef)"))); })() }; })() };throw(v_str) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_str = null;
var v_i = null;
(v_sig = v_self.v_sig);(v_invocant = v_sig.f_invocant());(v_pos = v_sig.f_positional());(v_str = "");(v_i = 1);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = (f_string(v_str) + f_string("my ") + f_string(v_field.f_emit_perl5()) + f_string(" = $_[") + f_string(v_i) + f_string("]; ")));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_pos));return((f_string("sub ") + f_string(v_self.v_name) + f_string(" { ") + f_string("my ") + f_string(v_invocant.f_emit_perl5()) + f_string(" = $_[0]; ") + f_string(v_str) + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_block)).join("; ")) + f_string(" }"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_str = null;
var v_i = null;
(v_sig = v_self.v_sig);(v_pos = v_sig.f_positional());(v_str = "");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = (f_string(v_str) + f_string("my ") + f_string(v_field.f_emit_perl5()) + f_string(" = $_[") + f_string(v_i) + f_string("]; ")));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_pos));return((f_string("sub ") + f_string(v_self.v_name) + f_string(" { ") + f_string(v_str) + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_self.v_block)).join("; ")) + f_string(" }"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Do.f_emit_perl5 = function () {
    var v_self = this;
    try { var v_block = null;
(v_block = v_self.f_simplify().f_block());return((f_string("do { ") + f_string(((function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_perl5() ) }; return out; })(v_block)).join("; ")) + f_string(" }"))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Use.f_emit_perl5 = function () {
    var v_self = this;
    try { if ( f_bool((v_self.v_mod == "v6")) ) { (function () { throw((f_string("\n") + f_string("# use ") + f_string(v_self.v_mod) + f_string(" ") + f_string("\n"))); })() };return((f_string("use ") + f_string(v_self.v_mod))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_args = (function () { var List_a = [];
var List_v = [];
return(List_a) })());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_v) { if ( f_bool((v_v != null)) ) { (function () { v_args.push(v_v); })() }; })(a_[i_]) } })(((v_param_list.f_arguments())));throw(v_args) })() } else { return (function () { if ( f_bool((v_param_list == "*undef*")) ) { return (function () { throw((function () { var List_a = [];
var List_v = [];
return(List_a) })()) })() } else { return (function () { throw((function () { var List_a = [];
var List_v = [];
List_a.push(v_param_list);return(List_a) })()) })() } })() } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  // sub block_or_hash
  Perlito$Expression.f_block_or_hash = function (v_o) {
    try { var v_stmts = null;
var v_stmt = null;
if ( f_bool((v_o.f_sig() != null)) ) { (function () { throw(v_o); })() };(v_stmts = v_o.f_stmts());if ( f_bool(f_or((( f_bool(((v_stmts != null))) ? false : true)), function () { return (((f_elems(v_stmts)) == 0))})) ) { (function () { throw((function () { var tmp = {v_hash1: (function () { var List_a = [];
var List_v = [];
return(List_a) })()}; tmp.__proto__ = Lit$Hash; return tmp })()); })() };if ( f_bool(((f_elems(v_stmts)) != 1)) ) { (function () { throw(v_o); })() };(v_stmt = v_stmts[0]);if ( f_bool(( f_bool((f_isa(v_stmt, "Apply"))) ? false : true)) ) { (function () { throw(v_o); })() };if ( f_bool(((v_stmt.f_code()) == "infix:<=>>")) ) { (function () { throw((function () { var tmp = {v_hash1: (function () { var List_a = [];
var List_v = [];
List_a.push(v_stmt);return(List_a) })()}; tmp.__proto__ = Lit$Hash; return tmp })()); })() };if ( f_bool(((v_stmt.f_code()) != "list:<,>")) ) { (function () { throw(v_o); })() };(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_item) { if ( f_bool(f_and(f_isa(v_item, "Apply"), function () { return ((v_item.f_code()) == "infix:<=>>")})) ) { (function () { throw((function () { var tmp = {v_hash1: v__NAMESPACE.f_expand_list(v_stmt)}; tmp.__proto__ = Lit$Hash; return tmp })()); })() }; })(a_[i_]) } })(((v_stmt.f_arguments())));throw(v_o) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  // sub pop_term
  Perlito$Expression.f_pop_term = function (v_num_stack) {
    try { var v_v = null;
(v_v = v_num_stack.pop());if ( f_bool(f_isa(v_v, "Array")) ) { (function () { if ( f_bool((v_v[1] == "methcall_no_params")) ) { (function () { (v_v = (function () { var tmp = {v_invocant: null,v_method: v_v[2],v_hyper: v_v[3]}; tmp.__proto__ = Call; return tmp })());throw(v_v); })() };if ( f_bool((v_v[1] == "funcall_no_params")) ) { (function () { (v_v = (function () { var tmp = {v_code: v_v[3],v_namespace: v_v[2]}; tmp.__proto__ = Apply; return tmp })());throw(v_v); })() };if ( f_bool((v_v[1] == "methcall")) ) { (function () { var v_param_list = null;
...
(v_param_list = v__NAMESPACE.f_expand_list(v_v[2]));(v_v = (function () { var tmp = {v_array1: v_param_list}; tmp.__proto__ = Lit$Array; return tmp })());throw(v_v); })() };if ( f_bool((v_v[1] == "block")) ) { (function () { (v_v = (function () { var tmp = {v_stmts: v_v[2],v_sig: v_v[3]}; tmp.__proto__ = Lit$Block; return tmp })());(v_v = v__NAMESPACE.f_block_or_hash(v_v));throw(v_v); })() };if ( f_bool((v_v[1] == ".( )")) ) { (function () { (v_v = (function () { var tmp = {v_invocant: null,v_method: "postcircumfix:<( )>",v_arguments: v_v[2],v_hyper: 0}; tmp.__proto__ = Call; return tmp })());throw(v_v); })() };if ( f_bool((v_v[1] == ".[ ]")) ) { (function () { (v_v = (function () { var tmp = {v_obj: null,v_index_exp: v_v[2]}; tmp.__proto__ = Index; return tmp })());throw(v_v); })() };if ( f_bool((v_v[1] == ".{ }")) ) { (function () { (v_v = (function () { var tmp = {v_obj: null,v_index_exp: v_v[2]}; tmp.__proto__ = Lookup; return tmp })());throw(v_v); })() };if ( f_bool(f_and(f_isa((v_v[1]), "Array"), function () { return (((f_elems((v_v[1]))) == 2))})) ) { (function () { (v_v = (function () { var tmp = {v_code: "pair",v_arguments: v_v[1],v_namespace: ""}; tmp.__proto__ = Apply; return tmp })());throw(v_v); })() };throw(v_v[1]); })() };throw(v_v) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  ...
  Perlito$Expression.f_reduce_postfix = function (v_op, v_value) {
    try { var v_v = null;
(v_v = v_op);if ( f_bool((v_v[1] == "methcall_no_params")) ) { (function () { (v_v = (function () { var tmp = {v_invocant: v_value,v_method: v_v[2],v_hyper: v_v[3]}; tmp.__proto__ = Call; return tmp })());throw(v_v); })() };if ( f_bool((v_v[1] == "funcall_no_params")) ) { (function () { f_die((f_string("unexpected function call")));f_push(v_v, v_value);throw(v_v); })() };if ( f_bool((v_v[1] == "methcall")) ) { (function () { var v_param_list = null;
...
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { var v_pos1 = null;
...
(v_m2 = Perlito$Grammar.f_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());if ( f_bool((v_MATCH).hasOwnProperty("Perlito::Grammar.ident")) ) { (function () { ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).push(v_m2); })() } else { (function () { (function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"]  = (function () { var List_a = [];
var List_v = [];
List_a.push(v_m2);return(List_a) })()); })(); })() };return(1) })() } else { return (function () { return(false) })() } })())})) })())) })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())})) })())) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  ...
  Perlito$Expression.f_hyper_op = function (v_str, v_pos) {
    ...
    try { var v_MATCH = null;
(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = (((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_last_pos = null;
...
(v_m2 = v_grammar.f_paren_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["paren_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and((")" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push(".( )");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["paren_parse"] ); })()));return(List_a) })())) })()), function () { return 1}))})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and((".[" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_square_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["square_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and(("]" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push(".[ ]");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["square_parse"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and((".{" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_curly_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["curly_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and(("}" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push(".{ }");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["curly_parse"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("(" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_paren_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["paren_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and((")" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push("( )");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["paren_parse"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("[" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_square_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["square_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and(("]" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
...
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { var v_m2 = null;
...
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())}), function () { return (f_and(("}" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push("block");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.exp_stmts"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("method" == (v_str || "").substr(v_MATCH.f_to(), 6)), function () { return ((v_MATCH.v_to = f_add(6, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
...
(v_m2 = Perlito$Grammar.f_method_def(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.method_def"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.method_def"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("sub" == (v_str || "").substr(v_MATCH.f_to(), 3)), function () { return ((v_MATCH.v_to = f_add(3, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())}), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_sub_def(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.sub_def"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.sub_def"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("token" == (v_str || "").substr(v_MATCH.f_to(), 5)), function () { return ((v_MATCH.v_to = f_add(5, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())}), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_token(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.token"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.token"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("do" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())}), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_statement_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["statement_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_block: f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["statement_parse"] ); })())}; tmp.__proto__ = Do; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("??" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_ternary_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["ternary_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and(("!!" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push("?? !!");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["ternary_parse"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_var_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.var_ident"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.var_ident"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("$<" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_capture_name(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["capture_name"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and((">" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_obj: (function () { var tmp = {v_sigil: "$",v_twigil: "",v_name: "/"}; tmp.__proto__ = Var; return tmp })(),v_index_exp: (function () { var tmp = {v_buf: ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["capture_name"] ); })()).f_string()}; tmp.__proto__ = Val$Buf; return tmp })()}; tmp.__proto__ = Lookup; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_m2 = null;
...
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })()), function () { return (f_and(("=>" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))}))})) })())) })()));(v_tmp.v_bool = ( f_bool(v_MATCH) ? true : false));(v_MATCH = v_tmp);return(( f_bool(v_MATCH) ? true : false)) })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_buf: ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).f_string()}; tmp.__proto__ = Val$Buf; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and((f_and(("True" == (v_str || "").substr(v_MATCH.f_to(), 4)), function () { return ((v_MATCH.v_to = f_add(4, v_MATCH.f_to())))})), function () { return ((function () { var v_tmp = null;
(v_tmp = v_MATCH);(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_tmp.f_to(),v_to: v_tmp.f_to(),v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = ((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(f_or(((function () { var v_m2 = null;
...
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_bit: 1}; tmp.__proto__ = Val$Bit; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and((f_and(("False" == (v_str || "").substr(v_MATCH.f_to(), 5)), function () { return ((v_MATCH.v_to = f_add(5, v_MATCH.f_to())))})), function () { return ((function () { var v_tmp = null;
(v_tmp = v_MATCH);(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_tmp.f_to(),v_to: v_tmp.f_to(),v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = ((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(f_or(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_word(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_and(("(" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})))) })())})) })())) })()));(v_tmp.v_bool = ( f_bool(v_MATCH) ? false : true));(v_MATCH = v_tmp);return(( f_bool(v_MATCH) ? true : false)) })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_bit: 0}; tmp.__proto__ = Val$Bit; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and((f_and(("and" == (v_str || "").substr(v_MATCH.f_to(), 3)), function () { return ((v_MATCH.v_to = f_add(3, v_MATCH.f_to())))})), function () { return ((function () { var v_tmp = null;
(v_tmp = v_MATCH);(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_tmp.f_to(),v_to: v_tmp.f_to(),v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = ((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(f_or(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_word(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_and(("(" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})))) })())})) })())) })()));(v_tmp.v_bool = ( f_bool(v_MATCH) ? false : true));(v_MATCH = v_tmp);return(( f_bool(v_MATCH) ? true : false)) })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push("and");return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and((f_and(("not" == (v_str || "").substr(v_MATCH.f_to(), 3)), function () { return ((v_MATCH.v_to = f_add(3, v_MATCH.f_to())))})), function () { return ((function () { var v_tmp = null;
(v_tmp = v_MATCH);(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_tmp.f_to(),v_to: v_tmp.f_to(),v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = ((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(f_or(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_word(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_and(("(" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})))) })())})) })())) })()));(v_tmp.v_bool = ( f_bool(v_MATCH) ? false : true));(v_MATCH = v_tmp);return(( f_bool(v_MATCH) ? true : false)) })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("op");List_a.push("not");return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and(f_and(f_and((f_and(("use" == (v_str || "").substr(v_MATCH.f_to(), 3)), function () { return ((v_MATCH.v_to = f_add(3, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())}), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_full_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.full_ident"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return ((function () { var v_last_pos = null;
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { return(f_and((f_and(("-" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());if ( f_bool((v_MATCH).hasOwnProperty("Perlito::Grammar.ident")) ) { (function () { ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).push(v_m2); })() } else { (function () { (function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"]  = (function () { var List_a = [];
var List_v = [];
List_a.push(v_m2);return(List_a) })()); })(); })() };return(1) })() } else { return (function () { return(false) })() } })())})) })())) })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())}), function () { return ((function () { var v_m2 = null;
(v_m2 = v_grammar.f_list_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["list_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_mod: f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.full_ident"] ); })())}; tmp.__proto__ = Use; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and(((function () { var v_pos1 = null;
...
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())}), function () { return ((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_grammar(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.grammar"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.grammar"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and(f_and(f_and(((function () { var v_m2 = null;
...
(v_m2 = v_grammar.f_list_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["list_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push("methcall");List_a.push(((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).f_string());List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["list_parse"] ); })()));List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["hyper_op"] ); })()));return(List_a) })())) })()), function () { return 1}))})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push("methcall_no_params");List_a.push(((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).f_string());List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["hyper_op"] ); })()));return(List_a) })())) })()), function () { return 1})))) })())})) })())}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(((function () { var v_m2 = null;
...
(v_m2 = v_grammar.f_list_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["list_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push("funcall");List_a.push(((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.optional_namespace_before_ident"] ); })()).f_string());List_a.push(((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).f_string());List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["list_parse"] ); })()));return(List_a) })())) })()), function () { return 1}))})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_tmp = null;
(v_tmp = v_MATCH);(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_tmp.f_to(),v_to: v_tmp.f_to(),v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = ((function () { var v_pos1 = null;
...
var v_name = null;
(v_namespace = ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.optional_namespace_before_ident"] ); })()).f_string());(v_name = ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).f_string());if ( f_bool(v_namespace) ) { (function () { (v_name = (f_string(v_namespace) + f_string("::") + f_string(v_name))); })() };return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push((function () { var tmp = {v_name: v_name}; tmp.__proto__ = Proto; return tmp })());return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("postfix_or_term");List_a.push("funcall_no_params");List_a.push(((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.optional_namespace_before_ident"] ); })()).f_string());List_a.push(((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.ident"] ); })()).f_string());return(List_a) })())) })()), function () { return 1})))) })())})) })())}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_val_num(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.val_num"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.val_num"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_val_int(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.val_int"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.val_int"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_val_buf(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.val_buf"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("term");List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Grammar.val_buf"] ); })()));return(List_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push("space");List_a.push(" ");return(List_a) })())) })()), function () { return 1}))}))) })())})) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_block = null;
var v_result = null;
(v_last_pos = v_pos);(v_is_first_token = true);(v_lexer_stack = (function () { var List_a = [];
var List_v = [];
return(List_a) })());(v_terminated = 0);(v_last_token_was_space = 1);(v_get_token = function () { try { var v_v = null;
if ( f_bool(f_elems(v_lexer_stack)) ) { (function () { (v_v = v_lexer_stack.pop());if ( f_bool(f_and(f_and(v_is_first_token, function () { return ((v_v[0] == "op"))}), function () { return ( f_bool((Perlito$Precedence.f_is_fixity_type("prefix", v_v[1]))) ? false : true)})) ) { (function () { (function () { if (v_v == null) { v_v = [] }; return (v_v[0]  = "end"); })(); })() }; })() } else { (function () { var v_m = null;
(v_m = v_self.f_operator(v_str, v_last_pos));if ( f_bool(( f_bool(v_m) ? false : true)) ) { (function () { throw((function () { var List_a = [];
var List_v = [];
List_a.push("end");List_a.push("*end*");return(List_a) })()); })() };(v_v = f_scalar(v_m));if ( f_bool(f_and(f_and(v_is_first_token, function () { return ((v_v[0] == "op"))}), function () { return ( f_bool((Perlito$Precedence.f_is_fixity_type("prefix", v_v[1]))) ? false : true)})) ) { (function () { (function () { if (v_v == null) { v_v = [] }; return (v_v[0]  = "end"); })(); })() };if ( f_bool((v_v[0] != "end")) ) { (function () { (v_last_pos = v_m.f_to()); })() }; })() };if ( f_bool(f_and(f_and((((v_v[0]) == "postfix_or_term")), function () { return (((v_v[1]) == "block"))}), function () { return v_last_token_was_space})) ) { (function () { if ( f_bool(v_self.f_has_newline_after(v_str, v_last_pos)) ) { (function () { (v_terminated = 1);v_lexer_stack.push((function () { var List_a = [];
var List_v = [];
List_a.push("end");List_a.push("*end*");return(List_a) })()); })() } else { (function () { if ( f_bool(v_self.f_has_no_comma_or_colon_after(v_str, v_last_pos)) ) { (function () { (v_terminated = 1);v_lexer_stack.push((function () { var List_a = [];
var List_v = [];
List_a.push("end");List_a.push("*end*");return(List_a) })()); })() }; })() }; })() };(v_last_token_was_space = ((v_v[0] == "space")));(v_is_first_token = false);throw(v_v) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } }  });(v_prec = (function () { var tmp = {v_get_token: v_get_token,v_reduce: v_reduce_to_ast,v_end_token: (function () { var List_a = [];
var List_v = [];
List_a.push("and");List_a.push("or");List_a.push("!!");List_a.push("]");List_a.push(")");List_a.push("}");List_a.push(";");List_a.push("if");List_a.push("else");List_a.push("elsif");List_a.push("unless");List_a.push("when");List_a.push("for");List_a.push("while");List_a.push("loop");return(List_a) })()}; tmp.__proto__ = Perlito$Precedence; return tmp })());(v_res = v_prec.f_precedence_parse());if ( f_bool((f_elems(v_res) == 0)) ) { (function () { throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_last_pos,v_bool: 1,v_capture: (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["exp"]  = "*undef*"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["end_block"]  = null); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["terminated"]  = null); })();return(Hash_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() };if ( f_bool((f_elems(v_res) > 1)) ) { (function () { (v_block = v_res.pop());(v_block = (function () { var tmp = {v_stmts: v_block[2],v_sig: v_block[3]}; tmp.__proto__ = Lit$Block; return tmp })()); })() };(v_result = v__NAMESPACE.f_pop_term(v_res));if ( f_bool((f_elems(v_res) > 0)) ) { (function () { (v_block = v_res.pop());(v_block = (function () { var tmp = {v_stmts: v_block[2],v_sig: v_block[3]}; tmp.__proto__ = Lit$Block; return tmp })()); })() };throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_last_pos,v_bool: 1,v_capture: (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["exp"]  = v_result); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["end_block"]  = v_block); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["terminated"]  = v_terminated); })();return(Hash_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_m = v_self.f_operator(v_str, v_last_pos));if ( f_bool(( f_bool(v_m) ? false : true)) ) { (function () { f_die((f_string("Expected closing delimiter: ")), ((v_delimiter)), " near ", v_last_pos); })() };(v_v = f_scalar(v_m));if ( f_bool((v_v[0] != "end")) ) { (function () { (v_last_pos = v_m.f_to()); })() };throw(v_v) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } }  });(v_prec = (function () { var tmp = {v_get_token: v_get_token,v_reduce: v_reduce_to_ast,v_end_token: v_delimiter}; tmp.__proto__ = Perlito$Precedence; return tmp })());(v_res = v_prec.f_precedence_parse());(v_res = v__NAMESPACE.f_pop_term(v_res));if ( f_bool(( f_bool(((v_res != null))) ? false : true)) ) { (function () { (v_res = "*undef*"); })() };throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_last_pos,v_bool: 1,v_capture: v_res}; tmp.__proto__ = Perlito$Match; return tmp })()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  ...
  Perlito$Expression.f_ternary_parse = function (v_str, v_pos) {
    var v_self = this;
    try { throw(v_self.f_circumfix_parse(v_str, v_pos, (function () { var List_a = [];
var List_v = [];
List_a.push("!!");return(List_a) })())) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_block = null;
var v_result = null;
(v_last_pos = v_pos);(v_lexer_stack = (function () { var List_a = [];
var List_v = [];
return(List_a) })());(v_terminated = 0);(v_get_token = function () { try { var v_v = null;
if ( f_bool(f_elems(v_lexer_stack)) ) { (function () { (v_v = v_lexer_stack.pop()); })() } else { (function () { var v_m = null;
(v_m = v_self.f_operator(v_str, v_last_pos));if ( f_bool(( f_bool(v_m) ? false : true)) ) { (function () { throw((function () { var List_a = [];
var List_v = [];
List_a.push("end");List_a.push("*end*");return(List_a) })()); })() };(v_v = f_scalar(v_m));if ( f_bool((v_v[0] != "end")) ) { (function () { (v_last_pos = v_m.f_to()); })() }; })() };if ( f_bool(f_or(f_or(f_or(f_or((f_and((((v_v[0]) == "postfix_or_term")), function () { return (((v_v[1]) == "block"))})), function () { return (f_and((((v_v[0]) == "term")), function () { return (f_isa((v_v[1]), "Sub"))}))}), function () { return (f_and((((v_v[0]) == "term")), function () { return (f_isa((v_v[1]), "Method"))}))}), function () { return (f_and((((v_v[0]) == "term")), function () { return (f_isa((v_v[1]), "Do"))}))}), function () { return (f_and((((v_v[0]) == "term")), function () { return (f_isa((v_v[1]), "CompUnit"))}))})) ) { (function () { if ( f_bool(v_self.f_has_newline_after(v_str, v_last_pos)) ) { (function () { (v_terminated = 1);v_lexer_stack.push((function () { var List_a = [];
var List_v = [];
List_a.push("end");List_a.push("*end*");return(List_a) })()); })() }; })() };throw(v_v) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } }  });(v_prec = (function () { var tmp = {v_get_token: v_get_token,v_reduce: v_reduce_to_ast,v_end_token: (function () { var List_a = [];
var List_v = [];
List_a.push("]");List_a.push(")");List_a.push("}");List_a.push(";");List_a.push("if");List_a.push("else");List_a.push("elsif");List_a.push("unless");List_a.push("when");List_a.push("for");List_a.push("while");List_a.push("loop");return(List_a) })()}; tmp.__proto__ = Perlito$Precedence; return tmp })());(v_res = v_prec.f_precedence_parse());if ( f_bool((f_elems(v_res) == 0)) ) { (function () { throw((function () { var tmp = {v_bool: 0}; tmp.__proto__ = Perlito$Match; return tmp })()); })() };if ( f_bool((f_elems(v_res) > 1)) ) { (function () { (v_block = v_res.pop());(v_block = (function () { var tmp = {v_stmts: v_block[2],v_sig: v_block[3]}; tmp.__proto__ = Lit$Block; return tmp })()); })() };(v_result = v__NAMESPACE.f_pop_term(v_res));if ( f_bool((f_elems(v_res) > 0)) ) { (function () { (v_block = v_res.pop());if ( f_bool(( f_bool((f_isa(v_block, "Lit::Block"))) ? false : true)) ) { (function () { (v_block = (function () { var tmp = {v_stmts: v_block[2],v_sig: v_block[3]}; tmp.__proto__ = Lit$Block; return tmp })()); })() }; })() };throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_last_pos,v_bool: 1,v_capture: (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["exp"]  = v_result); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["end_block"]  = v_block); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["terminated"]  = v_terminated); })();return(Hash_a) })()}; tmp.__proto__ = Perlito$Match; return tmp })()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_last_pos = v_pos);(v_lexer_stack = (function () { var List_a = [];
var List_v = [];
return(List_a) })());(v_res = v_self.f_exp_stmt(v_str, v_pos));if ( f_bool(v_res) ) { (function () { throw(v_res); })() };(v_res = v_self.f_exp_parse(v_str, v_pos));if ( f_bool(( f_bool((v_res)) ? false : true)) ) { (function () { throw(v_res); })() };if ( f_bool(f_isa((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })(), "Lit::Block")) ) { (function () { (function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"]  = (function () { var tmp = {v_block: (function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })()}; tmp.__proto__ = Do; return tmp })()); })(); })() };if ( f_bool((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["end_block"] ); })()) ) { (function () { f_die((f_string("Unexpected block after expression near ")), v_pos); })() };if ( f_bool((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["terminated"] ); })()) ) { (function () { (v_res.v_capture = (function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })());throw(v_res); })() };(v_modifier = v_self.f_statement_modifier(v_str, v_res.f_to()));if ( f_bool(( f_bool((v_modifier)) ? false : true)) ) { (function () { (v_res.v_capture = (function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })());throw(v_res); })() };(v_modifier_exp = v_self.f_exp_parse(v_str, v_modifier.f_to()));if ( f_bool(( f_bool((v_modifier_exp)) ? false : true)) ) { (function () { f_die((f_string("Expected expression after '")), v_modifier, (f_string("'"))); })() };if ( f_bool((function () { if ((f_scalar(v_modifier_exp)) == null) { (f_scalar(v_modifier_exp)) = {} }; return ((f_scalar(v_modifier_exp))["end_block"] ); })()) ) { (function () { f_die((f_string("Unexpected block after expression near ")), v_modifier.f_to()); })() };(v_modifier = (v_modifier).f_string());if ( f_bool((v_modifier == "if")) ) { (function () { throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_modifier_exp.f_to(),v_bool: 1,v_capture: (function () { var tmp = {v_cond: (function () { if ((f_scalar(v_modifier_exp)) == null) { (f_scalar(v_modifier_exp)) = {} }; return ((f_scalar(v_modifier_exp))["exp"] ); })(),v_body: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
List_a.push((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })());return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })(),v_otherwise: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })()}; tmp.__proto__ = If; return tmp })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() };if ( f_bool((v_modifier == "unless")) ) { (function () { throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_modifier_exp.f_to(),v_bool: 1,v_capture: (function () { var tmp = {v_cond: (function () { if ((f_scalar(v_modifier_exp)) == null) { (f_scalar(v_modifier_exp)) = {} }; return ((f_scalar(v_modifier_exp))["exp"] ); })(),v_body: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })(),v_otherwise: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
List_a.push((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })());return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })()}; tmp.__proto__ = If; return tmp })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() };if ( f_bool((v_modifier == "while")) ) { (function () { throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_modifier_exp.f_to(),v_bool: 1,v_capture: (function () { var tmp = {v_cond: (function () { if ((f_scalar(v_modifier_exp)) == null) { (f_scalar(v_modifier_exp)) = {} }; return ((f_scalar(v_modifier_exp))["exp"] ); })(),v_body: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
List_a.push((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })());return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })()}; tmp.__proto__ = While; return tmp })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() };if ( f_bool((v_modifier == "for")) ) { (function () { throw((function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_modifier_exp.f_to(),v_bool: 1,v_capture: (function () { var tmp = {v_cond: (function () { if ((f_scalar(v_modifier_exp)) == null) { (f_scalar(v_modifier_exp)) = {} }; return ((f_scalar(v_modifier_exp))["exp"] ); })(),v_body: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
List_a.push((function () { if ((f_scalar(v_res)) == null) { (f_scalar(v_res)) = {} }; return ((f_scalar(v_res))["exp"] ); })());return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })()}; tmp.__proto__ = For; return tmp })()}; tmp.__proto__ = Perlito$Match; return tmp })()); })() };return(f_die((f_string("Unexpected statement modifier '") + f_string(v_modifier) + f_string("'")))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_last_op = v_op_stack.shift());if ( f_bool((v_last_op[0] == "prefix")) ) { return (function () { return(f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("prefix:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v__NAMESPACE.f_pop_term(v_num_stack));return(List_a) })()}; tmp.__proto__ = Apply; return tmp })())) })() } else { return (function () { if ( f_bool((v_last_op[0] == "postfix")) ) { return (function () { return(f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("postfix:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v__NAMESPACE.f_pop_term(v_num_stack));return(List_a) })()}; tmp.__proto__ = Apply; return tmp })())) })() } else { return (function () { if ( f_bool((v_last_op[0] == "postfix_or_term")) ) { return (function () { return(v_num_stack.push(v__NAMESPACE.f_reduce_postfix(v_last_op, v__NAMESPACE.f_pop_term(v_num_stack)))) })() } else { return (function () { if ( f_bool(Perlito$Precedence.f_is_assoc_type("list", v_last_op[1])) ) { return (function () { var v_arg = null;
if ( f_bool((f_elems(v_num_stack) < 2)) ) { (function () { var v_v2 = null;
(v_v2 = v__NAMESPACE.f_pop_term(v_num_stack));if ( f_bool(f_and((f_isa(v_v2, "Apply")), function () { return ((v_v2.f_code() == ((f_string("list:<") + f_string(v_last_op[1]) + f_string(">")))))})) ) { (function () { (v_v2.f_arguments()).push(null);v_num_stack.push(v_v2); })() } else { (function () { f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("list:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v_v2);List_a.push(null);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })()); })() };throw(null); })() } else { (function () { var v_v2 = null;
(v_v2 = v__NAMESPACE.f_pop_term(v_num_stack));(v_arg = (function () { var List_a = [];
var List_v = [];
List_a.push(v__NAMESPACE.f_pop_term(v_num_stack));List_a.push(v_v2);return(List_a) })()); })() };if ( f_bool(f_and(f_and((f_isa((v_arg[0]), "Apply")), function () { return ((v_last_op[0] == "infix"))}), function () { return (((v_arg[0]).f_code() == ((f_string("list:<") + f_string(v_last_op[1]) + f_string(">")))))})) ) { (function () { f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (v_arg[0]).f_code(),v_arguments: (function () { var List_a = [];
var List_v = [];
(List_v = (((v_arg[0]).f_arguments())));(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_x) { List_a.push(List_v[v_x]); })(a_[i_]) } })((function (a) { for (var i=0, l=((f_elems(List_v) - 1)); i<=l; ++i){ a.push(i) }; return a })([]));List_a.push(v_arg[1]);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })());throw(null); })() };return(f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("list:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: v_arg}; tmp.__proto__ = Apply; return tmp })())) })() } else { return (function () { if ( f_bool(Perlito$Precedence.f_is_assoc_type("chain", v_last_op[1])) ) { return (function () { var v_v2 = null;
var v_arg = null;
if ( f_bool((f_elems(v_num_stack) < 2)) ) { (function () { f_die((f_string("Missing value after operator ") + f_string(v_last_op[1]))); })() };(v_v2 = v__NAMESPACE.f_pop_term(v_num_stack));(v_arg = (function () { var List_a = [];
var List_v = [];
List_a.push(v__NAMESPACE.f_pop_term(v_num_stack));List_a.push(v_v2);return(List_a) })());return(f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("infix:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: v_arg}; tmp.__proto__ = Apply; return tmp })())) })() } else { return (function () { if ( f_bool((v_last_op[0] == "ternary")) ) { return (function () { var v_v2 = null;
if ( f_bool(((f_elems(v_num_stack) < 2))) ) { (function () { f_die((f_string("Missing value after ternary operator"))); })() };(v_v2 = v__NAMESPACE.f_pop_term(v_num_stack));return(f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("ternary:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v__NAMESPACE.f_pop_term(v_num_stack));List_a.push(v_last_op[2]);List_a.push(v_v2);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })())) })() } else { return (function () { var v_v2 = null;
if ( f_bool(((f_elems(v_num_stack) < 2))) ) { (function () { f_die((f_string("missing value after operator '") + f_string(v_last_op[1]) + f_string((f_string("'"))))); })() };(v_v2 = v__NAMESPACE.f_pop_term(v_num_stack));return(f_push(v_num_stack, (function () { var tmp = {v_namespace: "",v_code: (f_string("infix:<") + f_string(v_last_op[1]) + f_string(">")),v_arguments: (function () { var List_a = [];
var List_v = [];
List_a.push(v__NAMESPACE.f_pop_term(v_num_stack));List_a.push(v_v2);return(List_a) })()}; tmp.__proto__ = Apply; return tmp })())) })() } })() } })() } })() } })() } })() } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } }  });})();
;// use v6
...
var Hash_rule_terms = {};
  ...
  Perlito$Grammar$Regex.f_ws = function (v_str, v_pos) {
    ...
    try { var v_MATCH = null;
(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = (((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_m2 = null;
...
(v_pos1 = v_MATCH.f_to());return(((function () { return(f_and(("" != (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})) })())) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  ...
  Perlito$Grammar$Regex.f_literal = function (v_str, v_pos) {
    ...
    try { var v_MATCH = null;
(v_MATCH = (function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1}; tmp.__proto__ = Perlito$Match; return tmp })());(v_MATCH.v_bool = (((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(((function () { var v_last_match_null = null;
var v_last_pos = null;
...
(v_m2 = v_grammar.f_rule(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["rule"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and((")" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["capturing_group"]  = f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["rule"] ); })())); })();return(Hash_a) })())) })()), function () { return 1}))})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("[" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
...
(v_m2 = v_grammar.f_metasyntax_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["metasyntax_exp"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_and((">" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["negate"]  = (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["metasyntax"]  = f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["metasyntax_exp"] ); })())); })();return(Hash_a) })()); })();return(Hash_a) })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and((f_and(("<+" == (v_str || "").substr(v_MATCH.f_to(), 2)), function () { return ((v_MATCH.v_to = f_add(2, v_MATCH.f_to())))})), function () { return ((function () { var v_m2 = null;
...
(v_pos1 = v_MATCH.f_to());return(f_or(((function () { return(f_and(((function () { var v_m2 = null;
(v_m2 = v_grammar.f_concat_list(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["concat_list"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["quantifier"] ); })()));(List_v = ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["concat_list"] ); })()))));(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_x) { List_a.push(List_v[v_x]); })(a_[i_]) } })((function (a) { for (var i=0, l=((f_elems(List_v) - 1)); i<=l; ++i){ a.push(i) }; return a })([]));return(List_a) })())) })()), function () { return 1}))})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["quantifier"] ); })()));return(List_a) })())) })()), function () { return 1})))) })())})) })())})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
return(List_a) })())) })()), function () { return 1})))) })())})) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_m2 = v_grammar.f_or_list_exp(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["or_list_exp"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["concat_exp"] ); })()));(List_v = ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["or_list_exp"] ); })()))));(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_x) { List_a.push(List_v[v_x]); })(a_[i_]) } })((function (a) { for (var i=0, l=((f_elems(List_v) - 1)); i<=l; ++i){ a.push(i) }; return a })([]));return(List_a) })())) })()), function () { return 1}))})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["concat_exp"] ); })()));return(List_a) })())) })()), function () { return 1})))) })())})) })())})) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { return((v_MATCH.v_capture = (function () { var List_a = [];
var List_v = [];
return(List_a) })())) })()), function () { return 1})))) })())})) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_body = (function () { if ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) == null) { (f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) = {} }; return ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })()))["end_block"] ); })());if ( f_bool(( f_bool(((v_body != null))) ? false : true)) ) { (function () { f_die((f_string("Missing code block in 'if'"))); })() };return((v_MATCH.v_capture = (function () { var tmp = {v_cond: (function () { if ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) == null) { (f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) = {} }; return ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })()))["exp"] ); })(),v_body: v_body,v_otherwise: (function () { var tmp = {v_stmts: (function () { var List_a = [];
var List_v = [];
List_a.push(f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["if"] ); })()));return(List_a) })()}; tmp.__proto__ = Lit$Block; return tmp })()}; tmp.__proto__ = If; return tmp })())) })()), function () { return 1}))}))) })())}), function () { return ((function () { (v_MATCH.v_to = v_pos1);return(((f_or(((function () { var v_body = null;
(v_body = (function () { if ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) == null) { (f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) = {} }; return ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })()))["end_block"] ); })());if ( f_bool(( f_bool(((v_body != null))) ? false : true)) ) { (function () { f_die((f_string("Missing code block in 'if'"))); })() };return((v_MATCH.v_capture = (function () { var tmp = {v_cond: (function () { if ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) == null) { (f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })())) = {} }; return ((f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["exp"] ); })()))["exp"] ); })(),v_body: v_body,v_otherwise: (function () { var List_a = [];
var List_v = [];
return(List_a) })()}; tmp.__proto__ = If; return tmp })())) })()), function () { return 1})))) })())})) })())})) })())) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
var v_last_pos = null;
(v_last_match_null = 0);(v_last_pos = v_MATCH.f_to());for ( ; f_bool(f_and(((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(f_or(f_or(((function () { var v_m2 = null;
...
var v_last_pos = null;
(v_last_match_null = 0);(v_last_pos = v_MATCH.f_to());for ( ; f_bool(f_and(((function () { var v_m2 = null;
(v_m2 = v_grammar.f_double_quoted_buf(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());if ( f_bool((v_MATCH).hasOwnProperty("double_quoted_buf")) ) { (function () { ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["double_quoted_buf"] ); })()).push(v_m2); })() } else { (function () { (function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["double_quoted_buf"]  = (function () { var List_a = [];
var List_v = [];
List_a.push(v_m2);return(List_a) })()); })(); })() };return(1) })() } else { return (function () { return(false) })() } })()), function () { return ((v_last_match_null < 2))}));  ) { (function () { if ( f_bool((v_last_pos == v_MATCH.f_to())) ) { (function () { (v_last_match_null = f_add(v_last_match_null, 1)); })() } else { (function () { (v_last_match_null = 0); })() };(v_last_pos = v_MATCH.f_to()); })() };(v_MATCH.v_to = v_last_pos);return(1) })())}), function () { return (f_and(("\"" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))}), function () { return (f_or(((function () { var v_args = null;
...
(v_pos1 = v_MATCH.f_to());return(((function () { var v_last_pos = null;
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { var v_m2 = null;
(v_m2 = v_grammar.f_ident(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());if ( f_bool((v_MATCH).hasOwnProperty("ident")) ) { (function () { ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["ident"] ); })()).push(v_m2); })() } else { (function () { (function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["ident"]  = (function () { var List_a = [];
var List_v = [];
List_a.push(v_m2);return(List_a) })()); })(); })() };return(1) })() } else { return (function () { return(false) })() } })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Rul$Var.f_emit_perl6 = function () {
    ...
    try { var v_table = null;
(v_table = (function () { var Hash_a = {};
(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["$"]  = "$"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["@"]  = "$List_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["%"]  = "$Hash_"); })();(function () { if (Hash_a == null) { Hash_a = {} }; return (Hash_a["&"]  = "$Code_"); })();return(Hash_a) })());return((f_string((function () { if (v_table == null) { v_table = {} }; return (v_table[v_self.v_sigil] ); })()) + f_string(v_self.v_name))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Do.f_simplify = function () {
    var v_self = this;
    try { var v_block = null;
if ( f_bool(f_isa(v_self.v_block, "Lit::Block")) ) { (function () { (v_block = v_self.v_block.f_stmts()); })() } else { (function () { (v_block = (function () { var List_a = [];
var List_v = [];
List_a.push(v_self.v_block);return(List_a) })()); })() };if ( f_bool((f_elems(v_block) == 1)) ) { (function () { var v_stmt = null;
(v_stmt = v_block[0]);if ( f_bool(f_and(f_isa(v_stmt, "Apply"), function () { return (v_stmt.f_code() == "circumfix:<( )>")})) ) { (function () { var v_args = null;
(v_args = v_stmt.f_arguments());throw((function () { var tmp = {v_block: v_args[0]}; tmp.__proto__ = Do; return tmp })().f_simplify()); })() };if ( f_bool(f_isa(v_stmt, "Do")) ) { (function () { throw(v_stmt.f_simplify()); })() }; })() };throw((function () { var tmp = {v_block: v_block}; tmp.__proto__ = Do; return tmp })()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
