...
(function () {
  ...
  MiniPerl6$Grammar.f_digits = function (v_str, v_pos) {
    var v_grammar = this;
    try { var v_MATCH = null;
(v_MATCH = function () { var tmp = {v_str: v_str,v_from: v_pos,v_to: v_pos,v_bool: 1,}; tmp.__proto__ = MiniPerl6$Match; return tmp }());(v_MATCH.v_bool = (function () { var v_pos1;(v_pos1 = v_MATCH.f_to());return((function () { return((function () { var v_last_match_null;var v_last_pos;var v_count;(v_last_match_null = 0);(v_last_pos = v_MATCH.f_to());(v_count = 0);while ( f_bool(( f_bool((function () { var v_m2;(v_m2 = v_grammar.f_digit(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { (v_MATCH.v_to = v_m2.f_to());return(1) } else { return(0) } })()) && f_bool((v_last_match_null < 2)) )) ) { (function () { if ( f_bool((v_last_pos == v_MATCH.f_to())) ) { (function () { (v_last_match_null = f_add(v_last_match_null, 1)); })() } else { (function () { (v_last_match_null = 0); })() };(v_last_pos = v_MATCH.f_to());(v_count = f_add(v_count, 1)); })() };(v_MATCH.v_to = v_last_pos);return((v_count > 0)) })()) })()) })());return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
