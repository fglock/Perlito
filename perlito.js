...
(function () {
  ...
  MiniPerl6$Match.f_scalar = function () {
    var v_self = this;
    try { if ( f_bool(v_self.v_bool) ) { if ( f_bool((v_self.v_capture != null)) ) { throw(v_self.v_capture) } else {  };throw((v_self.v_str || "").substr(v_self.v_from, (v_self.v_to - v_self.v_from))) } else { throw("") } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
if ( f_bool((v_self.v_block)) ) {  } else { throw("null") };(v_str = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_decl) { if ( f_bool(( f_bool(f_isa(v_decl, "Decl")) && f_bool((v_decl.f_decl() == "my")) )) ) { (v_str = ( f_string(v_str) + f_string(v_decl.f_emit_javascript_init()) )) } else {  };if ( f_bool(( f_bool(f_isa(v_decl, "Bind")) && f_bool(( f_bool(f_isa(v_decl.f_parameters(), "Decl")) && f_bool((v_decl.f_parameters().f_decl() == "my")) )) )) ) { (v_str = ( f_string(v_str) + f_string(( f_string("var ") + f_string(( f_string(v_decl.f_parameters().f_var().f_emit_javascript()) + f_string(";") )) )) )) } else {  } })(a_[i_]) } })(v_self.v_block);if ( f_bool(v_self.v_needs_return) ) { (v_last_statement = f_pop(v_self.v_block)) } else {  };(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_decl) { if ( f_bool(( f_bool(f_isa(v_decl, "Decl")) && f_bool((v_decl.f_decl() == "my")) )) ) {  } else { (v_str = ( f_string(v_str) + f_string(( f_string(v_decl.f_emit_javascript()) + f_string(";") )) )) } })(a_[i_]) } })(v_self.v_block);if ( f_bool(( f_bool(v_self.v_needs_return) && f_bool(v_last_statement) )) ) { if ( f_bool(f_isa(v_last_statement, "If")) ) { (v_cond = v_last_statement.f_cond());(v_body = v_last_statement.f_body());(v_otherwise = v_last_statement.f_otherwise());if ( f_bool(( f_bool(f_isa(v_cond, "Apply")) && f_bool((v_cond.f_code() == "prefix:<!>")) )) ) { (v_cond = v_cond.f_arguments()[0]);(v_body = v_last_statement.f_otherwise());(v_otherwise = v_last_statement.f_body()) } else {  };if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (v_cond = function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()) } else {  };(v_body = function () { var tmp = {v_block: v_body,v_needs_return: 1,}; tmp.__proto__ = MiniPerl6$Javascript$LexicalBlock; return tmp }());(v_otherwise = function () { var tmp = {v_block: v_otherwise,v_needs_return: 1,}; tmp.__proto__ = MiniPerl6$Javascript$LexicalBlock; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string("if ( f_bool(") + f_string(( f_string(v_cond.f_emit_javascript()) + f_string(( f_string(") ) { ") + f_string(( f_string(v_body.f_emit_javascript()) + f_string(( f_string(" } else { ") + f_string(( f_string(v_otherwise.f_emit_javascript()) + f_string(" }") )) )) )) )) )) )) )) } else { if ( f_bool(( f_bool(f_isa(v_last_statement, "Return")) || f_bool(f_isa(v_last_statement, "For")) )) ) { (v_str = ( f_string(v_str) + f_string(v_last_statement.f_emit_javascript()) )) } else { (v_str = ( f_string(v_str) + f_string(( f_string("return(") + f_string(( f_string(v_last_statement.f_emit_javascript()) + f_string(")") )) )) )) } } } else {  };if ( f_bool(v_self.v_top_level) ) { (v_str = ( f_string("try { ") + f_string(( f_string(v_str) + f_string(( f_string(" } catch(err) { ") + f_string(( f_string("if ( err instanceof Error ) { ") + f_string(( f_string("throw(err) ") + f_string(( f_string("} ") + f_string(( f_string("else { ") + f_string(( f_string("return(err) ") + f_string(( f_string("} ") + f_string("} ") )) )) )) )) )) )) )) )) )) } else {  };throw(v_str) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Lit$Array.f_emit_javascript = function () {
    var v_self = this;
    try { var v_needs_interpolation;(v_needs_interpolation = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_item) { if ( f_bool(( f_bool(( f_bool(f_isa(v_item, "Var")) && f_bool((v_item.f_sigil() == "@")) )) || f_bool(( f_bool(f_isa(v_item, "Apply")) && f_bool((v_item.f_code() == "prefix:<@>")) )) )) ) { (v_needs_interpolation = 1) } else {  } })(a_[i_]) } })(v_self.v_array1);if ( f_bool(v_needs_interpolation) ) { var v_s;(v_s = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_item) { if ( f_bool(( f_bool(( f_bool(f_isa(v_item, "Var")) && f_bool((v_item.f_sigil() == "@")) )) || f_bool(( f_bool(f_isa(v_item, "Apply")) && f_bool((v_item.f_code() == "prefix:<@>")) )) )) ) { (v_s = ( f_string(v_s) + f_string(( f_string("(function(a_) { ") + f_string(( f_string("for (var i_ = 0; i_ < a_.length ; i_++) { a.push(a_[i_]) }") + f_string(( f_string("})(") + f_string(( f_string(v_item.f_emit_javascript()) + f_string("); ") )) )) )) )) )) } else { (v_s = ( f_string(v_s) + f_string(( f_string("a.push(") + f_string(( f_string(v_item.f_emit_javascript()) + f_string("); ") )) )) )) } })(a_[i_]) } })(v_self.v_array1);return(( f_string("(function () { var a = []; ") + f_string(( f_string(v_s) + f_string(" return a })()") )) )) } else { return(( f_string("[") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_array1).join(", ")) + f_string("]") )) )) } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Var.f_emit_javascript = function () {
    var v_self = this;
    try { var v_table;var v_ns;(v_table = { "$":"v_","@":"List_","%":"Hash_","&":"Code_", });(v_ns = "");if ( f_bool(v_self.v_namespace) ) { (v_ns = ( f_string(Main.f_to_javascript_namespace(v_self.v_namespace)) + f_string(".") )) } else {  };return(( f_bool((v_self.v_twigil == ".")) ? ( f_string("v_self.v_") + f_string(( f_string(v_self.v_name) + f_string("") )) ) : ( f_bool((v_self.v_name == "/")) ? ( f_string(v_table[v_self.v_sigil]) + f_string("MATCH") ) : ( f_string(v_table[v_self.v_sigil]) + f_string(( f_string(v_ns) + f_string(v_self.v_name) )) )))) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
  Var.f_emit_javascript;  // v8 bug workaround
  // method plain_name
  Var.f_plain_name = function () {
    var v_self = this;
    try { if ( f_bool(v_self.v_namespace) ) { throw(( f_string(v_self.v_namespace) + f_string(( f_string(".") + f_string(v_self.v_name) )) )) } else {  };throw(v_self.v_name) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Bind.f_emit_javascript = function () {
    var v_self = this;
    try { if ( f_bool(f_isa(v_self.v_parameters, "Lit::Array")) ) { (v_a = v_self.v_parameters.f_array1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var,v_arguments: function () { var tmp = {v_obj: v_self.v_arguments,v_index_exp: function () { var tmp = {v_int: v_i,}; tmp.__proto__ = Val$Int; return tmp }(),}; tmp.__proto__ = Index; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(v_self.v_parameters.f_emit_javascript()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(v_self.v_parameters, "Lit::Hash")) ) { (v_a = v_self.v_parameters.f_hash1());(v_b = v_self.v_arguments.f_hash1());(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = function () { var tmp = {}; tmp.__proto__ = Val$Undef; return tmp }());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool((v_var2[0].f_buf() == v_var[0].f_buf())) ) { (v_arg = v_var2[1]) } else {  } })(a_[i_]) } })((v_b));(v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: v_arg,}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(v_self.v_parameters.f_emit_javascript()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(v_self.v_parameters, "Lit::Object")) ) { (v_class = v_self.v_parameters.f_class());(v_a = v_self.v_parameters.f_fields());(v_b = v_self.v_arguments);(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: function () { var tmp = {v_invocant: v_b,v_method: v_var[0].f_buf(),v_arguments: [],v_hyper: 0,}; tmp.__proto__ = Call; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(v_self.v_parameters.f_emit_javascript()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(v_self.v_parameters, "Call")) ) { throw(( f_string("(") + f_string(( f_string(v_self.v_parameters.f_invocant().f_emit_javascript()) + f_string(( f_string(".v_") + f_string(( f_string(v_self.v_parameters.f_method()) + f_string(( f_string(" = ") + f_string(( f_string(v_self.v_arguments.f_emit_javascript()) + f_string(")") )) )) )) )) )) )) } else {  };return(( f_string("(") + f_string(( f_string(v_self.v_parameters.f_emit_javascript()) + f_string(( f_string(" = ") + f_string(( f_string(v_self.v_arguments.f_emit_javascript()) + f_string(")") )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Call.f_emit_javascript = function () {
    var v_self = this;
    try { var v_invocant;var v_meth;(v_invocant = v_self.v_invocant.f_emit_javascript());if ( f_bool((v_invocant == "self")) ) { (v_invocant = "v_self") } else {  };if ( f_bool((v_self.v_method == "values")) ) { if ( f_bool(v_self.v_hyper) ) { f_die("not implemented") } else { throw(( f_string("f_values(") + f_string(( f_string(v_invocant) + f_string(")") )) )) } } else {  };if ( f_bool(( f_bool((v_self.v_method == "perl")) || f_bool(( f_bool((v_self.v_method == "isa")) || f_bool((v_self.v_method == "scalar")) )) )) ) { if ( f_bool(v_self.v_hyper) ) { throw(( f_string("(function (a_) { ") + f_string(( f_string("var out = []; ") + f_string(( f_string("if ( typeof a_ == 'undefined' ) { return out }; ") + f_string(( f_string("for(var i = 0; i < a_.length; i++) { ") + f_string(( f_string("out.push( f_") + f_string(( f_string(v_self.v_method) + f_string(( f_string("(a_[i]) ) } return out;") + f_string(( f_string(" })(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) )) )) )) )) )) } else {  };throw(( f_string("f_") + f_string(( f_string(v_self.v_method) + f_string(( f_string("(") + f_string(( f_string(v_invocant) + f_string(( f_string(( f_bool(v_self.v_arguments) ? ( f_string(", ") + f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) ) : "")) + f_string(")") )) )) )) )) )) } else {  };if ( f_bool(( f_bool((v_self.v_method == "join")) || f_bool(( f_bool((v_self.v_method == "shift")) || f_bool(( f_bool((v_self.v_method == "push")) || f_bool((v_self.v_method == "pop")) )) )) )) ) { throw(( f_string(v_invocant) + f_string(( f_string(".") + f_string(( f_string(v_self.v_method) + f_string(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) )) )) )) } else {  };if ( f_bool(( f_bool((v_self.v_method == "yaml")) || f_bool(( f_bool((v_self.v_method == "say")) || f_bool((v_self.v_method == "chars")) )) )) ) { if ( f_bool(v_self.v_hyper) ) { throw(( f_string("(function (a_) { ") + f_string(( f_string("var out = []; ") + f_string(( f_string("if ( typeof a_ == 'undefined' ) { return out }; ") + f_string(( f_string("for(var i = 0; i < a_.length; i++) { ") + f_string(( f_string("out.push( Main.") + f_string(( f_string(v_self.v_method) + f_string(( f_string("(a_[i]) ) } return out;") + f_string(( f_string(" })(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) )) )) )) )) )) } else { if ( f_bool((v_self.v_arguments != null)) ) { throw(( f_string("Main.") + f_string(( f_string(v_self.v_method) + f_string(( f_string("(") + f_string(( f_string(v_invocant) + f_string(( f_string(", ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) )) )) )) )) } else { throw(( f_string("Main.") + f_string(( f_string(v_self.v_method) + f_string(( f_string("(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) } } } else {  };(v_meth = v_self.v_method);if ( f_bool(v_self.v_hyper) ) { return(( f_string("(function (a_) { ") + f_string(( f_string("var out = []; ") + f_string(( f_string("if ( typeof a_ == 'undefined' ) { return out }; ") + f_string(( f_string("for(var i = 0; i < a_.length; i++) { ") + f_string(( f_string("out.push( a_[i].f_") + f_string(( f_string(v_meth) + f_string(( f_string("() ) } return out;") + f_string(( f_string(" })(") + f_string(( f_string(v_invocant) + f_string(")") )) )) )) )) )) )) )) )) )) } else { if ( f_bool((v_meth == "postcircumfix:<( )>")) ) { throw(( f_string("(") + f_string(( f_string(v_invocant) + f_string(( f_string(")(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) )) )) } else {  };throw(( f_string(v_invocant) + f_string(( f_string(".f_") + f_string(( f_string(v_meth) + f_string(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) )) )) )) } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Apply.f_emit_javascript = function () {
    var v_self = this;
    try { var v_code;(v_code = v_self.v_code);if ( f_bool(f_isa(v_code, "Str")) ) {  } else { throw(( f_string("(") + f_string(( f_string(v_self.v_code.f_emit_javascript()) + f_string(( f_string(")->(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) )) )) };if ( f_bool((v_code == "self")) ) { throw("v_self") } else {  };if ( f_bool((v_code == "false")) ) { throw("0") } else {  };if ( f_bool((v_code == "make")) ) { throw(( f_string("(v_MATCH.v_capture = ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "say")) ) { throw(( f_string("say(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "print")) ) { throw(( f_string("f_print(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "warn")) ) { throw(( f_string("f_warn(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "defined")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(" != null)") )) )) } else {  };if ( f_bool((v_code == "substr")) ) { throw(( f_string("(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(( f_string(" || \"\").substr(") + f_string(( f_string(v_self.v_arguments[1].f_emit_javascript()) + f_string(( f_string(", ") + f_string(( f_string(v_self.v_arguments[2].f_emit_javascript()) + f_string(")") )) )) )) )) )) )) } else {  };if ( f_bool((v_code == "Int")) ) { throw(( f_string("parseInt(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "Num")) ) { throw(( f_string("parseFloat(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "prefix:<~>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(").f_string()") )) )) } else {  };if ( f_bool((v_code == "prefix:<!>")) ) { throw(( f_string("( f_bool(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(") ? false : true)") )) )) } else {  };if ( f_bool((v_code == "prefix:<?>")) ) { throw(( f_string("( f_bool(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(") ? true : false)") )) )) } else {  };if ( f_bool((v_code == "prefix:<$>")) ) { throw(( f_string("f_scalar(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "prefix:<@>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "prefix:<%>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" ")) + f_string(").f_hash()") )) )) } else {  };if ( f_bool((v_code == "infix:<~>")) ) { throw(( f_string("( f_string(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(( f_string(")") + f_string(( f_string(" + f_string(") + f_string(( f_string(v_self.v_arguments[1].f_emit_javascript()) + f_string(") )") )) )) )) )) )) } else {  };if ( f_bool((v_code == "infix:<+>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" + ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<->")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" - ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<>>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" > ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<&&>")) ) { throw(( f_string("( f_bool(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(( f_string(")") + f_string(( f_string(" && f_bool(") + f_string(( f_string(v_self.v_arguments[1].f_emit_javascript()) + f_string(") )") )) )) )) )) )) } else {  };if ( f_bool((v_code == "infix:<||>")) ) { throw(( f_string("( f_bool(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(( f_string(")") + f_string(( f_string(" || f_bool(") + f_string(( f_string(v_self.v_arguments[1].f_emit_javascript()) + f_string(") )") )) )) )) )) )) } else {  };if ( f_bool((v_code == "infix:<eq>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" == ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<ne>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" != ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<==>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" == ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "infix:<!=>")) ) { throw(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(" != ")) + f_string(")") )) )) } else {  };if ( f_bool((v_code == "exists")) ) { (v_arg = v_self.v_arguments[0]);if ( f_bool(f_isa(v_arg, "Lookup")) ) { throw(( f_string("(") + f_string(( f_string(v_arg.f_obj().f_emit_javascript()) + f_string(( f_string(").hasOwnProperty(") + f_string(( f_string(v_arg.f_index_exp().f_emit_javascript()) + f_string(")") )) )) )) )) } else {  } } else {  };if ( f_bool((v_code == "ternary:<?? !!>")) ) { throw(( f_string("( f_bool(") + f_string(( f_string(v_self.v_arguments[0].f_emit_javascript()) + f_string(( f_string(")") + f_string(( f_string(" ? ") + f_string(( f_string(v_self.v_arguments[1].f_emit_javascript()) + f_string(( f_string(" : ") + f_string(( f_string(v_self.v_arguments[2].f_emit_javascript()) + f_string(")") )) )) )) )) )) )) )) } else {  };(v_code = ( f_string("f_") + f_string(v_self.v_code) ));if ( f_bool(v_self.v_namespace) ) { (v_code = ( f_string(Main.f_to_javascript_namespace(v_self.v_namespace)) + f_string(( f_string(".") + f_string(v_code) )) )) } else { if ( f_bool(( f_bool((v_code != "f_index")) && f_bool(( f_bool((v_code != "f_die")) && f_bool(( f_bool((v_code != "f_pop")) && f_bool(( f_bool((v_code != "f_shift")) && f_bool((v_code != "f_push")) )) )) )) )) ) { (v_code = ( f_string("v__NAMESPACE.") + f_string(v_code) )) } else {  } };return(( f_string(v_code) + f_string(( f_string("(") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_arguments).join(", ")) + f_string(")") )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  If.f_emit_javascript = function () {
    var v_self = this;
    try { var v_cond;(v_cond = v_self.v_cond);if ( f_bool(( f_bool(f_isa(v_cond, "Apply")) && f_bool((v_cond.f_code() == "prefix:<!>")) )) ) { (v_if = function () { var tmp = {v_cond: v_cond.f_arguments()[0],v_body: v_self.v_otherwise,v_otherwise: v_self.v_body,}; tmp.__proto__ = If; return tmp }());throw(v_if.f_emit_javascript()) } else {  };if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (v_cond = function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()) } else {  };return(( f_string("if ( f_bool(") + f_string(( f_string(v_cond.f_emit_javascript()) + f_string(( f_string(") ) { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_body).join(";")) + f_string(( f_string(" } else { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(v_self.v_otherwise).join(";")) + f_string(" }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Decl.f_emit_javascript_init = function () {
    var v_self = this;
    try { if ( f_bool((v_self.v_decl == "my")) ) { var v_str;(v_str = "");(v_str = ( f_string(v_str) + f_string(( f_string("var ") + f_string(( f_string(v_self.v_var.f_emit_javascript()) + f_string(" = ") )) )) ));if ( f_bool((v_self.v_var.f_sigil() == "%")) ) { (v_str = ( f_string(v_str) + f_string(( f_string("{};") + f_string("\n") )) )) } else { if ( f_bool((v_self.v_var.f_sigil() == "@")) ) { (v_str = ( f_string(v_str) + f_string(( f_string("[];") + f_string("\n") )) )) } else { (v_str = ( f_string(v_str) + f_string(( f_string("null;") + f_string("\n") )) )) } };throw(v_str) } else { return(f_die(( f_string("not implemented: Decl '") + f_string(( f_string(v_self.v_decl) + f_string("'") )) ))) } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
