...
(function () {
  ...
  Lit$Object.f_emit_javascript = function () {
    var v_self = this;
    try { var v_fields;var v_str;(v_fields = this.v_fields);(v_str = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = ( f_string(v_str) + f_string(( f_string("v_") + f_string(( f_string(v_field[0].f_buf()) + f_string(( f_string(": ") + f_string(( f_string(v_field[1].f_emit_javascript()) + f_string(",") )) )) )) )) )) })(a_[i_]) } })((v_fields));return(( f_string("function () { ") + f_string(( f_string("var tmp = {") + f_string(( f_string(v_str) + f_string(( f_string("}; ") + f_string(( f_string("tmp.__proto__ = ") + f_string(( f_string(Main.f_to_javascript_namespace(this.v_class)) + f_string(( f_string("; ") + f_string(( f_string("return tmp ") + f_string("}()") )) )) )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Bind.f_emit_javascript = function () {
    var v_self = this;
    try { if ( f_bool(f_isa(this.v_parameters, "Lit::Array")) ) { (v_a = this.v_parameters.f_array1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var,v_arguments: function () { var tmp = {v_obj: this.v_arguments,v_index_exp: function () { var tmp = {v_int: v_i,}; tmp.__proto__ = Val$Int; return tmp }(),}; tmp.__proto__ = Index; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit_javascript()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Lit::Hash")) ) { (v_a = this.v_parameters.f_hash1());(v_b = this.v_arguments.f_hash1());(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = function () { var tmp = {}; tmp.__proto__ = Val$Undef; return tmp }());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool((v_var2[0].f_buf() == v_var[0].f_buf())) ) { (v_arg = v_var2[1]) } else {  } })(a_[i_]) } })((v_b));(v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: v_arg,}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit_javascript()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Lit::Object")) ) { (v_class = this.v_parameters.f_class());(v_a = this.v_parameters.f_fields());(v_b = this.v_arguments);(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: function () { var tmp = {v_invocant: v_b,v_method: v_var[0].f_buf(),v_arguments: [],v_hyper: 0,}; tmp.__proto__ = Call; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit_javascript()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Call")) ) { throw(( f_string("(") + f_string(( f_string(this.v_parameters.f_invocant().f_emit_javascript()) + f_string(( f_string(".v_") + f_string(( f_string(this.v_parameters.f_method()) + f_string(( f_string(" = ") + f_string(( f_string(this.v_arguments.f_emit_javascript()) + f_string(")") )) )) )) )) )) )) } else {  };return(( f_string("(") + f_string(( f_string(this.v_parameters.f_emit_javascript()) + f_string(( f_string(" = ") + f_string(( f_string(this.v_arguments.f_emit_javascript()) + f_string(")") )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  If.f_emit_javascript = function () {
    var v_self = this;
    try { var v_cond;(v_cond = this.v_cond);if ( f_bool(( f_bool(f_isa(v_cond, "Apply")) && f_bool((v_cond.f_code() == "prefix:<!>")) )) ) { (v_if = function () { var tmp = {v_cond: v_cond.f_arguments()[0],v_body: this.v_otherwise,v_otherwise: this.v_body,}; tmp.__proto__ = If; return tmp }());throw(v_if.f_emit_javascript()) } else {  };if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (v_cond = function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()) } else {  };return(( f_string("if ( f_bool(") + f_string(( f_string(v_cond.f_emit_javascript()) + f_string(( f_string(") ) { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(this.v_body).join(";")) + f_string(( f_string(" } else { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })(this.v_otherwise).join(";")) + f_string(" }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Method.f_emit_javascript = function () {
    var v_self = this;
    try { var v_sig;var v_invocant;var v_pos;var v_str;(v_sig = this.v_sig);(v_invocant = v_sig.f_invocant());(v_pos = v_sig.f_positional());(v_str = (function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })((v_pos)).join(", "));return(( f_string("function ") + f_string(( f_string(this.v_name) + f_string(( f_string("(") + f_string(( f_string(v_str) + f_string(( f_string(") { ") + f_string(( f_string(function () { var tmp = {v_block: this.v_block,v_needs_return: 1,v_top_level: 1,}; tmp.__proto__ = MiniPerl6$Javascript$LexicalBlock; return tmp }().f_emit_javascript()) + f_string(" }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Sub.f_emit_javascript = function () {
    var v_self = this;
    try { var v_sig;var v_pos;var v_str;(v_sig = this.v_sig);(v_pos = v_sig.f_positional());(v_str = (function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit_javascript() ) } return out; })((v_pos)).join(", "));return(( f_string("function ") + f_string(( f_string(this.v_name) + f_string(( f_string("(") + f_string(( f_string(v_str) + f_string(( f_string(") { ") + f_string(( f_string(function () { var tmp = {v_block: this.v_block,v_needs_return: 1,v_top_level: 1,}; tmp.__proto__ = MiniPerl6$Javascript$LexicalBlock; return tmp }().f_emit_javascript()) + f_string(" }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Do.f_emit_javascript = function () {
    var v_self = this;
    try { return(( f_string("(function () { ") + f_string(( f_string(function () { var tmp = {v_block: this.v_block,v_needs_return: 1,}; tmp.__proto__ = MiniPerl6$Javascript$LexicalBlock; return tmp }().f_emit_javascript()) + f_string(" })()") )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
