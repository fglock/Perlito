...
(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v__) { if ( f_bool((v__ != null)) ) { (function () { f_push(List_block, v__); })() }; })(a_[i_]) } })(v_self.v_block);if ( f_bool(( f_bool(List_block) ? false : true)) ) { (function () { throw("null"); })() };(v_str = "");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_decl) { if ( f_bool(f_and(f_isa(v_decl, "Decl"), function () { return (v_decl.f_decl() == "my")})) ) { (function () { (v_str = (f_string(v_str) + f_string(v_decl.f_emit_javascript_init()))); })() };if ( f_bool(f_and(f_isa(v_decl, "Apply"), function () { return (v_decl.f_code() == "infix:<=>")})) ) { (function () { var v_var = null;
(v_var = v_decl.f_arguments()[0]);if ( f_bool(f_and(f_isa(v_var, "Decl"), function () { return (v_var.f_decl() == "my")})) ) { (function () { (v_str = (f_string(v_str) + f_string(v_var.f_emit_javascript_init()))); })() }; })() }; })(a_[i_]) } })(List_block);if ( f_bool(v_self.v_needs_return) ) { (function () { (v_last_statement = f_pop(List_block)); })() };(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_decl) { if ( f_bool(( f_bool((f_and(f_isa(v_decl, "Decl"), function () { return (v_decl.f_decl() == "my")}))) ? false : true)) ) { (function () { (v_str = (f_string(v_str) + f_string(v_decl.f_emit_javascript()) + f_string(";"))); })() }; })(a_[i_]) } })(List_block);if ( f_bool(f_and(v_self.v_needs_return, function () { return v_last_statement})) ) { (function () { if ( f_bool(f_isa(v_last_statement, "If")) ) { (function () { var v_cond = null;
var v_body = null;
...
var v_last_pos = null;
(v_last_match_null = 0);(v_last_pos = v_MATCH.f_to());for ( ; f_bool(f_and(((function () { var v_m2 = null;
(v_m2 = Perlito$Expression.f_delimited_statement(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());if ( f_bool((v_MATCH).hasOwnProperty("Perlito::Expression.delimited_statement")) ) { (function () { ((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Expression.delimited_statement"] ); })()).push(v_m2); })() } else { (function () { (function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Expression.delimited_statement"]  = [v_m2]); })(); })() };return(1) })() } else { return (function () { return(false) })() } })()), function () { return ((v_last_match_null < 2))}));  ) { (function () { if ( f_bool((v_last_pos == v_MATCH.f_to())) ) { (function () { (v_last_match_null = f_add(v_last_match_null, 1)); })() } else { (function () { (v_last_match_null = 0); })() };(v_last_pos = v_MATCH.f_to()); })() };(v_MATCH.v_to = v_last_pos);return(1) })()), function () { return (f_or(((function () { return((v_MATCH.v_capture = (function (a_) { var out = []; if ( a_ == null ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_capture() ) }; return out; })((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["Perlito::Expression.delimited_statement"] ); })()))) })()), function () { return 1}))}))) })())) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(v_c2 = (v_str || "").substr(f_add(v_pos, 1), 1));if ( f_bool(f_and(v__NAMESPACE.f_is_ident_middle(v_op1), function () { return (f_or(v__NAMESPACE.f_is_ident_middle(v_c2), function () { return (v_c2 == "(")}))})) ) { (function () { null })() } else { (function () { var v_c01 = null;
var v_c02 = null;
...
(v_pos1 = v_MATCH.f_to());return(((function () { return((f_and(((function () { var v_last_pos = null;
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { return(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())) })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })()), function () { return ((function () { var v_pos1 = null;
(v_pos1 = v_MATCH.f_to());return(f_or(((function () { return((f_and((f_and((";" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))})), function () { return ((function () { var v_last_pos = null;
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { return(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())) })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())}))) })()), function () { return ((function () { (v_MATCH.v_to = v_pos1);return((f_and(f_and(f_and(((function () { var v_m2 = null;
(v_m2 = v_grammar.f_statement_parse(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());(function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["statement_parse"]  = v_m2); })();return(1) })() } else { return (function () { return(false) })() } })()), function () { return ((function () { var v_last_pos = null;
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { return((f_and((";" == (v_str || "").substr(v_MATCH.f_to(), 1)), function () { return ((v_MATCH.v_to = f_add(1, v_MATCH.f_to())))}))) })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())}), function () { return ((function () { var v_last_pos = null;
(v_last_pos = v_MATCH.f_to());if ( f_bool(( f_bool(((function () { return(((function () { var v_m2 = null;
(v_m2 = Perlito$Grammar.f_ws(v_str, v_MATCH.f_to()));if ( f_bool(v_m2) ) { return (function () { (v_MATCH.v_to = v_m2.f_to());return(1) })() } else { return (function () { return(false) })() } })())) })())) ? false : true)) ) { (function () { (v_MATCH.v_to = v_last_pos); })() };return(1) })())}), function () { return (f_or(((function () { return((v_MATCH.v_capture = f_scalar((function () { if (v_MATCH == null) { v_MATCH = {} }; return (v_MATCH["statement_parse"] ); })()))) })()), function () { return 1}))}))) })())})) })())}))) })())) })())));return(v_MATCH) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
