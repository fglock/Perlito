...
(v_a = v_self.v_parameters.f_hash1());(v_b = v_self.v_arguments.f_hash1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = function () { var tmp = {}; tmp.__proto__ = Val$Undef; return tmp }());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool((v_var2[0].f_buf() == v_var[0].f_buf())) ) { (function () { (v_arg = v_var2[1]); })() } else { (function () { null })() } })(a_[i_]) } })((v_b));(v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: v_arg,}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit_javascript()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(v_self.v_parameters.f_emit_javascript()) + f_string(" }") )) )); })() } else { (function () { null })() };if ( f_bool(f_isa(v_self.v_parameters, "Lit::Object")) ) { (function () { var v_class;var v_a;var v_b;var v_str;var v_i;var v_arg = null;
