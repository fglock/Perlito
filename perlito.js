...
(function () {
  ...
  Decl.f_emit_javascript_init = function () {
    var v_self = this;
    try { if ( f_bool((this.v_decl == "my")) ) { var v_str;(v_str = "");(v_str = ( f_string(v_str) + f_string(( f_string("var ") + f_string(( f_string(this.v_var.f_emit_javascript()) + f_string(" = ") )) )) ));if ( f_bool((this.v_var.f_sigil() == "%")) ) { (v_str = ( f_string(v_str) + f_string(( f_string("{};") + f_string("\n") )) )) } else { if ( f_bool((this.v_var.f_sigil() == "@")) ) { (v_str = ( f_string(v_str) + f_string(( f_string("[];") + f_string("\n") )) )) } else { (v_str = ( f_string(v_str) + f_string(( f_string("null;") + f_string("\n") )) )) } };throw(v_str) } else { return(f_die(( f_string("not implemented: Decl '") + f_string(( f_string(this.v_decl) + f_string("'") )) ))) } } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
