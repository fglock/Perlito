...
(defmethod sv-eval ((sv-self mp-Var) &optional sv-env)
  (block mp6-function
    (let ((sv-ns (sv-undef))(sv-name (sv-undef))) (setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string "::")))) (progn (if (sv-bool (sv-and (sv-eq (sv-sigil sv-self) "@") (sv-and (sv-eq (sv-twigil sv-self) "*") (sv-eq (sv-name sv-self) "ARGS")))) (progn (return-from mp6-function COMMON-LISP-USER::*posix-argv*)) nil)(if (sv-bool (sv-eq (sv-twigil sv-self) ".")) (progn (write-line (format nil "~{~a~}" (list (concatenate 'string (sv-string "Interpreter TODO: $.") (sv-string (sv-name sv-self))))) *error-output*)(return-from mp6-function (concatenate 'string (sv-string "$self->{") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string "}")))))) nil)(if (sv-bool (sv-eq (sv-name sv-self) "/")) (progn (write-line (format nil "~{~a~}" (list "Interpreter TODO: $/")) *error-output*)(return-from mp6-function (concatenate 'string (sv-string (sv-sigil sv-self)) (sv-string "MATCH")))) nil)))(setf sv-name (concatenate 'string (sv-string (sv-sigil sv-self)) (sv-string (concatenate 'string (sv-string sv-ns) (sv-string (sv-name sv-self))))))(loop for sv-e across sv-env do (progn (if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup sv-name sv-e))) (progn (return-from mp6-function (mp-Main::sv-hash-lookup sv-name sv-e))) nil)))(write-line (format nil "~{~a~}" (list "Interpreter runtime error: variable '" sv-name "' not found")) *error-output*))))
...
(defmethod sv-eval ((sv-self mp-Apply) &optional sv-env)
  (block mp6-function
    (let ((sv-ns (sv-undef))(sv-code (sv-undef))) (setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string "::")))) nil)(setf sv-code (concatenate 'string (sv-string sv-ns) (sv-string (sv-code sv-self))))(loop for sv-e across sv-env do (progn (if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup sv-code sv-e))) (progn (sv-apply (return-from mp6-function (mp-Main::sv-hash-lookup sv-code sv-e)) sv-env (sv-arguments sv-self))) nil)))(write-line (format nil "~{~a~}" (list "Interpreter runtime error: subroutine '" sv-code "()' not found")) *error-output*))))
