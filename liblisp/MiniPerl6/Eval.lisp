...
(defmethod sv-apply ((sv-self mp-EvalFunction) &optional sv-env sv-args)
  (block mp6-function
    (progn (funcall (sv-func sv-self) sv-env sv-args))))
...
(defmethod sv-eval ((sv-self mp-Apply) &optional sv-env)
  (block mp6-function
    (let ((sv-ns (sv-undef))(sv-code (sv-undef))) (setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string "::")))) nil)(setf sv-code (concatenate 'string (sv-string sv-ns) (sv-string (sv-code sv-self))))(loop for sv-e across sv-env do (progn (if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup sv-code sv-e))) (progn (return-from mp6-function (sv-apply (mp-Main::sv-hash-lookup sv-code sv-e) sv-env (sv-arguments sv-self)))) nil)))(write-line (format nil "~{~a~}" (list "Interpreter runtime error: subroutine '" sv-code "()' not found")) *error-output*))))
