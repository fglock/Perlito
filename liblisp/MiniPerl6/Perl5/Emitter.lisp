...
(defmethod sv-emit ((sv-self mp-Method))
  (block mp6-function
    (let ((sv-sig (sv-undef))(sv-invocant (sv-undef))(sv-pos (sv-undef))(sv-str (sv-undef))(sv-i (sv-undef))) (setf sv-sig (sv-sig sv-self))(setf sv-invocant (sv-invocant sv-sig ))(setf sv-pos (sv-positional sv-sig ))(setf sv-str "")(setf sv-i 1)(loop for sv-field across sv-pos do (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "my ") (sv-string (concatenate 'string (sv-string (sv-emit sv-field )) (sv-string (concatenate 'string (sv-string " = $_[") (sv-string (concatenate 'string (sv-string sv-i) (sv-string "]; ")))))))))))(setf sv-i (+ sv-i 1))))(concatenate 'string (sv-string "sub ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string " { ") (sv-string (concatenate 'string (sv-string "my ") (sv-string (concatenate 'string (sv-string (sv-emit sv-invocant )) (sv-string (concatenate 'string (sv-string " = $_[0]; ") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit  c)) (sv-block sv-self)) "; ")) (sv-string " }")))))))))))))))))))
...
(defmethod sv-emit ((sv-self mp-Sub))
  (block mp6-function
    (let ((sv-sig (sv-undef))(sv-pos (sv-undef))(sv-str (sv-undef))(sv-i (sv-undef))) (setf sv-sig (sv-sig sv-self))(setf sv-pos (sv-positional sv-sig ))(setf sv-str "")(setf sv-i 0)(loop for sv-field across sv-pos do (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "my ") (sv-string (concatenate 'string (sv-string (sv-emit sv-field )) (sv-string (concatenate 'string (sv-string " = $_[") (sv-string (concatenate 'string (sv-string sv-i) (sv-string "]; ")))))))))))(setf sv-i (+ sv-i 1))))(concatenate 'string (sv-string "sub ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string " { ") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit  c)) (sv-block sv-self)) "; ")) (sv-string " }")))))))))))))
