...
(defmethod sv-emit ((sv-self mp-Apply))
  (block mp6-function
    (let ((sv-ns (sv-undef))(sv-code (sv-undef))) (setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (sv-namespace sv-self)) (sv-string "::")))) nil)(setf sv-code (concatenate 'string (sv-string sv-ns) (sv-string (sv-code sv-self))))(if (sv-bool (typep sv-code 'string)) nil (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit (sv-code sv-self) )) (sv-string (concatenate 'string (sv-string ")->(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))(if (sv-bool (sv-eq sv-code "self")) (progn (return-from mp6-function "$self")) nil)(if (sv-bool (sv-eq sv-code "false")) (progn (return-from mp6-function "0")) nil)(if (sv-bool (sv-eq sv-code "make")) (progn (return-from mp6-function (concatenate 'string (sv-string "($MATCH->capture = (") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string "))")))))) nil)(if (sv-bool (sv-eq sv-code "say")) (progn (return-from mp6-function (concatenate 'string (sv-string "Main::say(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "print")) (progn (return-from mp6-function (concatenate 'string (sv-string "Main::print(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "warn")) (progn (return-from mp6-function (concatenate 'string (sv-string "warn(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "array")) (progn (return-from mp6-function (concatenate 'string (sv-string "@{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) nil)(if (sv-bool (sv-eq sv-code "pop")) (progn (return-from mp6-function (concatenate 'string (sv-string "pop( @{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "} )")))))) nil)(if (sv-bool (sv-eq sv-code "push")) (progn (return-from mp6-function (concatenate 'string (sv-string "push( @{") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string "}, ") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 1) )) (sv-string " )")))))))))) nil)(if (sv-bool (sv-eq sv-code "shift")) (progn (return-from mp6-function (concatenate 'string (sv-string "shift( @{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "} )")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(\"\" . ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string " ? 0 : 1)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<?>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string " ? 1 : 0)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<$>")) (progn (return-from mp6-function (concatenate 'string (sv-string "${") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<@>")) (progn (return-from mp6-function (concatenate 'string (sv-string "@{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<%>")) (progn (return-from mp6-function (concatenate 'string (sv-string "%{") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ")) (sv-string "}")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " . ")) (sv-string "")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<+>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<->")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " - ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<>>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " > ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<x>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " x ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<&&>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " && ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<||>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " || ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<eq>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " eq ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<ne>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " ne ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<==>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<!=>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "ternary:<?? !!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string " ? ") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " : ") (sv-string (concatenate 'string (sv-string (sv-emit (elt (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))) nil)(concatenate 'string (sv-string sv-code) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))
