...
;; (in-package mp-MiniPerl6-Javascript-LexicalBlock)
...
(defmethod sv-emit_javascript ((sv-self mp-Lit-Seq))
  (block mp6-function
    (progn (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-seq sv-self)) ", ")) (sv-string ")")))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Lit-Hash))
  (block mp6-function
    (let ((sv-needs_interpolation (sv-undef))) (setf sv-needs_interpolation 0)(dolist (sv-item (sv-hash1 sv-self)) (progn (if (sv-bool (not (sv-bool (typep (elt sv-item 0) 'mp-Val-Buf)))) (progn (setf sv-needs_interpolation 1)) nil)))(if (sv-bool sv-needs_interpolation) (let ((sv-s (sv-undef))) (setf sv-s "")(dolist (sv-field (sv-hash1 sv-self)) (progn (setf sv-s (concatenate 'string (sv-string sv-s) (sv-string (concatenate 'string (sv-string "a[") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string "] = ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 1) )) (sv-string "; ")))))))))))))(return-from mp6-function (concatenate 'string (sv-string "(function () { var a = []; ") (sv-string (concatenate 'string (sv-string sv-s) (sv-string " return a })()")))))) (let ((sv-str (sv-undef))) (setf sv-str "")(dolist (sv-field (sv-hash1 sv-self)) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string ":") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 1) )) (sv-string ",")))))))))))(return-from mp6-function (concatenate 'string (sv-string "{ ") (sv-string (concatenate 'string (sv-string sv-str) (sv-string " }"))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Lit-Object))
  (block mp6-function
    (let ((sv-fields (sv-undef))(sv-str (sv-undef))) (setf sv-fields (sv-fields sv-self))(setf sv-str "")(dolist (sv-field sv-fields) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "v_") (sv-string (concatenate 'string (sv-string (sv-buf (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string ": ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 1) )) (sv-string ",")))))))))))))(concatenate 'string (sv-string "function () { ") (sv-string (concatenate 'string (sv-string "var tmp = {") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "}; ") (sv-string (concatenate 'string (sv-string "tmp.__proto__ = ") (sv-string (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-class sv-self))) (sv-string (concatenate 'string (sv-string "; ") (sv-string (concatenate 'string (sv-string "return tmp ") (sv-string "}()")))))))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Var))
  (block mp6-function
    (let ((sv-table (sv-undef))(sv-ns (sv-undef))) (setf sv-table (let ((h (make-hash-table :test 'equal))) (setf (gethash "$" h) "v_")(setf (gethash "@" h) "List_")(setf (gethash "%" h) "Hash_")(setf (gethash "&" h) "Code_") h))(setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-namespace sv-self))) (sv-string ".")))) nil)(if (sv-bool (sv-eq (sv-twigil sv-self) ".")) (concatenate 'string (sv-string "v_self.v_") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string "")))) (if (sv-bool (sv-eq (sv-name sv-self) "/")) (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string "MATCH")) (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string (concatenate 'string (sv-string sv-ns) (sv-string (sv-name sv-self))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Bind))
  (block mp6-function
    (progn (if (sv-bool (typep (sv-parameters sv-self) 'mp-Lit-Array)) (let ((sv-a (sv-undef))(sv-str (sv-undef))(sv-i (sv-undef))) (setf sv-a (sv-array1 (sv-parameters sv-self) ))(setf sv-str "do { ")(setf sv-i 0)(dolist (sv-var sv-a) (let ((sv-bind (sv-undef))) (setf sv-bind (let ((m (make-instance 'mp-Bind))) (setf (sv-parameters m) sv-var)(setf (sv-arguments m) (let ((m (make-instance 'mp-Index))) (setf (sv-obj m) (sv-arguments sv-self))(setf (sv-index_exp m) (let ((m (make-instance 'mp-Val-Int))) (setf (sv-int m) sv-i) m)) m)) m))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string " ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript sv-bind )) (sv-string "; ")))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-parameters sv-self) )) (sv-string " }")))))) nil)(if (sv-bool (typep (sv-parameters sv-self) 'mp-Lit-Hash)) (let ((sv-a (sv-undef))(sv-b (sv-undef))(sv-str (sv-undef))(sv-i (sv-undef))(sv-arg (sv-undef))) (setf sv-a (sv-hash1 (sv-parameters sv-self) ))(setf sv-b (sv-hash1 (sv-arguments sv-self) ))(setf sv-str "do { ")(setf sv-i 0)(dolist (sv-var sv-a) (let ((sv-bind (sv-undef))) (setf sv-arg (make-instance 'mp-Val-Undef))(dolist (sv-var2 sv-b) (progn (if (sv-bool (sv-eq (sv-buf (elt sv-var2 0) ) (sv-buf (elt sv-var 0) ))) (progn (setf sv-arg (elt sv-var2 1))) nil)))(setf sv-bind (let ((m (make-instance 'mp-Bind))) (setf (sv-parameters m) (elt sv-var 1))(setf (sv-arguments m) sv-arg) m))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string " ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript sv-bind )) (sv-string "; ")))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-parameters sv-self) )) (sv-string " }")))))) nil)(if (sv-bool (typep (sv-parameters sv-self) 'mp-Lit-Object)) (let ((sv-class (sv-undef))(sv-a (sv-undef))(sv-b (sv-undef))(sv-str (sv-undef))(sv-i (sv-undef))(sv-arg (sv-undef))) (setf sv-class (sv-class (sv-parameters sv-self) ))(setf sv-a (sv-fields (sv-parameters sv-self) ))(setf sv-b (sv-arguments sv-self))(setf sv-str "do { ")(setf sv-i 0)(dolist (sv-var sv-a) (let ((sv-bind (sv-undef))) (setf sv-bind (let ((m (make-instance 'mp-Bind))) (setf (sv-parameters m) (elt sv-var 1))(setf (sv-arguments m) (let ((m (make-instance 'mp-Call))) (setf (sv-invocant m) sv-b)(setf (sv-method m) (sv-buf (elt sv-var 0) ))(setf (sv-arguments m) nil)(setf (sv-hyper m) 0) m)) m))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string " ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript sv-bind )) (sv-string "; ")))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-parameters sv-self) )) (sv-string " }")))))) nil)(if (sv-bool (typep (sv-parameters sv-self) 'mp-Call)) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-invocant (sv-parameters sv-self) ) )) (sv-string (concatenate 'string (sv-string ".v_") (sv-string (concatenate 'string (sv-string (sv-method (sv-parameters sv-self) )) (sv-string (concatenate 'string (sv-string " = ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-arguments sv-self) )) (sv-string ")")))))))))))))) nil)(concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-parameters sv-self) )) (sv-string (concatenate 'string (sv-string " = ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-arguments sv-self) )) (sv-string ")")))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_javascript (sv-invocant sv-self) ))(if (sv-bool (sv-eq sv-invocant "self")) (progn (setf sv-invocant "v_self")) nil)(if (sv-bool (sv-eq (sv-method sv-self) "values")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (progn (write-line (format nil "~{~a~}" (list "not implemented")) *error-output*) (sb-ext:quit))) (progn (return-from mp6-function (concatenate 'string (sv-string "f_values(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "perl") (sv-or (sv-eq (sv-method sv-self) "isa") (sv-eq (sv-method sv-self) "scalar")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string "f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string (if (sv-bool (sv-arguments sv-self)) (concatenate 'string (sv-string ", ") (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", "))) "")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "join") (sv-or (sv-eq (sv-method sv-self) "shift") (sv-or (sv-eq (sv-method sv-self) "push") (sv-eq (sv-method sv-self) "pop"))))) (progn (return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "yaml") (sv-or (sv-eq (sv-method sv-self) "say") (sv-eq (sv-method sv-self) "chars")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) (progn (if (sv-bool (sv-defined (sv-arguments sv-self))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-hyper sv-self)) (progn (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( a_[i].f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "() ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")"))))))))))))))))))) (progn (if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ")(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")"))))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Apply))
  (block mp6-function
    (let ((sv-code (sv-undef))) (setf sv-code (sv-code sv-self))(if (sv-bool (typep sv-code 'string)) nil (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-code sv-self) )) (sv-string (concatenate 'string (sv-string ")->(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))(if (sv-bool (sv-eq sv-code "self")) (progn (return-from mp6-function "v_self")) nil)(if (sv-bool (sv-eq sv-code "false")) (progn (return-from mp6-function "0")) nil)(if (sv-bool (sv-eq sv-code "make")) (progn (return-from mp6-function (concatenate 'string (sv-string "(v_MATCH.v_capture = ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "say")) (progn (return-from mp6-function (concatenate 'string (sv-string "say(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "print")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_print(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "warn")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_warn(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "defined")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string " != null)")))))) nil)(if (sv-bool (sv-eq sv-code "substr")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string " || \"\").substr(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))) nil)(if (sv-bool (sv-eq sv-code "Int")) (progn (return-from mp6-function (concatenate 'string (sv-string "parseInt(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "Num")) (progn (return-from mp6-function (concatenate 'string (sv-string "parseFloat(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ").f_string()")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ") ? false : true)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<?>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ") ? true : false)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<$>")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_scalar(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<@>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<%>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ").f_hash()")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_string(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " + f_string(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<+>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<->")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " - ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<>>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " > ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<&&>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " && f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<||>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " || f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<eq>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<ne>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<==>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<!=>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "exists")) (let ((sv-arg (sv-undef))) (setf sv-arg (elt (sv-arguments sv-self) 0))(if (sv-bool (typep sv-arg 'mp-Lookup)) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-obj sv-arg ) )) (sv-string (concatenate 'string (sv-string ").hasOwnProperty(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-index_exp sv-arg ) )) (sv-string ")")))))))))) nil)) nil)(if (sv-bool (sv-eq sv-code "ternary:<?? !!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " ? ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " : ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))))) nil)(setf sv-code (concatenate 'string (sv-string "f_") (sv-string (sv-code sv-self))))(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-code (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-namespace sv-self))) (sv-string (concatenate 'string (sv-string ".") (sv-string sv-code)))))) (progn (if (sv-bool (sv-and (not (sv-eq sv-code "f_index")) (sv-and (not (sv-eq sv-code "f_die")) (sv-and (not (sv-eq sv-code "f_pop")) (sv-and (not (sv-eq sv-code "f_shift")) (not (sv-eq sv-code "f_push"))))))) (progn (setf sv-code (concatenate 'string (sv-string "v__NAMESPACE.") (sv-string sv-code)))) nil)))(concatenate 'string (sv-string sv-code) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-If))
  (block mp6-function
    (let ((sv-cond (sv-undef))) (setf sv-cond (sv-cond sv-self))(if (sv-bool (sv-and (typep sv-cond 'mp-Apply) (sv-eq (sv-code sv-cond ) "prefix:<!>"))) (let ((sv-if (sv-undef))) (setf sv-if (let ((m (make-instance 'mp-If))) (setf (sv-cond m) (elt (sv-arguments sv-cond ) 0))(setf (sv-body m) (sv-otherwise sv-self))(setf (sv-otherwise m) (sv-body sv-self)) m))(return-from mp6-function (sv-emit_javascript sv-if ))) nil)(if (sv-bool (sv-and (typep sv-cond 'mp-Var) (sv-eq (sv-sigil sv-cond ) "@"))) (progn (setf sv-cond (let ((m (make-instance 'mp-Apply))) (setf (sv-code m) "prefix:<@>")(setf (sv-arguments m) (concatenate 'list  (list sv-cond))) m))) nil)(concatenate 'string (sv-string "if ( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript sv-cond )) (sv-string (concatenate 'string (sv-string ") ) { ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-body sv-self)) ";")) (sv-string (concatenate 'string (sv-string " } else { ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-otherwise sv-self)) ";")) (sv-string " }")))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-For))
  (block mp6-function
    (progn (concatenate 'string (sv-string "(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { ") (sv-string (concatenate 'string (sv-string "(function (") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-topic sv-self) )) (sv-string (concatenate 'string (sv-string ") { ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-body sv-self)) ";")) (sv-string (concatenate 'string (sv-string " })(a_[i_]) } })") (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-cond sv-self) )) (sv-string ")")))))))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Method))
  (block mp6-function
    (let ((sv-sig (sv-undef))(sv-invocant (sv-undef))(sv-pos (sv-undef))(sv-str (sv-undef))) (setf sv-sig (sv-sig sv-self))(setf sv-invocant (sv-invocant sv-sig ))(setf sv-pos (sv-positional sv-sig ))(setf sv-str (sv-join (mapcar #'sv-emit_javascript sv-pos) ", "))(concatenate 'string (sv-string "function ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string ") { ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (let ((m (make-instance 'mp-MiniPerl6-Javascript-LexicalBlock))) (setf (sv-block m) (sv-block sv-self))(setf (sv-needs_return m) 1)(setf (sv-top_level m) 1) m) )) (sv-string " }")))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Sub))
  (block mp6-function
    (let ((sv-sig (sv-undef))(sv-pos (sv-undef))(sv-str (sv-undef))) (setf sv-sig (sv-sig sv-self))(setf sv-pos (sv-positional sv-sig ))(setf sv-str (sv-join (mapcar #'sv-emit_javascript sv-pos) ", "))(concatenate 'string (sv-string "function ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string ") { ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (let ((m (make-instance 'mp-MiniPerl6-Javascript-LexicalBlock))) (setf (sv-block m) (sv-block sv-self))(setf (sv-needs_return m) 1)(setf (sv-top_level m) 1) m) )) (sv-string " }")))))))))))))))
