...
(defmethod sv-emit_javascript ((sv-self mp-Lit-Seq))
  (block mp6-function
    (progn (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-seq sv-self)) tmp ) ", ")) (sv-string ")")))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_javascript (sv-invocant sv-self) ))(if (sv-bool (sv-eq sv-invocant "self")) (progn (setf sv-invocant "v_self")) nil)(if (sv-bool (sv-eq (sv-method sv-self) "values")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (progn (write-line (format nil "~{~a~}" (list "not implemented")) *error-output*) (sb-ext:quit))) (progn (return-from mp6-function (concatenate 'string (sv-string "f_values(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "perl") (sv-or (sv-eq (sv-method sv-self) "isa") (sv-eq (sv-method sv-self) "scalar")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string "f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string (if (sv-bool (sv-arguments sv-self)) (concatenate 'string (sv-string ", ") (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", "))) "")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "join") (sv-or (sv-eq (sv-method sv-self) "shift") (sv-or (sv-eq (sv-method sv-self) "push") (sv-eq (sv-method sv-self) "pop"))))) (progn (return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "yaml") (sv-or (sv-eq (sv-method sv-self) "say") (sv-eq (sv-method sv-self) "chars")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) (progn (if (sv-bool (sv-defined (sv-arguments sv-self))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))))))))))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-hyper sv-self)) (progn (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( a_[i].f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "() ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")"))))))))))))))))))) (progn (if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ")(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")"))))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Apply))
  (block mp6-function
    (let ((sv-code (sv-undef))) (setf sv-code (sv-code sv-self))(if (sv-bool (typep sv-code 'string)) nil (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-code sv-self) )) (sv-string (concatenate 'string (sv-string ")->(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))))))))(if (sv-bool (sv-eq sv-code "self")) (progn (return-from mp6-function "v_self")) nil)(if (sv-bool (sv-eq sv-code "false")) (progn (return-from mp6-function "0")) nil)(if (sv-bool (sv-eq sv-code "make")) (progn (return-from mp6-function (concatenate 'string (sv-string "(v_MATCH.v_capture = ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "say")) (progn (return-from mp6-function (concatenate 'string (sv-string "say(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "print")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_print(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "warn")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_warn(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "defined")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string " != null)")))))) nil)(if (sv-bool (sv-eq sv-code "substr")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string " || \"\").substr(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))) nil)(if (sv-bool (sv-eq sv-code "Int")) (progn (return-from mp6-function (concatenate 'string (sv-string "parseInt(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "Num")) (progn (return-from mp6-function (concatenate 'string (sv-string "parseFloat(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string ").f_string()")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string ") ? false : true)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<?>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string ") ? true : false)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<$>")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_scalar(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<@>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<%>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " ")) (sv-string ").f_hash()")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_string(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " + f_string(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<+>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<->")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " - ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<>>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " > ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<&&>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " && f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<||>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " || f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<eq>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<ne>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<==>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<!=>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "exists")) (let ((sv-arg (sv-undef))) (setf sv-arg (mp-Main::sv-array-index (sv-arguments sv-self) 0))(if (sv-bool (typep sv-arg 'mp-Lookup)) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-obj sv-arg ) )) (sv-string (concatenate 'string (sv-string ").hasOwnProperty(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-index_exp sv-arg ) )) (sv-string ")")))))))))) nil)) nil)(if (sv-bool (sv-eq sv-code "ternary:<?? !!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " ? ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " : ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (mp-Main::sv-array-index (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))))) nil)(setf sv-code (concatenate 'string (sv-string "f_") (sv-string (sv-code sv-self))))(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-code (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-namespace sv-self))) (sv-string (concatenate 'string (sv-string ".") (sv-string sv-code)))))) (progn (if (sv-bool (sv-and (not (sv-eq sv-code "f_index")) (sv-and (not (sv-eq sv-code "f_die")) (sv-and (not (sv-eq sv-code "f_pop")) (sv-and (not (sv-eq sv-code "f_shift")) (not (sv-eq sv-code "f_push"))))))) (progn (setf sv-code (concatenate 'string (sv-string "v__NAMESPACE.") (sv-string sv-code)))) nil)))(concatenate 'string (sv-string sv-code) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-For))
  (block mp6-function
    (progn (concatenate 'string (sv-string "(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { ") (sv-string (concatenate 'string (sv-string "(function (") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-topic sv-self) )) (sv-string (concatenate 'string (sv-string ") { ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) (sv-body sv-self)) tmp ) ";")) (sv-string (concatenate 'string (sv-string " })(a_[i_]) } })") (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-cond sv-self) )) (sv-string ")")))))))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Method))
  (block mp6-function
    (let ((sv-sig (sv-undef))(sv-invocant (sv-undef))(sv-pos (sv-undef))(sv-str (sv-undef))) (setf sv-sig (sv-sig sv-self))(setf sv-invocant (sv-invocant sv-sig ))(setf sv-pos (sv-positional sv-sig ))(setf sv-str (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) sv-pos) tmp ) ", "))(concatenate 'string (sv-string "function ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string ") { ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (let ((m (make-instance 'mp-MiniPerl6-Javascript-LexicalBlock))) (setf (sv-block m) (sv-block sv-self))(setf (sv-needs_return m) 1)(setf (sv-top_level m) 1) m) )) (sv-string " }")))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Sub))
  (block mp6-function
    (let ((sv-sig (sv-undef))(sv-pos (sv-undef))(sv-str (sv-undef))) (setf sv-sig (sv-sig sv-self))(setf sv-pos (sv-positional sv-sig ))(setf sv-str (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_javascript  c) tmp)) sv-pos) tmp ) ", "))(concatenate 'string (sv-string "function ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string ") { ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (let ((m (make-instance 'mp-MiniPerl6-Javascript-LexicalBlock))) (setf (sv-block m) (sv-block sv-self))(setf (sv-needs_return m) 1)(setf (sv-top_level m) 1) m) )) (sv-string " }")))))))))))))))
