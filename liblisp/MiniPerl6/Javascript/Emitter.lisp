...
(defmethod sv-emit_javascript ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_javascript (sv-invocant sv-self) ))(if (sv-bool (sv-eq sv-invocant "self")) (progn (setf sv-invocant "v_self")) nil)(if (sv-bool (sv-eq (sv-method sv-self) "values")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (progn (write-line (format nil "~{~a~}" (list "not implemented")) *error-output*) (sb-ext:quit))) (progn (return-from mp6-function (concatenate 'string (sv-string "f_values(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "perl") (sv-or (sv-eq (sv-method sv-self) "isa") (sv-eq (sv-method sv-self) "scalar")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string "f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string (if (sv-bool (sv-arguments sv-self)) (concatenate 'string (sv-string ", ") (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit_javascript  c)) (sv-arguments sv-self)) ", "))) "")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "join") (sv-or (sv-eq (sv-method sv-self) "shift") (sv-or (sv-eq (sv-method sv-self) "push") (sv-eq (sv-method sv-self) "pop"))))) (progn (return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit_javascript  c)) (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "yaml") (sv-or (sv-eq (sv-method sv-self) "say") (sv-eq (sv-method sv-self) "chars")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) (progn (if (sv-bool (sv-defined (sv-arguments sv-self))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit_javascript  c)) (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( a_[i].f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "() ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) nil)(if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ")(") (sv-string (concatenate 'string (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit_javascript  c)) (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (map 'vector #'(lambda (c) (sv-emit_javascript  c)) (sv-arguments sv-self)) ", ")) (sv-string ")"))))))))))))))
