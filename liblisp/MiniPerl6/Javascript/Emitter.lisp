...
(defmethod sv-emit_javascript ((sv-self mp-Lit-Hash))
  (block mp6-function
    (let ((sv-fields (sv-undef))(sv-str (sv-undef))) (setf sv-fields (sv-hash sv-self))(setf sv-str "")(dolist (sv-field sv-fields) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string ":") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 1) )) (sv-string ",")))))))))))(concatenate 'string (sv-string "{ ") (sv-string (concatenate 'string (sv-string sv-str) (sv-string " }")))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Lit-Object))
  (block mp6-function
    (let ((sv-fields (sv-undef))(sv-str (sv-undef))) (setf sv-fields (sv-fields sv-self))(setf sv-str "")(dolist (sv-field sv-fields) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "v_") (sv-string (concatenate 'string (sv-string (sv-buf (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string ": ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt sv-field 1) )) (sv-string ",")))))))))))))(concatenate 'string (sv-string "{ __proto__:") (sv-string (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-class sv-self))) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string sv-str) (sv-string "}")))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Var))
  (block mp6-function
    (let ((sv-table (sv-undef))(sv-ns (sv-undef))) (setf sv-table (let ((h (make-hash-table :test 'equal))) (setf (gethash "$" h) "v_")(setf (gethash "@" h) "List_")(setf (gethash "%" h) "Hash_")(setf (gethash "&" h) "Code_") h))(setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-namespace sv-self))) (sv-string ".")))) nil)(if (sv-bool (sv-eq (sv-twigil sv-self) ".")) (concatenate 'string (sv-string "this.v_") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string "")))) (if (sv-bool (sv-eq (sv-name sv-self) "/")) (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string "MATCH")) (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string (concatenate 'string (sv-string sv-ns) (sv-string (sv-name sv-self))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_javascript (sv-invocant sv-self) ))(if (sv-bool (sv-eq sv-invocant "self")) (progn (setf sv-invocant "this")) nil)(if (sv-bool (sv-eq (sv-method sv-self) "values")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (progn (write-line (format nil "~{~a~}" (list "not implemented")) *error-output*) (sb-ext:quit))) (progn (return-from mp6-function (concatenate 'string (sv-string "@{") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string "}")))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "perl") (sv-or (sv-eq (sv-method sv-self) "isa") (sv-eq (sv-method sv-self) "scalar")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string "f_") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string (if (sv-bool (sv-arguments sv-self)) (concatenate 'string (sv-string ", ") (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", "))) "")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-eq (sv-method sv-self) "join")) (progn (return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))) nil)(if (sv-bool (sv-or (sv-eq (sv-method sv-self) "yaml") (sv-or (sv-eq (sv-method sv-self) "say") (sv-eq (sv-method sv-self) "chars")))) (progn (if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(a_[i]) ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))) (progn (if (sv-bool (sv-defined (sv-arguments sv-self))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))))) (progn (return-from mp6-function (concatenate 'string (sv-string "Main.") (sv-string (concatenate 'string (sv-string (sv-method sv-self)) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (setf sv-meth "")) nil)(if (sv-bool (sv-hyper sv-self)) (progn (concatenate 'string (sv-string "(function (a_) { ") (sv-string (concatenate 'string (sv-string "var out = []; ") (sv-string (concatenate 'string (sv-string "if ( typeof a_ == 'undefined' ) { return out }; ") (sv-string (concatenate 'string (sv-string "for(var i = 0; i < a_.length; i++) { ") (sv-string (concatenate 'string (sv-string "out.push( a_[i].f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "() ) } return out;") (sv-string (concatenate 'string (sv-string " })(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")"))))))))))))))))))) (progn (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ".f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))))))
...
(defmethod sv-emit_javascript ((sv-self mp-Apply))
  (block mp6-function
    (let ((sv-code (sv-undef))) (setf sv-code (sv-code sv-self))(if (sv-bool (typep sv-code 'string)) nil (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (sv-code sv-self) )) (sv-string (concatenate 'string (sv-string ")->(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))))(if (sv-bool (sv-eq sv-code "self")) (progn (return-from mp6-function "this")) nil)(if (sv-bool (sv-eq sv-code "false")) (progn (return-from mp6-function "0")) nil)(if (sv-bool (sv-eq sv-code "make")) (progn (return-from mp6-function (concatenate 'string (sv-string "(v_MATCH.v_capture = ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "say")) (progn (return-from mp6-function (concatenate 'string (sv-string "say(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "print")) (progn (return-from mp6-function (concatenate 'string (sv-string "print(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "warn")) (progn (return-from mp6-function (concatenate 'string (sv-string "warn(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "defined")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string " != null)")))))) nil)(if (sv-bool (sv-eq sv-code "substr")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ").substr(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ", ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ").f_string()")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ") ? false : true)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<?>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ") ? true : false)")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<$>")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_scalar(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<@>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<%>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " ")) (sv-string ").f_hash()")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_string(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " + f_string(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<+>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " + ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<->")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " - ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<>>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " > ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<&&>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " && f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<||>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " || f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string ") )")))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<eq>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<ne>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<==>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " == ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "infix:<!=>")) (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) " != ")) (sv-string ")")))))) nil)(if (sv-bool (sv-eq sv-code "ternary:<?? !!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "( f_bool(") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string " ? ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " : ") (sv-string (concatenate 'string (sv-string (sv-emit_javascript (elt (sv-arguments sv-self) 2) )) (sv-string ")")))))))))))))))) nil)(setf sv-code (concatenate 'string (sv-string "f_") (sv-string (sv-code sv-self))))(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-code (concatenate 'string (sv-string (mp-Main::sv-to_javascript_namespace (sv-namespace sv-self))) (sv-string (concatenate 'string (sv-string ".") (sv-string sv-code)))))) nil)(concatenate 'string (sv-string sv-code) (sv-string (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_javascript (sv-arguments sv-self)) ", ")) (sv-string ")")))))))))
