...
") (sv-string (concatenate 'string (sv-string "  Method_") (sv-string (concatenate 'string (sv-string sv-class_name) (sv-string (concatenate 'string (sv-string ".f_") (sv-string (concatenate 'string (sv-string (sv-name (sv-var sv-decl ) )) (sv-string (concatenate 'string (sv-string " = func (v_self *") (sv-string (concatenate 'string (sv-string sv-class_name) (sv-string (concatenate 'string (sv-string ", v Capture) *Any {") (sv-string (concatenate 'string (sv-string "
") (sv-string (concatenate 'string (sv-string "    ") (sv-string (concatenate 'string (sv-string "if v_self.v_") (sv-string (concatenate 'string (sv-string (sv-name (sv-var sv-decl ) )) (sv-string (concatenate 'string (sv-string " == nil {") (sv-string "
")))))))))))))))))))))))))))))))))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "      ") (sv-string (sv-emit_go_init (let ((m (make-instance 'mp-Decl))) (setf (sv-decl m) "my")(setf (sv-type m) (sv-undef))(setf (sv-var m) (let ((m (make-instance 'mp-Var))) (setf (sv-sigil m) (sv-sigil (sv-var sv-decl ) ))(setf (sv-twigil m) "")(setf (sv-namespace m) "")(setf (sv-name m) "tmp") m)) m) ))))))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "      ") (sv-string (concatenate 'string (sv-string "v_self.v_") (sv-string (concatenate 'string (sv-string (sv-name (sv-var sv-decl ) )) (sv-string (concatenate 'string (sv-string " = ") (sv-string (concatenate 'string (sv-string (sv-emit_go (let ((m (make-instance 'mp-Var))) (setf (sv-sigil m) (sv-sigil (sv-var sv-decl ) ))(setf (sv-twigil m) "")(setf (sv-namespace m) "")(setf (sv-name m) "tmp") m) )) (sv-string (concatenate 'string (sv-string ";") (sv-string (concatenate 'string (sv-string "
...
(in-package mp-CompUnit)
  ...
  (block mp6-function (let ((sv-str (sv-undef))(sv-unit_seen (sv-undef))(sv-tmp_comp_unit (sv-undef))(sv-meth_seen (sv-undef))) (setf sv-str "")(dolist (sv-comp_unit sv-comp_units) (let ((sv-name (sv-undef))) (setf sv-name (sv-name sv-comp_unit ))(if (sv-bool (gethash sv-name sv-unit_seen)) (progn (dolist (sv-stmt (sv-body sv-comp_unit )) (progn (sv-push (sv-body (gethash sv-name sv-unit_seen) ) sv-stmt)))) (progn (setf (gethash sv-name sv-unit_seen) sv-comp_unit)(sv-push sv-tmp_comp_unit sv-comp_unit)))))(setf sv-comp_units sv-tmp_comp_unit)(dolist (sv-comp_unit sv-comp_units) (progn (dolist (sv-stmt (sv-body sv-comp_unit )) (progn (if (sv-bool (typep sv-stmt 'mp-Method)) (progn (setf (gethash (sv-name sv-stmt ) (sv-methods sv-comp_unit )) sv-stmt)) nil)(if (sv-bool (sv-and (typep sv-stmt 'mp-Decl) (sv-eq (sv-decl sv-stmt ) "has"))) (progn (setf (gethash (sv-name (sv-var sv-stmt ) ) (sv-attributes sv-comp_unit )) sv-stmt)) nil)))))(dolist (sv-comp_unit sv-comp_units) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (sv-emit_go sv-comp_unit ))))))(if (sv-bool (not (sv-bool (gethash "MiniPerl6::Grammar" sv-unit_seen)))) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string "type MiniPerl6__Grammar struct{}
")))) nil)(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string "// interfaces for all methods
")))(setf sv-meth_seen (let ((h (make-hash-table :test 'equal))) (setf (gethash "join" h) 1)(setf (gethash "perl" h) 1)(setf (gethash "scalar" h) 1)(setf (gethash "isa" h) 1)(setf (gethash "values" h) 1)(setf (gethash "bind" h) 1)(setf (gethash "int" h) 1)(setf (gethash "str" h) 1)(setf (gethash "bool" h) 1)(setf (gethash "array" h) 1)(setf (gethash "hash" h) 1)(setf (gethash "push" h) 1)(setf (gethash "lookup" h) 1)(setf (gethash "index" h) 1) h))(dolist (sv-comp_unit sv-comp_units) (progn (dolist (sv-stmt (sv-body sv-comp_unit )) (progn (if (sv-bool (sv-and (typep sv-stmt 'mp-Method) (not (sv-bool (gethash (sv-name sv-stmt ) sv-meth_seen))))) (let ((sv-meth (sv-undef))) (setf sv-meth (sv-name sv-stmt ))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "type ") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "_er interface { f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string " (Capture) *Any }
...
(defmethod sv-emit_go ((sv-self mp-Lit-Object))
  (block mp6-function
    (let ((sv-fields (sv-undef))(sv-str (sv-undef))) (setf sv-fields (sv-fields sv-self))(setf sv-str "")(dolist (sv-field sv-fields) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "if m.v_") (sv-string (concatenate 'string (sv-string (sv-buf (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string " == nil {") (sv-string (concatenate 'string (sv-string "var p Any; ") (sv-string (concatenate 'string (sv-string "m.v_") (sv-string (concatenate 'string (sv-string (sv-buf (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string " = &p; ") (sv-string (concatenate 'string (sv-string "}") (sv-string (concatenate 'string (sv-string "*m.v_") (sv-string (concatenate 'string (sv-string (sv-buf (elt sv-field 0) )) (sv-string (concatenate 'string (sv-string " = *") (sv-string (concatenate 'string (sv-string (sv-emit_go (elt sv-field 1) )) (sv-string "; ")))))))))))))))))))))))))))))(concatenate 'string (sv-string "func() *Any { ") (sv-string (concatenate 'string (sv-string "var m = new(") (sv-string (concatenate 'string (sv-string (mp-Main::sv-to_go_namespace (sv-class sv-self))) (sv-string (concatenate 'string (sv-string "); ") (sv-string (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "var m1 Any = m; ") (sv-string (concatenate 'string (sv-string "return &m1; ") (sv-string "}()")))))))))))))))))
...
(defmethod sv-emit_go ((sv-self mp-Var))
  (block mp6-function
    (let ((sv-table (sv-undef))(sv-ns (sv-undef))) (setf sv-table (let ((h (make-hash-table :test 'equal))) (setf (gethash "$" h) "v_")(setf (gethash "@" h) "List_")(setf (gethash "%" h) "Hash_")(setf (gethash "&" h) "Code_") h))(setf sv-ns "")(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-ns (concatenate 'string (sv-string (mp-Main::sv-to_go_namespace (sv-namespace sv-self))) (sv-string ".")))) nil)(if (sv-bool (sv-eq (sv-twigil sv-self) ".")) (concatenate 'string (sv-string "(*v_self).(") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string "_er).f_") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string "(Capture{})")))))))) (if (sv-bool (sv-eq (sv-name sv-self) "/")) "Proto_MiniPerl6__Match" (concatenate 'string (sv-string (gethash (sv-sigil sv-self) sv-table)) (sv-string (concatenate 'string (sv-string sv-ns) (sv-string (sv-name sv-self))))))))))
...
(defmethod sv-emit_go ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_go (sv-invocant sv-self) ))(if (sv-bool (typep (sv-invocant sv-self) 'mp-Proto)) (progn (setf sv-invocant (concatenate 'string (sv-string "Proto_") (sv-string sv-invocant)))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (setf sv-meth "")) (progn (return-from mp6-function (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string "( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_go (sv-arguments sv-self)) ", ")) (sv-string " } } )")))))))))) nil)(if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "func (a_ *Any) *Any { ") (sv-string (concatenate 'string (sv-string "var out = a_array(); ") (sv-string (concatenate 'string (sv-string "var i = (*(*a_).(array_er).f_array(Capture{})).(Array); ") (sv-string (concatenate 'string (sv-string "for pos := 0; pos <= i.n; pos++ { ") (sv-string (concatenate 'string (sv-string "(*out).(push_er).f_push( Capture{p: []*Any{ (*i.v[pos]).(") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "_er).f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "(Capture{ p : []*Any{}  }) }} ) } ") (sv-string (concatenate 'string (sv-string "return out; ") (sv-string (concatenate 'string (sv-string "}(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string "(*") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ").(") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "_er).f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_go (sv-arguments sv-self)) ", ")) (sv-string " } } )"))))))))))))))))))))
...
(defmethod sv-emit_go ((sv-self mp-For))
  (block mp6-function
    (progn (concatenate 'string (sv-string "func (a_ *Any) { ") (sv-string (concatenate 'string (sv-string "var i = (*(*a_).(array_er).f_array(Capture{})).(Array); ") (sv-string (concatenate 'string (sv-string "for pos := 0; pos <= i.n; pos++ { ") (sv-string (concatenate 'string (sv-string "func (") (sv-string (concatenate 'string (sv-string (sv-emit_go (sv-topic sv-self) )) (sv-string (concatenate 'string (sv-string " *Any) { ") (sv-string (concatenate 'string (sv-string (sv-emit_go (let ((m (make-instance 'mp-MiniPerl6-Go-LexicalBlock))) (setf (sv-block m) (sv-body sv-self))(setf (sv-needs_return m) 0) m) )) (sv-string (concatenate 'string (sv-string " }(i.v[pos]) ") (sv-string (concatenate 'string (sv-string "} ") (sv-string (concatenate 'string (sv-string "}(") (sv-string (concatenate 'string (sv-string (sv-emit_go (sv-cond sv-self) )) (sv-string ")")))))))))))))))))))))))))
