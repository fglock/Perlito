...
")))(setf sv-meth_seen (let ((h (make-hash-table :test 'equal))) (setf (mp-Main::sv-hash-lookup "join" h) 1)(setf (mp-Main::sv-hash-lookup "perl" h) 1)(setf (mp-Main::sv-hash-lookup "scalar" h) 1)(setf (mp-Main::sv-hash-lookup "isa" h) 1)(setf (mp-Main::sv-hash-lookup "values" h) 1)(setf (mp-Main::sv-hash-lookup "keys" h) 1)(setf (mp-Main::sv-hash-lookup "bind" h) 1)(setf (mp-Main::sv-hash-lookup "int" h) 1)(setf (mp-Main::sv-hash-lookup "str" h) 1)(setf (mp-Main::sv-hash-lookup "Str" h) 1)(setf (mp-Main::sv-hash-lookup "bool" h) 1)(setf (mp-Main::sv-hash-lookup "Bool" h) 1)(setf (mp-Main::sv-hash-lookup "array" h) 1)(setf (mp-Main::sv-hash-lookup "hash" h) 1)(setf (mp-Main::sv-hash-lookup "push" h) 1)(setf (mp-Main::sv-hash-lookup "pop" h) 1)(setf (mp-Main::sv-hash-lookup "shift" h) 1)(setf (mp-Main::sv-hash-lookup "lookup" h) 1)(setf (mp-Main::sv-hash-lookup "index" h) 1)(setf (mp-Main::sv-hash-lookup "function" h) 1) h))(loop for sv-comp_unit across sv-comp_units do (progn (loop for sv-stmt across (sv-body sv-comp_unit ) do (progn (if (sv-bool (sv-and (typep sv-stmt 'mp-Method) (not (sv-bool (mp-Main::sv-hash-lookup (sv-name sv-stmt ) sv-meth_seen))))) (let ((sv-meth (sv-undef))) (setf sv-meth (sv-name sv-stmt ))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "type ") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "_er interface { f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string " (Capture) *Any }
...
(defmethod sv-emit_go ((sv-self mp-Lit-Seq))
  (block mp6-function
    (progn (concatenate 'string (sv-string "[]*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-seq sv-self)) tmp ) ", ")) (sv-string " }")))))))
...
(defmethod sv-emit_go ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_go (sv-invocant sv-self) ))(if (sv-bool (typep (sv-invocant sv-self) 'mp-Proto)) (progn (if (sv-bool (sv-eq (sv-name (sv-invocant sv-self) ) "self")) (progn (setf sv-invocant "v_self")) (progn (setf sv-invocant (concatenate 'string (sv-string "Proto_") (sv-string sv-invocant)))))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (setf sv-meth "")) (progn (return-from mp6-function (concatenate 'string (sv-string "((*") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ").(function_er).f_function( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } ))")))))))))))) nil)(if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "func (a_ *Any) *Any { ") (sv-string (concatenate 'string (sv-string "
...
") (sv-string (concatenate 'string (sv-string "}(") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string ")")))))))))))))))))))))))))))))))))))))))))) nil)(return-from mp6-function (concatenate 'string (sv-string "(*") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ").(") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "_er).f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )"))))))))))))))))))))
...
(defmethod sv-emit_go ((sv-self mp-Apply))
  (block mp6-function
    (let ((sv-code (sv-undef))) (setf sv-code (sv-code sv-self))(if (sv-bool (typep sv-code 'string)) nil (progn (return-from mp6-function (concatenate 'string (sv-string "(") (sv-string (concatenate 'string (sv-string (sv-emit_go (sv-code sv-self) )) (sv-string (concatenate 'string (sv-string ")->(") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ")")))))))))))(if (sv-bool (sv-eq sv-code "self")) (progn (return-from mp6-function "v_self")) nil)(if (sv-bool (sv-eq sv-code "false")) (progn (return-from mp6-function "b_false()")) nil)(if (sv-bool (sv-eq sv-code "make")) (progn (return-from mp6-function (concatenate 'string (sv-string "func () *Any { ") (sv-string (concatenate 'string (sv-string "tmp := ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string (concatenate 'string (sv-string "; ") (sv-string (concatenate 'string (sv-string "*(*v_MATCH).(capture_er).f_capture(Capture{}) = *tmp; ") (sv-string (concatenate 'string (sv-string "return tmp; ") (sv-string "}()")))))))))))))) nil)(if (sv-bool (sv-eq sv-code "say")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_print( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ", toStr(\"\\n\") } } )")))))) nil)(if (sv-bool (sv-eq sv-code "print")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_print( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "warn")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_print_stderr( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string ", toStr(\"\\n\") } } )")))))) nil)(if (sv-bool (sv-eq sv-code "die")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_die( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "defined")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_defined( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "pop")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_pop( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "push")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_push( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "shift")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_shift( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "index")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_index( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "substr")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_substr( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "scalar")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_scalar( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "Int")) (progn (return-from mp6-function (concatenate 'string (sv-string "toInt(") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string ")")))))))))) nil)(if (sv-bool (sv-eq sv-code "Num")) (progn (return-from mp6-function (concatenate 'string (sv-string "toInt(") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ")") (sv-string ")")))))))))) nil)(if (sv-bool (sv-eq sv-code "exists")) (let ((sv-arg (sv-undef))) (setf sv-arg (mp-Main::sv-array-index (sv-arguments sv-self) 0))(if (sv-bool (typep sv-arg 'mp-Lookup)) (progn (return-from mp6-function (concatenate 'string (sv-string "(*") (sv-string (concatenate 'string (sv-string (sv-emit_go (sv-obj sv-arg ) )) (sv-string (concatenate 'string (sv-string ")") (sv-string (concatenate 'string (sv-string ".(exists_er).f_exists(Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-emit_go (sv-index_exp sv-arg ) )) (sv-string " } } )")))))))))))) nil)) nil)(if (sv-bool (sv-eq sv-code "prefix:<~>")) (progn (return-from mp6-function (mp-Call::sv-emit_go_call (mp-Main::sv-array-index (sv-arguments sv-self) 0) "Str"))) nil)(if (sv-bool (sv-eq sv-code "prefix:<!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toBool(!tobool(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string "))")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<?>")) (progn (return-from mp6-function (mp-Call::sv-emit_go_call (mp-Main::sv-array-index (sv-arguments sv-self) 0) "Bool"))) nil)(if (sv-bool (sv-eq sv-code "prefix:<$>")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_scalar( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))) nil)(if (sv-bool (sv-eq sv-code "prefix:<@>")) (progn (return-from mp6-function (mp-Call::sv-emit_go_call (mp-Main::sv-array-index (sv-arguments sv-self) 0) "array"))) nil)(if (sv-bool (sv-eq sv-code "prefix:<%>")) (progn (return-from mp6-function (mp-Call::sv-emit_go_call (mp-Main::sv-array-index (sv-arguments sv-self) 0) "hash"))) nil)(if (sv-bool (sv-eq sv-code "infix:<~>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toStr( ") (sv-string (concatenate 'string (sv-string "tostr(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") + ") (sv-string (concatenate 'string (sv-string "tostr(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ") ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<+>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toInt( ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") + ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ") ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<->")) (progn (return-from mp6-function (concatenate 'string (sv-string "toInt( ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") - ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ") ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<>>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toBool( ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") > ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ") ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<&&>")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_and( ") (sv-string (concatenate 'string (sv-string "func () *Any { return ") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string " }, ") (sv-string (concatenate 'string (sv-string "func () *Any { return ") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " } ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<||>")) (progn (return-from mp6-function (concatenate 'string (sv-string "f_or( ") (sv-string (concatenate 'string (sv-string "func () *Any { return ") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string " }, ") (sv-string (concatenate 'string (sv-string "func () *Any { return ") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " } ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<eq>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toBool(") (sv-string (concatenate 'string (sv-string "tostr(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") == ") (sv-string (concatenate 'string (sv-string "tostr(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ")") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<ne>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toBool(") (sv-string (concatenate 'string (sv-string "tostr(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") != ") (sv-string (concatenate 'string (sv-string "tostr(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ")") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<==>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toBool(") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") == ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ") ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "infix:<!=>")) (progn (return-from mp6-function (concatenate 'string (sv-string "toBool(") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 0) )) (sv-string (concatenate 'string (sv-string ") != ") (sv-string (concatenate 'string (sv-string "toint(") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string ") ") (sv-string ")")))))))))))))))) nil)(if (sv-bool (sv-eq sv-code "ternary:<?? !!>")) (progn (return-from mp6-function (concatenate 'string (sv-string "func () *Any { ") (sv-string (concatenate 'string (sv-string "if tobool( ") (sv-string (concatenate 'string (sv-string (mp-Call::sv-emit_go_call (mp-Main::sv-array-index (sv-arguments sv-self) 0) "Bool")) (sv-string (concatenate 'string (sv-string " ) ") (sv-string (concatenate 'string (sv-string "{ return ") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 1) )) (sv-string (concatenate 'string (sv-string " }; ") (sv-string (concatenate 'string (sv-string "return ") (sv-string (concatenate 'string (sv-string (sv-emit_go (mp-Main::sv-array-index (sv-arguments sv-self) 2) )) (sv-string (concatenate 'string (sv-string " ") (sv-string "}()")))))))))))))))))))))) nil)(setf sv-code (concatenate 'string (sv-string "f_") (sv-string (sv-code sv-self))))(if (sv-bool (sv-namespace sv-self)) (progn (setf sv-code (concatenate 'string (sv-string "Namespace_") (sv-string (concatenate 'string (sv-string (mp-Main::sv-to_go_namespace (sv-namespace sv-self))) (sv-string (concatenate 'string (sv-string ".") (sv-string sv-code)))))))) (progn (setf sv-code (concatenate 'string (sv-string "this_namespace.") (sv-string sv-code)))))(concatenate 'string (sv-string sv-code) (sv-string (concatenate 'string (sv-string "( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (let ((tmp (make-array 0 :adjustable 1 :fill-pointer t))) (map nil #'(lambda (c) (push (sv-emit_go  c) tmp)) (sv-arguments sv-self)) tmp ) ", ")) (sv-string " } } )")))))))))
...
") (sv-string "  }
")))))))))))))))))))))))))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string (sv-emit_go sv-decl )) (sv-string (concatenate 'string (sv-string " = ") (sv-string (concatenate 'string (sv-string (sv-emit_go sv-decl )) (sv-string "; ")))))))))(setf sv-i (+ sv-i 1))))(return-from mp6-function sv-str))))
