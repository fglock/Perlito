...
(defmethod sv-emit_go ((sv-self mp-CompUnit))
  (block mp6-function
    (let ((sv-class_name (sv-undef))(sv-str (sv-undef))(sv-decl_seen (sv-undef))) (setf sv-class_name (mp-Main::sv-to_go_namespace (sv-name sv-self)))(setf sv-str (concatenate 'string (sv-string "// instances of class ") (sv-string (concatenate 'string (sv-string (sv-name sv-self)) (sv-string (concatenate 'string (sv-string "
...
")))))))))))))))))))))))(dolist (sv-decl1 (sv-body sv-self)) (let ((sv-decl (sv-undef))) (setf sv-decl sv-decl1)(if (sv-bool (sv-and (typep sv-decl 'mp-Bind) (sv-and (typep (sv-parameters sv-decl ) 'mp-Decl) (sv-eq (sv-decl (sv-parameters sv-decl ) ) "my")))) (progn (setf sv-decl (sv-parameters sv-decl ))) nil)(if (sv-bool (sv-and (typep sv-decl 'mp-Decl) (sv-eq (sv-decl sv-decl ) "my"))) (let ((sv-var_name (sv-undef))) (setf sv-var_name (sv-emit_go (sv-var sv-decl ) ))(if (sv-bool (not (sv-bool (gethash sv-var_name sv-decl_seen)))) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (sv-emit_go_init sv-decl ))))(setf (gethash sv-var_name sv-decl_seen) 1)) nil)) nil)))(dolist (sv-decl (sv-body sv-self)) (progn (if (sv-bool (sv-and (typep sv-decl 'mp-Decl) (sv-eq (sv-decl sv-decl ) "has"))) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "  // accessor ") (sv-string (concatenate 'string (sv-string (sv-name (sv-var sv-decl ) )) (sv-string (concatenate 'string (sv-string "
...
(in-package mp-CompUnit)
  ...
  (block mp6-function (let ((sv-str (sv-undef))(sv-unit_seen (sv-undef))(sv-tmp_comp_unit (MAKE-ARRAY 5 :FILL-POINTER T :ADJUSTABLE T))(sv-meth_seen (sv-undef))) (setf sv-str "")(dolist (sv-comp_unit sv-comp_units) (let ((sv-name (sv-undef))) (setf sv-name (sv-name sv-comp_unit ))(if (sv-bool (gethash sv-name sv-unit_seen)) (progn (dolist (sv-stmt (sv-body sv-comp_unit )) (progn (sv-push (sv-body (gethash sv-name sv-unit_seen) ) sv-stmt)))) (progn (setf (gethash sv-name sv-unit_seen) sv-comp_unit)(sv-push sv-tmp_comp_unit sv-comp_unit)))))(setf sv-comp_units sv-tmp_comp_unit)(dolist (sv-comp_unit sv-comp_units) (progn (dolist (sv-stmt (sv-body sv-comp_unit )) (progn (if (sv-bool (typep sv-stmt 'mp-Method)) (progn (setf (gethash (sv-name sv-stmt ) (sv-methods sv-comp_unit )) sv-stmt)) nil)(if (sv-bool (sv-and (typep sv-stmt 'mp-Decl) (sv-eq (sv-decl sv-stmt ) "has"))) (progn (setf (gethash (sv-name (sv-var sv-stmt ) ) (sv-attributes sv-comp_unit )) sv-stmt)) nil)))))(dolist (sv-comp_unit sv-comp_units) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (sv-emit_go sv-comp_unit ))))))(if (sv-bool (not (sv-bool (gethash "MiniPerl6::Grammar" sv-unit_seen)))) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string "type MiniPerl6__Grammar struct{}
")))) nil)(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string "// interfaces for all methods
")))(setf sv-meth_seen (let ((h (make-hash-table :test 'equal))) (setf (gethash "join" h) 1)(setf (gethash "perl" h) 1)(setf (gethash "scalar" h) 1)(setf (gethash "isa" h) 1)(setf (gethash "values" h) 1)(setf (gethash "keys" h) 1)(setf (gethash "bind" h) 1)(setf (gethash "int" h) 1)(setf (gethash "str" h) 1)(setf (gethash "Str" h) 1)(setf (gethash "bool" h) 1)(setf (gethash "Bool" h) 1)(setf (gethash "array" h) 1)(setf (gethash "hash" h) 1)(setf (gethash "push" h) 1)(setf (gethash "pop" h) 1)(setf (gethash "shift" h) 1)(setf (gethash "lookup" h) 1)(setf (gethash "index" h) 1)(setf (gethash "function" h) 1) h))(dolist (sv-comp_unit sv-comp_units) (progn (dolist (sv-stmt (sv-body sv-comp_unit )) (progn (if (sv-bool (sv-and (typep sv-stmt 'mp-Method) (not (sv-bool (gethash (sv-name sv-stmt ) sv-meth_seen))))) (let ((sv-meth (sv-undef))) (setf sv-meth (sv-name sv-stmt ))(setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "type ") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string (concatenate 'string (sv-string "_er interface { f_") (sv-string (concatenate 'string (sv-string sv-meth) (sv-string " (Capture) *Any }
...
(defmethod sv-emit_go ((sv-self mp-Call))
  (block mp6-function
    (let ((sv-invocant (sv-undef))(sv-meth (sv-undef))) (setf sv-invocant (sv-emit_go (sv-invocant sv-self) ))(if (sv-bool (typep (sv-invocant sv-self) 'mp-Proto)) (progn (if (sv-bool (sv-eq (sv-name (sv-invocant sv-self) ) "self")) (progn (setf sv-invocant "v_self")) (progn (setf sv-invocant (concatenate 'string (sv-string "Proto_") (sv-string sv-invocant)))))) nil)(setf sv-meth (sv-method sv-self))(if (sv-bool (sv-eq sv-meth "postcircumfix:<( )>")) (progn (if (sv-bool (sv-hyper sv-self)) (progn (setf sv-meth "")) (progn (return-from mp6-function (concatenate 'string (sv-string "((*") (sv-string (concatenate 'string (sv-string sv-invocant) (sv-string (concatenate 'string (sv-string ").(function_er).f_function( Capture{ p : []*Any{ ") (sv-string (concatenate 'string (sv-string (sv-join (mapcar #'sv-emit_go (sv-arguments sv-self)) ", ")) (sv-string " } } ))")))))))))))) nil)(if (sv-bool (sv-hyper sv-self)) (progn (return-from mp6-function (concatenate 'string (sv-string "func (a_ *Any) *Any { ") (sv-string (concatenate 'string (sv-string "
...
(defmethod sv-emit_go_bind ((sv-self mp-Sig))
  (block mp6-function
    (let ((sv-str (sv-undef))(sv-i (sv-undef))) (setf sv-str "")(setf sv-i 0)(dolist (sv-decl (sv-positional sv-self)) (progn (setf sv-str (concatenate 'string (sv-string sv-str) (sv-string (concatenate 'string (sv-string "  var ") (sv-string (concatenate 'string (sv-string (sv-emit_go sv-decl )) (sv-string (concatenate 'string (sv-string " *Any;
