...
(defmethod sv-comp_unit ((sv-grammar mp-MiniPerl6-Grammar) &optional sv-str sv-pos)
  (block mp6-function
    (let ((sv-MATCH (sv-undef))) (setf sv-MATCH (let ((m (make-instance 'mp-MiniPerl6-Match))) (setf (sv-str m) sv-str)(setf (sv-from m) sv-pos)(setf (sv-to m) sv-pos)(setf (sv-bool m) 1) m))(setf (sv-bool sv-MATCH ) (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (sv-and (if (sv-bool (sv-eq ";" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup "ws" sv-MATCH))) (progn (sv-push (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)) (progn (setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) (let ((_tmp_ (concatenate 'list  (list sv-m2)))) (make-array (length _tmp_) :adjustable 1 :fill-pointer t :initial-contents _tmp_)))))1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1)))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (sv-and (if (sv-bool (sv-eq "use" (sv-substr sv-str (sv-to sv-MATCH ) 3))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 3 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)1) (progn nil))) (sv-and (if (sv-bool (sv-eq "v6" (sv-substr sv-str (sv-to sv-MATCH ) 2))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 2 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (sv-and (if (sv-bool (sv-eq "-" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ident sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup "ident" sv-MATCH))) (progn (sv-push (mp-Main::sv-hash-lookup "ident" sv-MATCH) sv-m2)) (progn (setf (mp-Main::sv-hash-lookup "ident" sv-MATCH) (let ((_tmp_ (concatenate 'list  (list sv-m2)))) (make-array (length _tmp_) :adjustable 1 :fill-pointer t :initial-contents _tmp_)))))1) (progn nil)))))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup "ws" sv-MATCH))) (progn (sv-push (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)) (progn (setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) (let ((_tmp_ (concatenate 'list  (list sv-m2)))) (make-array (length _tmp_) :adjustable 1 :fill-pointer t :initial-contents _tmp_)))))1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (if (sv-bool (sv-eq ";" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup "ws" sv-MATCH))) (progn (sv-push (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)) (progn (setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) (let ((_tmp_ (concatenate 'list  (list sv-m2)))) (make-array (length _tmp_) :adjustable 1 :fill-pointer t :initial-contents _tmp_)))))1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1))))))))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(sv-or (progn (if (sv-bool (sv-eq "class" (sv-substr sv-str (sv-to sv-MATCH ) 5))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 5 (sv-to sv-MATCH )))) nil)) (progn (setf (sv-to sv-MATCH ) sv-pos1)(if (sv-bool (sv-eq "grammar" (sv-substr sv-str (sv-to sv-MATCH ) 7))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 7 (sv-to sv-MATCH )))) nil)))) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))1) (progn nil))) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-full_ident sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "full_ident" sv-MATCH) sv-m2)1) (progn nil))) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (if (sv-bool (sv-eq "{" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-and (sv-or (progn (setf sv-Class_name (sv-string (mp-Main::sv-hash-lookup "full_ident" sv-MATCH)))) 1) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-exp_stmts sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "exp_stmts" sv-MATCH) sv-m2)1) (progn nil))) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (if (sv-bool (sv-eq "}" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-and (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (sv-and (if (sv-bool (sv-eq ";" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (let ((sv-last_pos (sv-undef))) (setf sv-last_pos (sv-to sv-MATCH ))(if (sv-bool (not (sv-bool (progn (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-ws sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(if (sv-bool (nth-value 1 (mp-Main::sv-hash-lookup "ws" sv-MATCH))) (progn (sv-push (mp-Main::sv-hash-lookup "ws" sv-MATCH) sv-m2)) (progn (setf (mp-Main::sv-hash-lookup "ws" sv-MATCH) (let ((_tmp_ (concatenate 'list  (list sv-m2)))) (make-array (length _tmp_) :adjustable 1 :fill-pointer t :initial-contents _tmp_)))))1) (progn nil))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1)))))))) (progn (setf (sv-to sv-MATCH ) sv-last_pos)) nil)1) (sv-or (progn (setf (sv-capture sv-MATCH) (let ((m (make-instance 'mp-CompUnit))) (setf (sv-name m) (sv-scalar (mp-Main::sv-hash-lookup "full_ident" sv-MATCH)))(setf (sv-attributes m) (make-hash-table :test 'equal))(setf (sv-methods m) (make-hash-table :test 'equal))(setf (sv-body m) (sv-scalar (mp-Main::sv-hash-lookup "exp_stmts" sv-MATCH))) m))) 1)))))))))))))))))))sv-MATCH)))
...
(defmethod sv-metasyntax_exp ((sv-grammar mp-MiniPerl6-Grammar-Regex) &optional sv-str sv-pos)
  (block mp6-function
    (let ((sv-MATCH (sv-undef))) (setf sv-MATCH (let ((m (make-instance 'mp-MiniPerl6-Match))) (setf (sv-str m) sv-str)(setf (sv-from m) sv-pos)(setf (sv-to m) sv-pos)(setf (sv-bool m) 1) m))(setf (sv-bool sv-MATCH ) (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (let ((sv-last_match_null (sv-undef))(sv-last_pos (sv-undef))(sv-count (sv-undef))) (setf sv-last_match_null 0)(setf sv-last_pos (sv-to sv-MATCH ))(setf sv-count 0)(loop while (sv-bool (sv-and (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(sv-or (progn (sv-and (if (sv-bool (sv-eq "\\" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (if (sv-bool (not (sv-eq "" (sv-substr sv-str (sv-to sv-MATCH ) 1)))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil))) (sv-or (progn (setf (sv-to sv-MATCH ) sv-pos1)(sv-and (if (sv-bool (sv-eq "'" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-literal sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "literal" sv-MATCH) sv-m2)1) (progn nil))) (if (sv-bool (sv-eq "'" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)))) (sv-or (progn (setf (sv-to sv-MATCH ) sv-pos1)(sv-and (if (sv-bool (sv-eq "{" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-string_code sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "string_code" sv-MATCH) sv-m2)1) (progn nil))) (if (sv-bool (sv-eq "}" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)))) (sv-or (progn (setf (sv-to sv-MATCH ) sv-pos1)(sv-and (if (sv-bool (sv-eq "<" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-metasyntax_exp sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "metasyntax_exp" sv-MATCH) sv-m2)1) (progn nil))) (if (sv-bool (sv-eq ">" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)))) (progn (setf (sv-to sv-MATCH ) sv-pos1)(sv-and (let ((sv-tmp (sv-undef))) (setf sv-tmp sv-MATCH)(setf sv-MATCH (let ((m (make-instance 'mp-MiniPerl6-Match))) (setf (sv-str m) sv-str)(setf (sv-from m) (sv-to sv-tmp ))(setf (sv-to m) (sv-to sv-tmp ))(setf (sv-bool m) 1) m))(setf (sv-bool sv-MATCH ) (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(progn (if (sv-bool (sv-eq ">" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil))))(setf (sv-bool sv-tmp ) (not (sv-bool sv-MATCH)))(setf sv-MATCH sv-tmp)(sv-bool sv-MATCH)) (if (sv-bool (not (sv-eq "" (sv-substr sv-str (sv-to sv-MATCH ) 1)))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)))))))) (sv-numeric-smaller sv-last_match_null 2))) do (progn (if (sv-bool (sv-numeric-equal sv-last_pos (sv-to sv-MATCH ))) (progn (setf sv-last_match_null (sv-add sv-last_match_null 1))) (progn (setf sv-last_match_null 0)))(setf sv-last_pos (sv-to sv-MATCH ))(setf sv-count (sv-add sv-count 1))))(setf (sv-to sv-MATCH ) sv-last_pos)(sv-numeric-bigger sv-count 0)))))sv-MATCH)))
...
(defmethod sv-quant_exp ((sv-grammar mp-MiniPerl6-Grammar-Regex) &optional sv-str sv-pos)
  (block mp6-function
    (let ((sv-MATCH (sv-undef))) (setf sv-MATCH (let ((m (make-instance 'mp-MiniPerl6-Match))) (setf (sv-str m) sv-str)(setf (sv-from m) sv-pos)(setf (sv-to m) sv-pos)(setf (sv-bool m) 1) m))(setf (sv-bool sv-MATCH ) (let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(sv-or (progn (sv-and (if (sv-bool (sv-eq "**" (sv-substr sv-str (sv-to sv-MATCH ) 2))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 2 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-opt_ws (proto-mp-MiniPerl6-Grammar) sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))1) (progn nil))) (sv-and (if (sv-bool (sv-eq "{" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-and (let ((sv-m2 (sv-undef))) (setf sv-m2 (sv-parsed_code sv-grammar sv-str (sv-to sv-MATCH )))(if (sv-bool sv-m2) (progn (setf (sv-to sv-MATCH ) (sv-to sv-m2 ))(setf (mp-Main::sv-hash-lookup "parsed_code" sv-MATCH) sv-m2)1) (progn nil))) (sv-and (if (sv-bool (sv-eq "}" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil) (sv-or (progn (setf (sv-capture sv-MATCH) (let ((h (make-hash-table :test 'equal))) (setf (mp-Main::sv-hash-lookup "closure" h) (sv-scalar (mp-Main::sv-hash-lookup "parsed_code" sv-MATCH))) h))) 1))))))) (progn (setf (sv-to sv-MATCH ) sv-pos1)(let ((sv-pos1 (sv-undef))) (setf sv-pos1 (sv-to sv-MATCH ))(sv-or (progn (if (sv-bool (sv-eq "?" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)) (sv-or (progn (setf (sv-to sv-MATCH ) sv-pos1)(if (sv-bool (sv-eq "*" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)) (progn (setf (sv-to sv-MATCH ) sv-pos1)(if (sv-bool (sv-eq "+" (sv-substr sv-str (sv-to sv-MATCH ) 1))) (sv-add 1 (setf (sv-to sv-MATCH ) (sv-add 1 (sv-to sv-MATCH )))) nil)))))))))sv-MATCH)))
