...
### FUNCTIONS
  ...
  sub isnt ($got, $expected, $desc, $todo, $depends) {
    my $test = !($got eq $expected);
    Perlito::Test::proclaim($test, 'isnt! ' ~ $desc, $todo, $got, $expected, $depends, { negate => 1 });
  }


  sub cmp_ok ($got, &compare_func, $expected, $desc, $todo, $depends) {
    say "### Perlito::Test::cmp_ok not implemented";
  }


  sub like () {
    say "### Perlito::Test::like not implemented";
  }

  sub unlike () {
    say "### Perlito::Test::unlike not implemented";
  }

  sub eval_dies_ok () {
    say "### Perlito::Test::eval_dies_ok not implemented";
  }

  sub isa_ok () {
    say "### Perlito::Test::isa_ok not implemented";
  }

  sub use_ok () {
    say "### Perlito::Test::use_ok not implemented";
  }

  sub throws_ok () {
    say "### Perlito::Test::throws_ok not implemented";
  }

  sub dies_ok () {
    say "### Perlito::Test::dies_ok not implemented";
  }

  sub lives_ok () {
    say "### Perlito::Test::lives_ok not implemented";
  }
...
## 'private' subs
  ...
  sub report_failure ($todo, $got, $expected, $negate) {
    say "### Perlito::Test::report_failure not implemented";
  }
