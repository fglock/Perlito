...
if ((($backend && @ARGV))) {
    ...
    if ((($backend eq 'perl5'))) {
        Perlito5::Runtime::say((chr(35) . ' Perlito5::AST::Do not edit this file - Generated by '), $_V6_COMPILER_NAME, (' '), $_V6_COMPILER_VERSION);
    ...
    if ((($backend eq 'js'))) {
        Perlito5::Runtime::say((chr(47) . chr(47) . ' Perlito5::AST::Do not edit this file - Generated by '), $_V6_COMPILER_NAME, (' '), $_V6_COMPILER_VERSION);
