...
(function () {
  ...
  Sub.f_emit = function () {
    var v_self = this;
    try { var v_sig;var v_pos;var v_str;var v_bind;(v_sig = v_self.v_sig);(v_pos = v_sig.f_positional());(v_str = "my $List__ = \\@_; ");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { if ( f_bool(f_isa(v_field, "Lit::Array")) ) { (function () { (v_str = ( f_string(v_str) + f_string(( f_string("my (") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_field.f_array1()).join(", ")) + f_string("); ") )) )) )); })() } else { (function () { (v_str = ( f_string(v_str) + f_string(( f_string("my ") + f_string(( f_string(v_field.f_emit()) + f_string("; ") )) )) )); })() } })(a_[i_]) } })((v_pos));(v_bind = function () { var tmp = {v_parameters: function () { var tmp = {v_array1: v_sig.f_positional(),}; tmp.__proto__ = Lit$Array; return tmp }(),v_arguments: function () { var tmp = {v_sigil: "@",v_twigil: "",v_name: "_",}; tmp.__proto__ = Var; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) ));return(( f_string("sub ") + f_string(( f_string(v_self.v_name) + f_string(( f_string(" { ") + f_string(( f_string(v_str) + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_self.v_block).join("; ")) + f_string(" }") )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
