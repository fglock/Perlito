...
(function () {
  ...
  Lit$Array.f_emit = function () {
    var v_self = this;
    try { return(( f_string("[") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_array).join(", ")) + f_string("]") )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Method.f_emit = function () {
    var v_self = this;
    try { var v_sig;var v_invocant;var v_pos;var v_str;var v_bind;(v_sig = this.v_sig);(v_invocant = v_sig.f_invocant());(v_pos = v_sig.f_positional());(v_str = "my $List__ = \\@_; ");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { if ( f_bool(f_isa(v_field, "Lit::Array")) ) { (v_str = ( f_string(v_str) + f_string(( f_string("my (") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_field.f_array()).join(", ")) + f_string("); ") )) )) )) } else { (v_str = ( f_string(v_str) + f_string(( f_string("my ") + f_string(( f_string(v_field.f_emit()) + f_string("; ") )) )) )) } })(a_[i_]) } })((v_pos));(v_bind = { __proto__:Bind, v_parameters: { __proto__:Lit$Array, v_array: v_sig.f_positional(),},v_arguments: { __proto__:Var, v_sigil: "@",v_twigil: "",v_name: "_",},});(v_str = ( f_string(v_str) + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) ));return(( f_string("sub ") + f_string(( f_string(this.v_name) + f_string(( f_string(" { ") + f_string(( f_string("my ") + f_string(( f_string(v_invocant.f_emit()) + f_string(( f_string(" = shift; ") + f_string(( f_string(v_str) + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_block).join("; ")) + f_string(" }") )) )) )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Sub.f_emit = function () {
    var v_self = this;
    try { var v_sig;var v_pos;var v_str;var v_bind;(v_sig = this.v_sig);(v_pos = v_sig.f_positional());(v_str = "my $List__ = \\@_; ");(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { if ( f_bool(f_isa(v_field, "Lit::Array")) ) { (v_str = ( f_string(v_str) + f_string(( f_string("my (") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_field.f_array()).join(", ")) + f_string("); ") )) )) )) } else { (v_str = ( f_string(v_str) + f_string(( f_string("my ") + f_string(( f_string(v_field.f_emit()) + f_string("; ") )) )) )) } })(a_[i_]) } })((v_pos));(v_bind = { __proto__:Bind, v_parameters: { __proto__:Lit$Array, v_array: v_sig.f_positional(),},v_arguments: { __proto__:Var, v_sigil: "@",v_twigil: "",v_name: "_",},});(v_str = ( f_string(v_str) + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) ));return(( f_string("sub ") + f_string(( f_string(this.v_name) + f_string(( f_string(" { ") + f_string(( f_string(v_str) + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_block).join("; ")) + f_string(" }") )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
