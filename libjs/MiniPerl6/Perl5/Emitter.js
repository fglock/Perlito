...
(v_class = v_self.v_parameters.f_class());(v_a = v_self.v_parameters.f_fields());(v_b = v_self.v_arguments);(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: function () { var tmp = {v_invocant: v_b,v_method: v_var[0].f_buf(),v_arguments: [],v_hyper: 0,}; tmp.__proto__ = Call; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = f_add(v_i, 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(v_self.v_parameters.f_emit()) + f_string(" }") )) )); })() } else { (function () { null })() };return(( f_string("(") + f_string(( f_string(v_self.v_parameters.f_emit()) + f_string(( f_string(" = ") + f_string(( f_string(v_self.v_arguments.f_emit()) + f_string(")") )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
