...
(function () {
  ...
  Var.f_emit = function () {
    var v_self = this;
    try { var v_table;var v_ns;(v_table = { "$":"$","@":"$List_","%":"$Hash_","&":"$Code_", });(v_ns = "");if ( f_bool(this.v_namespace) ) { (v_ns = ( f_string(this.v_namespace) + f_string("::") )) } else { if ( f_bool(( f_bool((this.v_sigil == "@")) && f_bool(( f_bool((this.v_twigil == "*")) && f_bool((this.v_name == "ARGS")) )) )) ) { throw("(\\@ARGV)") } else {  };if ( f_bool((this.v_twigil == ".")) ) { throw(( f_string("$self->{") + f_string(( f_string(this.v_name) + f_string("}") )) )) } else {  };if ( f_bool((this.v_name == "/")) ) { throw(( f_string(v_table[this.v_sigil]) + f_string("MATCH") )) } else {  } };throw(( f_string(v_table[this.v_sigil]) + f_string(( f_string(v_ns) + f_string(this.v_name) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Bind.f_emit = function () {
    var v_self = this;
    try { if ( f_bool(f_isa(this.v_parameters, "Lit::Array")) ) { (v_a = this.v_parameters.f_array1());(v_str = "do { ");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var,v_arguments: function () { var tmp = {v_obj: this.v_arguments,v_index_exp: function () { var tmp = {v_int: v_i,}; tmp.__proto__ = Val$Int; return tmp }(),}; tmp.__proto__ = Index; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Lit::Hash")) ) { (v_a = this.v_parameters.f_hash1());(v_b = this.v_arguments.f_hash1());(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_arg = function () { var tmp = {}; tmp.__proto__ = Val$Undef; return tmp }());(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var2) { if ( f_bool((v_var2[0].f_buf() == v_var[0].f_buf())) ) { (v_arg = v_var2[1]) } else {  } })(a_[i_]) } })((v_b));(v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: v_arg,}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit()) + f_string(" }") )) )) } else {  };if ( f_bool(f_isa(this.v_parameters, "Lit::Object")) ) { (v_class = this.v_parameters.f_class());(v_a = this.v_parameters.f_fields());(v_b = this.v_arguments);(v_str = "do { ");(v_i = 0);v_arg;(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_var) { (v_bind = function () { var tmp = {v_parameters: v_var[1],v_arguments: function () { var tmp = {v_invocant: v_b,v_method: v_var[0].f_buf(),v_arguments: [],v_hyper: 0,}; tmp.__proto__ = Call; return tmp }(),}; tmp.__proto__ = Bind; return tmp }());(v_str = ( f_string(v_str) + f_string(( f_string(" ") + f_string(( f_string(v_bind.f_emit()) + f_string("; ") )) )) ));(v_i = (v_i + 1)) })(a_[i_]) } })((v_a));throw(( f_string(v_str) + f_string(( f_string(this.v_parameters.f_emit()) + f_string(" }") )) )) } else {  };return(( f_string("(") + f_string(( f_string(this.v_parameters.f_emit()) + f_string(( f_string(" = ") + f_string(( f_string(this.v_arguments.f_emit()) + f_string(")") )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  If.f_emit = function () {
    var v_self = this;
    try { var v_cond;(v_cond = this.v_cond);if ( f_bool(( f_bool(f_isa(v_cond, "Apply")) && f_bool((v_cond.f_code() == "prefix:<!>")) )) ) { (v_if = function () { var tmp = {v_cond: v_cond.f_arguments()[0],v_body: this.v_otherwise,v_otherwise: this.v_body,}; tmp.__proto__ = If; return tmp }());throw(v_if.f_emit()) } else {  };if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (v_cond = function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()) } else {  };return(( f_string("do { if (") + f_string(( f_string(v_cond.f_emit()) + f_string(( f_string(") { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_body).join(";")) + f_string(( f_string(" } else { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(this.v_otherwise).join(";")) + f_string(" } }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
