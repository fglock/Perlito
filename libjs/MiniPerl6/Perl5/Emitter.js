...
(function () {
  ...
  Perl5.f_to_bool = function (v_cond) {
    try { if ( f_bool(( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) || f_bool(f_isa(v_cond, "Lit::Array")) )) ) { (function () { throw(function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()); })() } else { (function () { null })() };if ( f_bool(( f_bool(f_isa(v_cond, "Val::Num")) || f_bool(( f_bool(f_isa(v_cond, "Val::Buf")) || f_bool(( f_bool(f_isa(v_cond, "Val::Int")) || f_bool(( f_bool(f_isa(v_cond, "Val::Undef")) || f_bool(( f_bool(f_isa(v_cond, "Apply")) && f_bool(( f_bool((v_cond.f_code() == "bool")) || f_bool(( f_bool((v_cond.f_code() == "True")) || f_bool((v_cond.f_code() == "False")) )) )) )) )) )) )) )) ) { (function () { throw(v_cond); })() } else { (function () { null })() };throw(function () { var tmp = {v_code: "bool",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
})();
...
(function () {
  ...
  While.f_emit = function () {
    var v_self = this;
    try { var v_cond;(v_cond = v_self.v_cond);if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (function () { (v_cond = function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()); })() } else { (function () { null })() };return(( f_string("for ( ") + f_string(( f_string(( f_bool(v_self.v_init) ? ( f_string(v_self.v_init.f_emit()) + f_string("; ") ) : "; ")) + f_string(( f_string(( f_bool(v_cond) ? ( f_string(v_cond.f_emit()) + f_string("; ") ) : "; ")) + f_string(( f_string(( f_bool(v_self.v_continue) ? ( f_string(v_self.v_continue.f_emit()) + f_string(" ") ) : " ")) + f_string(( f_string(") { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_self.v_body).join("; ")) + f_string(" }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  For.f_emit = function () {
    var v_self = this;
    try { var v_cond;(v_cond = v_self.v_cond);if ( f_bool(( f_bool(f_isa(v_cond, "Var")) && f_bool((v_cond.f_sigil() == "@")) )) ) { (function () { (v_cond = function () { var tmp = {v_code: "prefix:<@>",v_arguments: [v_cond],}; tmp.__proto__ = Apply; return tmp }()); })() } else { (function () { null })() };throw(( f_string("for my ") + f_string(( f_string(v_self.v_topic.f_emit()) + f_string(( f_string(" ( ") + f_string(( f_string(v_cond.f_emit()) + f_string(( f_string(" ) { ") + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_self.v_body).join(";")) + f_string(" }") )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Method.f_emit = function () {
    var v_self = this;
    try { var v_sig;var v_invocant;var v_pos;var v_str;var v_i;(v_sig = v_self.v_sig);(v_invocant = v_sig.f_invocant());(v_pos = v_sig.f_positional());(v_str = "");(v_i = 1);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = ( f_string(v_str) + f_string(( f_string("my ") + f_string(( f_string(v_field.f_emit()) + f_string(( f_string(" = $_[") + f_string(( f_string(v_i) + f_string("]; ") )) )) )) )) ));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_pos));return(( f_string("sub ") + f_string(( f_string(v_self.v_name) + f_string(( f_string(" { ") + f_string(( f_string("my ") + f_string(( f_string(v_invocant.f_emit()) + f_string(( f_string(" = $_[0]; ") + f_string(( f_string(v_str) + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_self.v_block).join("; ")) + f_string(" }") )) )) )) )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
...
(function () {
  ...
  Sub.f_emit = function () {
    var v_self = this;
    try { var v_sig;var v_pos;var v_str;var v_i;(v_sig = v_self.v_sig);(v_pos = v_sig.f_positional());(v_str = "");(v_i = 0);(function (a_) { for (var i_ = 0; i_ < a_.length ; i_++) { (function (v_field) { (v_str = ( f_string(v_str) + f_string(( f_string("my ") + f_string(( f_string(v_field.f_emit()) + f_string(( f_string(" = $_[") + f_string(( f_string(v_i) + f_string("]; ") )) )) )) )) ));(v_i = f_add(v_i, 1)); })(a_[i_]) } })((v_pos));return(( f_string("sub ") + f_string(( f_string(v_self.v_name) + f_string(( f_string(" { ") + f_string(( f_string(v_str) + f_string(( f_string((function (a_) { var out = []; if ( typeof a_ == 'undefined' ) { return out }; for(var i = 0; i < a_.length; i++) { out.push( a_[i].f_emit() ) } return out; })(v_self.v_block).join("; ")) + f_string(" }") )) )) )) )) )) } catch(err) { if ( err instanceof Error ) { throw(err) } else { return(err) } } 
  }
