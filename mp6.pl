...
if ( $backend eq 'ruby' ) {
    ...
    $result .= "# Do not edit this file - Generated by $::_V6_COMPILER_NAME $::_V6_COMPILER_VERSION\n";
    $result .= "\n";
    $result .= "from miniperl6.python.runtime import *\n";
    $result .= "from MiniPerl6__Python__Prelude import *\n";
