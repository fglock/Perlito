...
token module_name {
    ...
    [   '::' <module_name>  { make [ ~$<Perlito::Grammar.ident>, @( $$<module_name> ) ] }
    |   ''                  { make [ ~$<Perlito::Grammar.ident> ] }
    ]
}
...
";
    ...
    if $backend && @*ARGS {
        ...
        if $backend eq 'go' {
            ...
            my $filename = $perl6lib ~ '/Perlito/Go/Runtime.go';
            if ( $verbose ) {
                warn "// now loading: ", $filename;
            }
            my $source = IO::slurp( $filename );
        ...
        if $backend eq 'lisp' {
            say ";; Do not edit this file - Generated by ", $_V6_COMPILER_NAME, " ", $_V6_COMPILER_VERSION;
            my $filename = $perl6lib ~ '/Perlito/Lisp/Runtime.lisp';
            if ( $verbose ) {
                warn "// now loading: ", $filename;
            }
            my $source = IO::slurp( $filename );
        ...
        if $backend eq 'js' {
            say "// Do not edit this file - Generated by ", $_V6_COMPILER_NAME, " ", $_V6_COMPILER_VERSION;
            my $filename = $perl6lib ~ '/Perlito/Javascript/Runtime.js';
            if ( $verbose ) {
                warn "// now loading: ", $filename;
            }
            my $source = IO::slurp( $filename );
        ...
        if $backend eq 'python' {
            ...
            say "#-*- coding: utf-8 -*-";
            say "";
            say "from Perlito__Python__Runtime import *";
            say "from Perlito__Python__Prelude import *";
        ...
        if $backend eq 'ruby' {
            say "# Do not edit this file - Generated by ", $_V6_COMPILER_NAME, " ", $_V6_COMPILER_VERSION;
            say "";
            say "require 'Perlito/Ruby/Runtime.rb'";
            say "";
            for @($comp_units) -> $c {
                say $c.emit_ruby;
            }
